...
class ApplicationAddResponse(object):
    ...
    def __init__(self, application_id=None, application_stage=None, control_flow_id=None):  # noqa: E501
        """ApplicationAddResponse - a model defined in Swagger"""  # noqa: E501
    ...
    def application_id(self):
        """Gets the application_id of this ApplicationAddResponse.  # noqa: E501

        Unique identifier for the application  # noqa: E501

        :return: The application_id of this ApplicationAddResponse.  # noqa: E501
        :rtype: str
        """
    ...
    def application_id(self, application_id):
        """Sets the application_id of this ApplicationAddResponse.

        Unique identifier for the application  # noqa: E501

        :param application_id: The application_id of this ApplicationAddResponse.  # noqa: E501
        :type: str
        """
    ...
    def application_stage(self):
        """Gets the application_stage of this ApplicationAddResponse.  # noqa: E501
        ...
        :return: The application_stage of this ApplicationAddResponse.  # noqa: E501
        :rtype: str
        """
    ...
    def application_stage(self, application_stage):
        """Sets the application_stage of this ApplicationAddResponse.

        Current stage of an application.This is a reference data field. Please use /v1/apac/utilities/referenceData/{applicationStage} resource to get possible value of this field with description. You can use applicationStage field name as the referenceCode parameter to retrieve the values.  # noqa: E501

        :param application_stage: The application_stage of this ApplicationAddResponse.  # noqa: E501
        :type: str
        """
    ...
    def control_flow_id(self):
        """Gets the control_flow_id of this ApplicationAddResponse.  # noqa: E501

        Control flow id is used to control the flow for subsequent requests in the session.  # noqa: E501

        :return: The control_flow_id of this ApplicationAddResponse.  # noqa: E501
        :rtype: str
        """
    ...
    def control_flow_id(self, control_flow_id):
        """Sets the control_flow_id of this ApplicationAddResponse.

        Control flow id is used to control the flow for subsequent requests in the session.  # noqa: E501

        :param control_flow_id: The control_flow_id of this ApplicationAddResponse.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ApplicationAddResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ApplicationAddResponse):
            return False
