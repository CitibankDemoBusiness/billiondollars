...
class InsertDocumentRequest(object):
    ...
    def __init__(self, document_details=None, control_flow_id=None):  # noqa: E501
        """InsertDocumentRequest - a model defined in Swagger"""  # noqa: E501
    ...
    def document_details(self):
        """Gets the document_details of this InsertDocumentRequest.  # noqa: E501


        :return: The document_details of this InsertDocumentRequest.  # noqa: E501
    ...
    def document_details(self, document_details):
        """Sets the document_details of this InsertDocumentRequest.


        :param document_details: The document_details of this InsertDocumentRequest.  # noqa: E501
        :type: DocumentDetails
        """
        if document_details is None:
            raise ValueError("Invalid value for `document_details`, must not be `None`")  # noqa: E501

        self._document_details = document_details

    @property
    def control_flow_id(self):
        """Gets the control_flow_id of this InsertDocumentRequest.  # noqa: E501

        Control flow id is used to control the flow for subsequent requests in the session.  # noqa: E501

        :return: The control_flow_id of this InsertDocumentRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def control_flow_id(self, control_flow_id):
        """Sets the control_flow_id of this InsertDocumentRequest.

        Control flow id is used to control the flow for subsequent requests in the session.  # noqa: E501

        :param control_flow_id: The control_flow_id of this InsertDocumentRequest.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(InsertDocumentRequest, dict):
