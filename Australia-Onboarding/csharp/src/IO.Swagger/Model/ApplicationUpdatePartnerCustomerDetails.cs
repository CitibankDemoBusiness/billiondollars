...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ApplicationUpdatePartnerCustomerDetails :  IEquatable<ApplicationUpdatePartnerCustomerDetails>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ApplicationUpdatePartnerCustomerDetails" /> class.
        /// </summary>
        ...
        public ApplicationUpdatePartnerCustomerDetails(string partnerCustomerInternalId = default(string), string partnerCustomerId = default(string), string partnerCustomerSegment = default(string))
        {
        ...
        {
            return this.Equals(input as ApplicationUpdatePartnerCustomerDetails);
        }

        /// <summary>
        /// Returns true if ApplicationUpdatePartnerCustomerDetails instances are equal
        /// </summary>
        /// <param name="input">Instance of ApplicationUpdatePartnerCustomerDetails to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApplicationUpdatePartnerCustomerDetails input)
        {
            if (input == null)
                return false;
