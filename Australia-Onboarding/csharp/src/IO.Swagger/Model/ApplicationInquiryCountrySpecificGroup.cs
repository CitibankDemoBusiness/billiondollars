...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ApplicationInquiryCountrySpecificGroup :  IEquatable<ApplicationInquiryCountrySpecificGroup>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ApplicationInquiryCountrySpecificGroup" /> class.
        /// </summary>
        ...
        public ApplicationInquiryCountrySpecificGroup(bool? bumiputraIndicator = default(bool?), bool? disabilityIndicator = default(bool?), string unionPayCardNumber = default(string), string taxFileNumber = default(string))
        {
        ...
        {
            return this.Equals(input as ApplicationInquiryCountrySpecificGroup);
        }

        /// <summary>
        /// Returns true if ApplicationInquiryCountrySpecificGroup instances are equal
        /// </summary>
        /// <param name="input">Instance of ApplicationInquiryCountrySpecificGroup to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApplicationInquiryCountrySpecificGroup input)
        {
            if (input == null)
                return false;
