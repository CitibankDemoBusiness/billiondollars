...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ApplicationAddResponse :  IEquatable<ApplicationAddResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ApplicationAddResponse" /> class.
        /// </summary>
        ...
        public ApplicationAddResponse(string applicationId = default(string), string applicationStage = default(string), string controlFlowId = default(string))
        {
            // to ensure "applicationId" is required (not null)
            if (applicationId == null)
            {
                throw new InvalidDataException("applicationId is a required property for ApplicationAddResponse and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("applicationStage is a required property for ApplicationAddResponse and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("controlFlowId is a required property for ApplicationAddResponse and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as ApplicationAddResponse);
        }

        /// <summary>
        /// Returns true if ApplicationAddResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of ApplicationAddResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApplicationAddResponse input)
        {
            if (input == null)
                return false;
