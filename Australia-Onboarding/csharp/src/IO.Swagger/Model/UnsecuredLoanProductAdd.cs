...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class UnsecuredLoanProductAdd :  IEquatable<UnsecuredLoanProductAdd>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UnsecuredLoanProductAdd" /> class.
        /// </summary>
        ...
        public UnsecuredLoanProductAdd(string productCode = default(string), string sourceCode = default(string), string organization = default(string), string logo = default(string), bool? requestCreditShield = default(bool?), string billingAddress = default(string), string giftCode = default(string), double? requestedLoanAmount = default(double?), string disbursementOption = default(string), string loanPurpose = default(string), string tenor = default(string), string tenor1 = default(string), string penaltyScheme = default(string), LoanRepaymentDetails loanRepaymentDetails = default(LoanRepaymentDetails), List<LoanPaymentAccountDetailsAdd> loanPaymentAccountDetails = default(List<LoanPaymentAccountDetailsAdd>))
        {
            // to ensure "productCode" is required (not null)
            if (productCode == null)
            {
                throw new InvalidDataException("productCode is a required property for UnsecuredLoanProductAdd and cannot be null");
            }
            else
            {
            ...
            if (sourceCode == null)
            {
                throw new InvalidDataException("sourceCode is a required property for UnsecuredLoanProductAdd and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("organization is a required property for UnsecuredLoanProductAdd and cannot be null");
            }
            else
            {
            ...
            if (logo == null)
            {
                throw new InvalidDataException("logo is a required property for UnsecuredLoanProductAdd and cannot be null");
            }
            else
            {
                this.Logo = logo;
        ...
        public List<LoanPaymentAccountDetailsAdd> LoanPaymentAccountDetails { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class UnsecuredLoanProductAdd {\n");
        ...
        {
            return this.Equals(input as UnsecuredLoanProductAdd);
        }

        /// <summary>
        /// Returns true if UnsecuredLoanProductAdd instances are equal
        /// </summary>
        /// <param name="input">Instance of UnsecuredLoanProductAdd to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UnsecuredLoanProductAdd input)
        {
            if (input == null)
                return false;
