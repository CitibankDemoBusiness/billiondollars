...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ApplicantInquiryCreditCardProduct :  IEquatable<ApplicantInquiryCreditCardProduct>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ApplicantInquiryCreditCardProduct" /> class.
        /// </summary>
        ...
        public ApplicantInquiryCreditCardProduct(string embossName = default(string), double? requestedCreditLimit = default(double?), bool? overseasCardActivationFlag = default(bool?))
        {
        ...
        {
            return this.Equals(input as ApplicantInquiryCreditCardProduct);
        }

        /// <summary>
        /// Returns true if ApplicantInquiryCreditCardProduct instances are equal
        /// </summary>
        /// <param name="input">Instance of ApplicantInquiryCreditCardProduct to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApplicantInquiryCreditCardProduct input)
        {
            if (input == null)
                return false;
