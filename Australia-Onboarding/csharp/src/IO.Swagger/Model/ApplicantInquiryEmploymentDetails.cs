...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ApplicantInquiryEmploymentDetails :  IEquatable<ApplicantInquiryEmploymentDetails>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ApplicantInquiryEmploymentDetails" /> class.
        /// </summary>
        ...
        public ApplicantInquiryEmploymentDetails(int? employmentDurationInYears = default(int?), int? employmentDurationiInMonths = default(int?), string employerName = default(string), string jobTitle = default(string), string occupationCode = default(string), string employmentStatus = default(string))
        {
        ...
        {
            return this.Equals(input as ApplicantInquiryEmploymentDetails);
        }

        /// <summary>
        /// Returns true if ApplicantInquiryEmploymentDetails instances are equal
        /// </summary>
        /// <param name="input">Instance of ApplicantInquiryEmploymentDetails to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApplicantInquiryEmploymentDetails input)
        {
            if (input == null)
                return false;
