...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ApplicantAddCreditCardProduct :  IEquatable<ApplicantAddCreditCardProduct>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ApplicantAddCreditCardProduct" /> class.
        /// </summary>
        ...
        public ApplicantAddCreditCardProduct(string embossName = default(string), double? requestedCreditLimit = default(double?), bool? overseasCardActivationFlag = default(bool?))
        {
        ...
        {
            return this.Equals(input as ApplicantAddCreditCardProduct);
        }

        /// <summary>
        /// Returns true if ApplicantAddCreditCardProduct instances are equal
        /// </summary>
        /// <param name="input">Instance of ApplicantAddCreditCardProduct to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApplicantAddCreditCardProduct input)
        {
            if (input == null)
                return false;
