...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ApplicationInquiryKycInformation :  IEquatable<ApplicationInquiryKycInformation>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ApplicationInquiryKycInformation" /> class.
        /// </summary>
        ...
        /// <param name="relatedSeniorPublicFigureDesignation">Public figure designation..</param>
        ...
        public ApplicationInquiryKycInformation(bool? selfPublicFigureDeclarationFlag = default(bool?), string publicFigureOfficeStatus = default(string), string publicFigureOfficeDetails = default(string), DateTime? publicFigureOfficeStartDate = default(DateTime?), DateTime? publicFigureOfficeEndDate = default(DateTime?), bool? isRelatedToSeniorPublicFigure = default(bool?), string relatedSeniorPublicFigureName = default(string), string relatedSeniorPublicFigureDesignation = default(string), string relatedSpfCountryOfGovernment = default(string), string relatedSeniorPublicFigureDepartment = default(string), string relationshipWithSeniorPublicFigure = default(string), string relatedSeniorPublicFigureLastName = default(string), string usTaxStatus = default(string), string usTaxId = default(string))
        {
        ...
        /// </summary>
        /// <value>Public figure designation.</value>
        [DataMember(Name="relatedSeniorPublicFigureDesignation", EmitDefaultValue=false)]
        public string RelatedSeniorPublicFigureDesignation { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  RelatedSeniorPublicFigureDesignation: ").Append(RelatedSeniorPublicFigureDesignation).Append("\n");
        ...
        {
            return this.Equals(input as ApplicationInquiryKycInformation);
        }

        /// <summary>
        /// Returns true if ApplicationInquiryKycInformation instances are equal
        /// </summary>
        /// <param name="input">Instance of ApplicationInquiryKycInformation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApplicationInquiryKycInformation input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.RelatedSeniorPublicFigureDesignation == input.RelatedSeniorPublicFigureDesignation ||
                    (this.RelatedSeniorPublicFigureDesignation != null &&
                    this.RelatedSeniorPublicFigureDesignation.Equals(input.RelatedSeniorPublicFigureDesignation))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.RelatedSeniorPublicFigureDesignation != null)
                    hashCode = hashCode * 59 + this.RelatedSeniorPublicFigureDesignation.GetHashCode();
