...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ApplicationUpdateEmail :  IEquatable<ApplicationUpdateEmail>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ApplicationUpdateEmail" /> class.
        /// </summary>
        /// <param name="emailAddress">Email Id of applicant (required).</param>
        ...
        public ApplicationUpdateEmail(string emailAddress = default(string), bool? okToEmail = default(bool?), bool? isPreferredEmailAddress = default(bool?))
        {
            // to ensure "emailAddress" is required (not null)
            if (emailAddress == null)
            {
                throw new InvalidDataException("emailAddress is a required property for ApplicationUpdateEmail and cannot be null");
            }
            else
            {
        ...
        /// </summary>
        /// <value>Email Id of applicant</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ApplicationUpdateEmail {\n");
        ...
        {
            return this.Equals(input as ApplicationUpdateEmail);
        }

        /// <summary>
        /// Returns true if ApplicationUpdateEmail instances are equal
        /// </summary>
        /// <param name="input">Instance of ApplicationUpdateEmail to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApplicationUpdateEmail input)
        {
            if (input == null)
                return false;
