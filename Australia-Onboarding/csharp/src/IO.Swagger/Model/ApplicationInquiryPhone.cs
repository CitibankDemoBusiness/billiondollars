...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ApplicationInquiryPhone :  IEquatable<ApplicationInquiryPhone>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ApplicationInquiryPhone" /> class.
        /// </summary>
        ...
        public ApplicationInquiryPhone(string phoneType = default(string), string phoneCountryCode = default(string), string areaCode = default(string), string phoneNumber = default(string), string extension = default(string), bool? okToSms = default(bool?), bool? okToCall = default(bool?))
        {
            // to ensure "phoneType" is required (not null)
            if (phoneType == null)
            {
                throw new InvalidDataException("phoneType is a required property for ApplicationInquiryPhone and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("phoneCountryCode is a required property for ApplicationInquiryPhone and cannot be null");
            }
            else
            {
            ...
            if (phoneNumber == null)
            {
                throw new InvalidDataException("phoneNumber is a required property for ApplicationInquiryPhone and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as ApplicationInquiryPhone);
        }

        /// <summary>
        /// Returns true if ApplicationInquiryPhone instances are equal
        /// </summary>
        /// <param name="input">Instance of ApplicationInquiryPhone to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApplicationInquiryPhone input)
        {
            if (input == null)
                return false;
