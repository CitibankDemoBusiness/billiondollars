...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ApplicantInquiryEmail :  IEquatable<ApplicantInquiryEmail>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ApplicantInquiryEmail" /> class.
        /// </summary>
        ...
        public ApplicantInquiryEmail(string emailAddress = default(string), bool? okToEmail = default(bool?), bool? isPreferredEmailAddress = default(bool?))
        {
            // to ensure "emailAddress" is required (not null)
            if (emailAddress == null)
            {
                throw new InvalidDataException("emailAddress is a required property for ApplicantInquiryEmail and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ApplicantInquiryEmail {\n");
        ...
        {
            return this.Equals(input as ApplicantInquiryEmail);
        }

        /// <summary>
        /// Returns true if ApplicantInquiryEmail instances are equal
        /// </summary>
        /// <param name="input">Instance of ApplicantInquiryEmail to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApplicantInquiryEmail input)
        {
            if (input == null)
                return false;
