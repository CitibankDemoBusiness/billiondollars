...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ApplicantAddApplicant :  IEquatable<ApplicantAddApplicant>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ApplicantAddApplicant" /> class.
        /// </summary>
        ...
        public ApplicantAddApplicant(string applicantType = default(string), string motherMaidenName = default(string), ApplicantAddName name = default(ApplicantAddName), ApplicantAddDemographics demographics = default(ApplicantAddDemographics), List<ApplicantAddAddress> address = default(List<ApplicantAddAddress>), List<ApplicantAddEmail> email = default(List<ApplicantAddEmail>), List<ApplicantAddPhone> phone = default(List<ApplicantAddPhone>), ApplicantAddFinancialInformation financialInformation = default(ApplicantAddFinancialInformation), List<ApplicantAddEmploymentDetails> employmentDetails = default(List<ApplicantAddEmploymentDetails>), List<ApplicantAddIdentificationDocumentDetails> identificationDocumentDetails = default(List<ApplicantAddIdentificationDocumentDetails>), ApplicantAddAdditionalData additionalData = default(ApplicantAddAdditionalData), ApplicantAddPartnerCustomerDetails partnerCustomerDetails = default(ApplicantAddPartnerCustomerDetails), List<ApplicantAddConsentDetails> consentDetails = default(List<ApplicantAddConsentDetails>), ApplicantAddKycInformation kycInformation = default(ApplicantAddKycInformation), ApplicantAddContactConsent contactConsent = default(ApplicantAddContactConsent))
        {
            // to ensure "applicantType" is required (not null)
            if (applicantType == null)
            {
                throw new InvalidDataException("applicantType is a required property for ApplicantAddApplicant and cannot be null");
            }
            else
            {
            ...
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for ApplicantAddApplicant and cannot be null");
            }
            else
            {
                this.Name = name;
        ...
        public ApplicantAddName Name { get; set; }

        /// <summary>
        /// Gets or Sets Demographics
        /// </summary>
        [DataMember(Name="demographics", EmitDefaultValue=false)]
        public ApplicantAddDemographics Demographics { get; set; }

        /// <summary>
        /// Gets or Sets Address
        /// </summary>
        [DataMember(Name="address", EmitDefaultValue=false)]
        public List<ApplicantAddAddress> Address { get; set; }

        /// <summary>
        /// Gets or Sets Email
        /// </summary>
        [DataMember(Name="email", EmitDefaultValue=false)]
        public List<ApplicantAddEmail> Email { get; set; }

        /// <summary>
        /// Gets or Sets Phone
        /// </summary>
        [DataMember(Name="phone", EmitDefaultValue=false)]
        public List<ApplicantAddPhone> Phone { get; set; }

        /// <summary>
        /// Gets or Sets FinancialInformation
        /// </summary>
        [DataMember(Name="financialInformation", EmitDefaultValue=false)]
        public ApplicantAddFinancialInformation FinancialInformation { get; set; }

        /// <summary>
        /// Gets or Sets EmploymentDetails
        /// </summary>
        [DataMember(Name="employmentDetails", EmitDefaultValue=false)]
        public List<ApplicantAddEmploymentDetails> EmploymentDetails { get; set; }

        /// <summary>
        /// Gets or Sets IdentificationDocumentDetails
        /// </summary>
        [DataMember(Name="identificationDocumentDetails", EmitDefaultValue=false)]
        public List<ApplicantAddIdentificationDocumentDetails> IdentificationDocumentDetails { get; set; }

        /// <summary>
        /// Gets or Sets AdditionalData
        /// </summary>
        [DataMember(Name="additionalData", EmitDefaultValue=false)]
        public ApplicantAddAdditionalData AdditionalData { get; set; }

        /// <summary>
        /// Gets or Sets PartnerCustomerDetails
        /// </summary>
        [DataMember(Name="partnerCustomerDetails", EmitDefaultValue=false)]
        public ApplicantAddPartnerCustomerDetails PartnerCustomerDetails { get; set; }

        /// <summary>
        /// Gets or Sets ConsentDetails
        /// </summary>
        [DataMember(Name="consentDetails", EmitDefaultValue=false)]
        public List<ApplicantAddConsentDetails> ConsentDetails { get; set; }

        /// <summary>
        /// Gets or Sets KycInformation
        /// </summary>
        [DataMember(Name="kycInformation", EmitDefaultValue=false)]
        public ApplicantAddKycInformation KycInformation { get; set; }

        /// <summary>
        /// Gets or Sets ContactConsent
        /// </summary>
        [DataMember(Name="contactConsent", EmitDefaultValue=false)]
        public ApplicantAddContactConsent ContactConsent { get; set; }
        ...
        {
            return this.Equals(input as ApplicantAddApplicant);
        }

        /// <summary>
        /// Returns true if ApplicantAddApplicant instances are equal
        /// </summary>
        /// <param name="input">Instance of ApplicantAddApplicant to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApplicantAddApplicant input)
        {
            if (input == null)
                return false;
