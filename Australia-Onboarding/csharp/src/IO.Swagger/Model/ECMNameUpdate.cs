...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ECMNameUpdate :  IEquatable<ECMNameUpdate>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ECMNameUpdate" /> class.
        /// </summary>
        ...
        public ECMNameUpdate(string localEnglishGivenName = default(string), string localEnglishSurname = default(string))
        {
        ...
        {
            return this.Equals(input as ECMNameUpdate);
        }

        /// <summary>
        /// Returns true if ECMNameUpdate instances are equal
        /// </summary>
        /// <param name="input">Instance of ECMNameUpdate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ECMNameUpdate input)
        {
            if (input == null)
                return false;
