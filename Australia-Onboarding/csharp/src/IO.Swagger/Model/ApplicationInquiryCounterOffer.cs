...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ApplicationInquiryCounterOffer :  IEquatable<ApplicationInquiryCounterOffer>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ApplicationInquiryCounterOffer" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as ApplicationInquiryCounterOffer);
        }

        /// <summary>
        /// Returns true if ApplicationInquiryCounterOffer instances are equal
        /// </summary>
        /// <param name="input">Instance of ApplicationInquiryCounterOffer to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApplicationInquiryCounterOffer input)
        {
            if (input == null)
                return false;
