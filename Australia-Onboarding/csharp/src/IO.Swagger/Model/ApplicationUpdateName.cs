...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ApplicationUpdateName :  IEquatable<ApplicationUpdateName>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ApplicationUpdateName" /> class.
        /// </summary>
        /// <param name="salutation">Salutation. This is a reference data data field. Please use /v1/apac/utilities/referenceData/{salutation} resource to get valid value of this field with description. You can use salutation field name as the referenceCode parameter to retrieve the values..</param>
        ...
        /// </summary>
        /// <value>Salutation. This is a reference data data field. Please use /v1/apac/utilities/referenceData/{salutation} resource to get valid value of this field with description. You can use salutation field name as the referenceCode parameter to retrieve the values.</value>
        ...
        /// </summary>
        /// <value>Contains value with which applicant like to be addressed. This is a reference data data field. Please use /v1/apac/utilities/referenceData/{saluteBy} resource to get valid value of this field with description. You can use saluteBy field name as the referenceCode parameter to retrieve the values.</value>
        ...
        {
            return this.Equals(input as ApplicationUpdateName);
        }

        /// <summary>
        /// Returns true if ApplicationUpdateName instances are equal
        /// </summary>
        /// <param name="input">Instance of ApplicationUpdateName to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApplicationUpdateName input)
        {
            if (input == null)
                return false;
