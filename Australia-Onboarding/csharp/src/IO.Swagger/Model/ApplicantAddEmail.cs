...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ApplicantAddEmail :  IEquatable<ApplicantAddEmail>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ApplicantAddEmail" /> class.
        /// </summary>
        ...
        public ApplicantAddEmail(string emailAddress = default(string), bool? okToEmail = default(bool?), bool? isPreferredEmailAddress = default(bool?))
        {
            // to ensure "emailAddress" is required (not null)
            if (emailAddress == null)
            {
                throw new InvalidDataException("emailAddress is a required property for ApplicantAddEmail and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as ApplicantAddEmail);
        }

        /// <summary>
        /// Returns true if ApplicantAddEmail instances are equal
        /// </summary>
        /// <param name="input">Instance of ApplicantAddEmail to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApplicantAddEmail input)
        {
            if (input == null)
                return false;
