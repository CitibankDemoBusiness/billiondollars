...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ApplicationAddDemographics :  IEquatable<ApplicationAddDemographics>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ApplicationAddDemographics" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as ApplicationAddDemographics);
        }

        /// <summary>
        /// Returns true if ApplicationAddDemographics instances are equal
        /// </summary>
        /// <param name="input">Instance of ApplicationAddDemographics to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApplicationAddDemographics input)
        {
            if (input == null)
                return false;
