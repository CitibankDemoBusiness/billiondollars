...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ReadyCreditProductAdd :  IEquatable<ReadyCreditProductAdd>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ReadyCreditProductAdd" /> class.
        /// </summary>
        ...
        /// <param name="cardDeliveryAddress">Card delivery address of applicant. This is a reference data field. Please use /v1/utilities/referenceData/{addressType} resource to get valid value of this field with description. You can use addressType field name as the referenceCode parameter to retrieve the values..</param>
        ...
        public ReadyCreditProductAdd(string productCode = default(string), string sourceCode = default(string), string organization = default(string), string logo = default(string), bool? requestCreditShield = default(bool?), string embossName = default(string), string billingAddress = default(string), string cardDeliveryAddress = default(string), string pinDeliveryAddress = default(string), string giftCode = default(string), bool? creditLimitIncreaseIndicator = default(bool?), bool? atmRequiredFlag = default(bool?), bool? chequeBookRequiredFlag = default(bool?), string loanPurpose = default(string), double? requestedCreditLimit = default(double?), List<EqualPaymentPlan> equalPaymentPlan = default(List<EqualPaymentPlan>))
        {
            // to ensure "productCode" is required (not null)
            if (productCode == null)
            {
                throw new InvalidDataException("productCode is a required property for ReadyCreditProductAdd and cannot be null");
            }
            else
            {
            ...
            if (sourceCode == null)
            {
                throw new InvalidDataException("sourceCode is a required property for ReadyCreditProductAdd and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("organization is a required property for ReadyCreditProductAdd and cannot be null");
            }
            else
            {
            ...
            if (logo == null)
            {
                throw new InvalidDataException("logo is a required property for ReadyCreditProductAdd and cannot be null");
            }
            else
            {
                this.Logo = logo;
        ...
        /// </summary>
        /// <value>Card delivery address of applicant. This is a reference data field. Please use /v1/utilities/referenceData/{addressType} resource to get valid value of this field with description. You can use addressType field name as the referenceCode parameter to retrieve the values.</value>
        ...
        public List<EqualPaymentPlan> EqualPaymentPlan { get; set; }
        ...
        {
            return this.Equals(input as ReadyCreditProductAdd);
        }

        /// <summary>
        /// Returns true if ReadyCreditProductAdd instances are equal
        /// </summary>
        /// <param name="input">Instance of ReadyCreditProductAdd to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ReadyCreditProductAdd input)
        {
            if (input == null)
                return false;
