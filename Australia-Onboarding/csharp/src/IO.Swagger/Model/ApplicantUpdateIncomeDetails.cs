...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ApplicantUpdateIncomeDetails :  IEquatable<ApplicantUpdateIncomeDetails>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ApplicantUpdateIncomeDetails" /> class.
        /// </summary>
        ...
        public ApplicantUpdateIncomeDetails(string incomeType = default(string), double? fixedAmount = default(double?), double? variableAmount = default(double?), string frequency = default(string))
        {
        ...
        {
            return this.Equals(input as ApplicantUpdateIncomeDetails);
        }

        /// <summary>
        /// Returns true if ApplicantUpdateIncomeDetails instances are equal
        /// </summary>
        /// <param name="input">Instance of ApplicantUpdateIncomeDetails to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApplicantUpdateIncomeDetails input)
        {
            if (input == null)
                return false;
