...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ApplicationUpdateCountrySpecificGroup :  IEquatable<ApplicationUpdateCountrySpecificGroup>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ApplicationUpdateCountrySpecificGroup" /> class.
        /// </summary>
        ...
        /// <param name="disabilityIndicator">The instruments issued to applicants are provided with special needs like brailed characters on statements. Valid values: true and false. Applicable to Singapore only.</param>
        /// <param name="unionPayCardNumber">Applicant&#x27;s union pay card number to link the product and applicable to China only.</param>
        /// <param name="taxFileNumber">Applicant&#x27;s tax file number to link the product and applicable to Australia only.</param>
        public ApplicationUpdateCountrySpecificGroup(bool? bumiputraIndicator = default(bool?), bool? disabilityIndicator = default(bool?), string unionPayCardNumber = default(string), string taxFileNumber = default(string))
        {
        ...
        /// </summary>
        /// <value>The instruments issued to applicants are provided with special needs like brailed characters on statements. Valid values: true and false. Applicable to Singapore only</value>
        ...
        /// </summary>
        /// <value>Applicant&#x27;s union pay card number to link the product and applicable to China only</value>
        ...
        /// </summary>
        /// <value>Applicant&#x27;s tax file number to link the product and applicable to Australia only</value>
        ...
        {
            return this.Equals(input as ApplicationUpdateCountrySpecificGroup);
        }

        /// <summary>
        /// Returns true if ApplicationUpdateCountrySpecificGroup instances are equal
        /// </summary>
        /// <param name="input">Instance of ApplicationUpdateCountrySpecificGroup to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApplicationUpdateCountrySpecificGroup input)
        {
            if (input == null)
                return false;
