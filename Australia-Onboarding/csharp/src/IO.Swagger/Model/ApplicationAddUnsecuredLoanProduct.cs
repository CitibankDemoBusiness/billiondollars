...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ApplicationAddUnsecuredLoanProduct :  IEquatable<ApplicationAddUnsecuredLoanProduct>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ApplicationAddUnsecuredLoanProduct" /> class.
        /// </summary>
        ...
        public ApplicationAddUnsecuredLoanProduct(string productCode = default(string), string sourceCode = default(string), string organization = default(string), string logo = default(string), bool? requestCreditShield = default(bool?), string billingAddress = default(string), string giftCode = default(string), double? requestedLoanAmount = default(double?), string tenor = default(string))
        {
            ...
            if (sourceCode == null)
            {
                throw new InvalidDataException("sourceCode is a required property for ApplicationAddUnsecuredLoanProduct and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("organization is a required property for ApplicationAddUnsecuredLoanProduct and cannot be null");
            }
            else
            {
            ...
            if (logo == null)
            {
                throw new InvalidDataException("logo is a required property for ApplicationAddUnsecuredLoanProduct and cannot be null");
            }
            else
            {
                this.Logo = logo;
        ...
        {
            return this.Equals(input as ApplicationAddUnsecuredLoanProduct);
        }

        /// <summary>
        /// Returns true if ApplicationAddUnsecuredLoanProduct instances are equal
        /// </summary>
        /// <param name="input">Instance of ApplicationAddUnsecuredLoanProduct to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApplicationAddUnsecuredLoanProduct input)
        {
            if (input == null)
                return false;
