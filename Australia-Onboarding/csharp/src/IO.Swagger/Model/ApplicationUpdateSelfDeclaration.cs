...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ApplicationUpdateSelfDeclaration :  IEquatable<ApplicationUpdateSelfDeclaration>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ApplicationUpdateSelfDeclaration" /> class.
        /// </summary>
        /// <param name="totalActiveCreditCardLimitAmount">Total active credit card amount.</param>
        ...
        /// <param name="monthlyRepaymentForAllExtLoans">Applicants declaration for his/her total monthly repayment amount for all the external loans..</param>
        public ApplicationUpdateSelfDeclaration(double? totalActiveCreditCardLimitAmount = default(double?), string anticipatedIncomeDecreaseCode = default(string), bool? loanTakenIndicator = default(bool?), double? monthlyRepaymentForAllExtLoans = default(double?))
        {
        ...
        /// </summary>
        /// <value>Total active credit card amount</value>
        ...
        /// </summary>
        /// <value>Applicants declaration for his/her total monthly repayment amount for all the external loans.</value>
        ...
        {
            return this.Equals(input as ApplicationUpdateSelfDeclaration);
        }

        /// <summary>
        /// Returns true if ApplicationUpdateSelfDeclaration instances are equal
        /// </summary>
        /// <param name="input">Instance of ApplicationUpdateSelfDeclaration to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApplicationUpdateSelfDeclaration input)
        {
            if (input == null)
                return false;
