...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ApplicationInquiryEducation :  IEquatable<ApplicationInquiryEducation>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ApplicationInquiryEducation" /> class.
        /// </summary>
        ...
        /// <param name="university">University name. This is a reference data field. Please use /v1/apac/utilities/referenceData/{universityCode} resource to get valid value of this field with description. You can use university field name as the referenceCode parameter to retrieve the values..</param>
        public ApplicationInquiryEducation(string highestEducationLevel = default(string), string yearOfGraduation = default(string), string studentId = default(string), string university = default(string))
        {
        ...
        /// </summary>
        /// <value>University name. This is a reference data field. Please use /v1/apac/utilities/referenceData/{universityCode} resource to get valid value of this field with description. You can use university field name as the referenceCode parameter to retrieve the values.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ApplicationInquiryEducation {\n");
        ...
        {
            return this.Equals(input as ApplicationInquiryEducation);
        }

        /// <summary>
        /// Returns true if ApplicationInquiryEducation instances are equal
        /// </summary>
        /// <param name="input">Instance of ApplicationInquiryEducation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApplicationInquiryEducation input)
        {
            if (input == null)
                return false;
