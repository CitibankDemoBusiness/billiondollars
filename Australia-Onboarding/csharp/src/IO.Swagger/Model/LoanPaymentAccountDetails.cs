...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class LoanPaymentAccountDetails :  IEquatable<LoanPaymentAccountDetails>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LoanPaymentAccountDetails" /> class.
        /// </summary>
        ...
        /// <param name="bankName">Indicates the bank name of the customer&#x27;s account to which the loan amount will be transferred. Also, indicates the bank name of the customer&#x27;s account from which the repayment of the loan will be debited. Please use /v1/utilities/referenceData/{bankName} resource to get valid value of this field with description..</param>
        ...
        public LoanPaymentAccountDetails(double? disbursementAmount = default(double?), string loanDisbursementMethod = default(string), string accountReferenceKey = default(string), string displayAccountNumber = default(string), string accountNickName = default(string), string bankName = default(string), string bankCode = default(string), string branchCode = default(string))
        {
        ...
        {
            return this.Equals(input as LoanPaymentAccountDetails);
        }

        /// <summary>
        /// Returns true if LoanPaymentAccountDetails instances are equal
        /// </summary>
        /// <param name="input">Instance of LoanPaymentAccountDetails to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LoanPaymentAccountDetails input)
        {
            if (input == null)
                return false;
