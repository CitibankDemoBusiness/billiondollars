...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ApplicantInquiryCountrySpecificAddress :  IEquatable<ApplicantInquiryCountrySpecificAddress>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ApplicantInquiryCountrySpecificAddress" /> class.
        /// </summary>
        ...
        public ApplicantInquiryCountrySpecificAddress(string unitNumber = default(string), string floorNumber = default(string), string blockNumber = default(string), string buildingName = default(string), string estateName = default(string), string streetNumber = default(string), string streetName = default(string), string streetType = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ApplicantInquiryCountrySpecificAddress {\n");
        ...
        {
            return this.Equals(input as ApplicantInquiryCountrySpecificAddress);
        }

        /// <summary>
        /// Returns true if ApplicantInquiryCountrySpecificAddress instances are equal
        /// </summary>
        /// <param name="input">Instance of ApplicantInquiryCountrySpecificAddress to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApplicantInquiryCountrySpecificAddress input)
        {
            if (input == null)
                return false;
