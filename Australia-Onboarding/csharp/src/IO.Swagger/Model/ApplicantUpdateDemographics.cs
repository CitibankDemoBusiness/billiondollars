...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ApplicantUpdateDemographics :  IEquatable<ApplicantUpdateDemographics>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ApplicantUpdateDemographics" /> class.
        /// </summary>
        ...
        public ApplicantUpdateDemographics(string gender = default(string), DateTime? dateOfBirth = default(DateTime?), string placeOfBirth = default(string), string countryOfBirth = default(string), string nationality = default(string), string maritalStatus = default(string), string residentialStatus = default(string))
        {
            this.Gender = gender;
        ...
        {
            return this.Equals(input as ApplicantUpdateDemographics);
        }

        /// <summary>
        /// Returns true if ApplicantUpdateDemographics instances are equal
        /// </summary>
        /// <param name="input">Instance of ApplicantUpdateDemographics to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApplicantUpdateDemographics input)
        {
            if (input == null)
                return false;
