...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ApplicantAddName :  IEquatable<ApplicantAddName>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ApplicantAddName" /> class.
        /// </summary>
        ...
        public ApplicantAddName(string salutation = default(string), string givenName = default(string), string middleName = default(string), string surname = default(string), string aliasName = default(string))
        {
            // to ensure "givenName" is required (not null)
            if (givenName == null)
            {
                throw new InvalidDataException("givenName is a required property for ApplicantAddName and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as ApplicantAddName);
        }

        /// <summary>
        /// Returns true if ApplicantAddName instances are equal
        /// </summary>
        /// <param name="input">Instance of ApplicantAddName to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApplicantAddName input)
        {
            if (input == null)
                return false;
