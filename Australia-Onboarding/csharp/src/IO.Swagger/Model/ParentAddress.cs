...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ParentAddress :  IEquatable<ParentAddress>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ParentAddress" /> class.
        /// </summary>
        ...
        /// <param name="okToMail">Parent&#x27;s consent for receiving mail. Valid values: true and false.</param>
        /// <param name="residenceDurationInYears">Parent&#x27;s residence duration in the current address in years. Applicable only for residential address..</param>
        /// <param name="residenceDurationInMonths">Parent&#x27;s residence duration in the current address in months. Applicable only for residential address..</param>
        /// <param name="countrySpecificAddress">countrySpecificAddress.</param>
        public ParentAddress(string addressType = default(string), string addressLine1 = default(string), string addressLine2 = default(string), string addressLine3 = default(string), string addressLine4 = default(string), string cityName = default(string), string state = default(string), string postalCode = default(string), string provinceCode = default(string), string countryCode = default(string), bool? okToMail = default(bool?), int? residenceDurationInYears = default(int?), int? residenceDurationInMonths = default(int?), ParentCountrySpecificAddress countrySpecificAddress = default(ParentCountrySpecificAddress))
        {
        ...
        /// </summary>
        /// <value>Parent&#x27;s consent for receiving mail. Valid values: true and false</value>
        ...
        /// </summary>
        /// <value>Parent&#x27;s residence duration in the current address in years. Applicable only for residential address.</value>
        ...
        /// </summary>
        /// <value>Parent&#x27;s residence duration in the current address in months. Applicable only for residential address.</value>
        ...
        public ParentCountrySpecificAddress CountrySpecificAddress { get; set; }
        ...
        {
            return this.Equals(input as ParentAddress);
        }

        /// <summary>
        /// Returns true if ParentAddress instances are equal
        /// </summary>
        /// <param name="input">Instance of ParentAddress to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ParentAddress input)
        {
            if (input == null)
                return false;
