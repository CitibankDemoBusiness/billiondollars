...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ApplicantAddRequest :  IEquatable<ApplicantAddRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ApplicantAddRequest" /> class.
        /// </summary>
        ...
        public ApplicantAddRequest(string controlFlowId = default(string), ApplicantAddApplicant applicant = default(ApplicantAddApplicant), ApplicantAddCreditCardProduct creditCardProduct = default(ApplicantAddCreditCardProduct))
        {
            // to ensure "controlFlowId" is required (not null)
            if (controlFlowId == null)
            {
                throw new InvalidDataException("controlFlowId is a required property for ApplicantAddRequest and cannot be null");
            }
            else
            {
            ...
            if (applicant == null)
            {
                throw new InvalidDataException("applicant is a required property for ApplicantAddRequest and cannot be null");
            }
            else
            {
        ...
        public ApplicantAddApplicant Applicant { get; set; }

        /// <summary>
        /// Gets or Sets CreditCardProduct
        /// </summary>
        [DataMember(Name="creditCardProduct", EmitDefaultValue=false)]
        public ApplicantAddCreditCardProduct CreditCardProduct { get; set; }
        ...
        {
            return this.Equals(input as ApplicantAddRequest);
        }

        /// <summary>
        /// Returns true if ApplicantAddRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of ApplicantAddRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApplicantAddRequest input)
        {
            if (input == null)
                return false;
