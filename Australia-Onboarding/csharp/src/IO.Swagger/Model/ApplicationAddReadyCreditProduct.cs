...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ApplicationAddReadyCreditProduct :  IEquatable<ApplicationAddReadyCreditProduct>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ApplicationAddReadyCreditProduct" /> class.
        /// </summary>
        ...
        public ApplicationAddReadyCreditProduct(string productCode = default(string), string sourceCode = default(string), string organization = default(string), string logo = default(string), bool? requestCreditShield = default(bool?), string embossName = default(string), string billingAddress = default(string), string cardDeliveryAddress = default(string), string pinDeliveryAddress = default(string), string giftCode = default(string), bool? creditLimitIncreaseIndicator = default(bool?), bool? atmRequiredFlag = default(bool?), bool? chequeBookRequiredFlag = default(bool?))
        {
            ...
            if (sourceCode == null)
            {
                throw new InvalidDataException("sourceCode is a required property for ApplicationAddReadyCreditProduct and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("organization is a required property for ApplicationAddReadyCreditProduct and cannot be null");
            }
            else
            {
            ...
            if (logo == null)
            {
                throw new InvalidDataException("logo is a required property for ApplicationAddReadyCreditProduct and cannot be null");
            }
            else
            {
                this.Logo = logo;
        ...
        {
            return this.Equals(input as ApplicationAddReadyCreditProduct);
        }

        /// <summary>
        /// Returns true if ApplicationAddReadyCreditProduct instances are equal
        /// </summary>
        /// <param name="input">Instance of ApplicationAddReadyCreditProduct to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApplicationAddReadyCreditProduct input)
        {
            if (input == null)
                return false;
