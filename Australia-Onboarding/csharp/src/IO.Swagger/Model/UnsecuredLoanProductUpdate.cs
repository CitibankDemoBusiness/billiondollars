...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class UnsecuredLoanProductUpdate :  IEquatable<UnsecuredLoanProductUpdate>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UnsecuredLoanProductUpdate" /> class.
        /// </summary>
        ...
        public UnsecuredLoanProductUpdate(string productCode = default(string), string sourceCode = default(string), string organization = default(string), string logo = default(string), bool? requestCreditShield = default(bool?), string billingAddress = default(string), string giftCode = default(string), double? requestedLoanAmount = default(double?), string disbursementOption = default(string), string loanPurpose = default(string), string tenor = default(string), string tenor1 = default(string), string penaltyScheme = default(string), LoanRepaymentDetails loanRepaymentDetails = default(LoanRepaymentDetails), List<LoanPaymentAccountDetails> loanPaymentAccountDetails = default(List<LoanPaymentAccountDetails>))
        {
        ...
        {
            return this.Equals(input as UnsecuredLoanProductUpdate);
        }

        /// <summary>
        /// Returns true if UnsecuredLoanProductUpdate instances are equal
        /// </summary>
        /// <param name="input">Instance of UnsecuredLoanProductUpdate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UnsecuredLoanProductUpdate input)
        {
            if (input == null)
                return false;
