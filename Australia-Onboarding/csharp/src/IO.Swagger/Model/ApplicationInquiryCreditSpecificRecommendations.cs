...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ApplicationInquiryCreditSpecificRecommendations :  IEquatable<ApplicationInquiryCreditSpecificRecommendations>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ApplicationInquiryCreditSpecificRecommendations" /> class.
        /// </summary>
        /// <param name="recommendedCreditLimit">Recommended credit limit.</param>
        ...
        /// <param name="eppMaximumLoanPercentage">Equal payment plan max loan percentage. Applicable to Counter and Cross-sell offers.</param>
        ...
        /// </summary>
        /// <value>Recommended credit limit</value>
        ...
        /// </summary>
        /// <value>Equal payment plan max loan percentage. Applicable to Counter and Cross-sell offers</value>
        ...
        {
            return this.Equals(input as ApplicationInquiryCreditSpecificRecommendations);
        }

        /// <summary>
        /// Returns true if ApplicationInquiryCreditSpecificRecommendations instances are equal
        /// </summary>
        /// <param name="input">Instance of ApplicationInquiryCreditSpecificRecommendations to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApplicationInquiryCreditSpecificRecommendations input)
        {
            if (input == null)
                return false;
