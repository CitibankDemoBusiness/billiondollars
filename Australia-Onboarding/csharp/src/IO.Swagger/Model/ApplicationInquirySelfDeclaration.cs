...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ApplicationInquirySelfDeclaration :  IEquatable<ApplicationInquirySelfDeclaration>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ApplicationInquirySelfDeclaration" /> class.
        /// </summary>
        ...
        public ApplicationInquirySelfDeclaration(double? totalActiveCreditCardLimitAmount = default(double?), string anticipatedIncomeDecreaseCode = default(string), bool? loanTakenIndicator = default(bool?), double? monthlyRepaymentForAllExtLoans = default(double?))
        {
        ...
        {
            return this.Equals(input as ApplicationInquirySelfDeclaration);
        }

        /// <summary>
        /// Returns true if ApplicationInquirySelfDeclaration instances are equal
        /// </summary>
        /// <param name="input">Instance of ApplicationInquirySelfDeclaration to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApplicationInquirySelfDeclaration input)
        {
            if (input == null)
                return false;
