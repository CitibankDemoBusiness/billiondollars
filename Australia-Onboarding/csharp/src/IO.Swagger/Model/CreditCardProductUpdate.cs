...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class CreditCardProductUpdate :  IEquatable<CreditCardProductUpdate>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreditCardProductUpdate" /> class.
        /// </summary>
        ...
        /// <param name="billingAddress">Billing address of applicant. This is a reference data data field. Please use /v1/utilities/referenceData/{addressType} resource to get valid value of this field with description..</param>
        /// <param name="cardDeliveryAddress">Card delivery address of applicant. This is a reference data data field. Please use /v1/utilities/referenceData/{addressType} resource to get valid value of this field with description..</param>
        /// <param name="pinDeliveryAddress">Delivery address  for card pin of applicant. This is a reference data data field. Please use /v1/utilities/referenceData/{addressType} resource to get valid value of this field with description..</param>
        ...
        /// <param name="creditLimitAcceptedFlag">Flag to indicate acceptance of customer for the credit card limit..</param>
        public CreditCardProductUpdate(string productCode = default(string), string sourceCode = default(string), string organization = default(string), string logo = default(string), bool? requestCreditShield = default(bool?), double? requestedCreditLimit = default(double?), string embossName = default(string), string billingAddress = default(string), string cardDeliveryAddress = default(string), string pinDeliveryAddress = default(string), string cardDeliveryBranch = default(string), string cardDeliveryOption = default(string), string giftCode = default(string), bool? creditLimitIncreaseIndicator = default(bool?), List<BalanceTransferDetails> balanceTransferDetails = default(List<BalanceTransferDetails>), bool? creditLimitAcceptedFlag = default(bool?))
        {
        ...
        /// </summary>
        /// <value>Billing address of applicant. This is a reference data data field. Please use /v1/utilities/referenceData/{addressType} resource to get valid value of this field with description.</value>
        ...
        /// </summary>
        /// <value>Card delivery address of applicant. This is a reference data data field. Please use /v1/utilities/referenceData/{addressType} resource to get valid value of this field with description.</value>
        ...
        /// </summary>
        /// <value>Delivery address  for card pin of applicant. This is a reference data data field. Please use /v1/utilities/referenceData/{addressType} resource to get valid value of this field with description.</value>
        ...
        /// </summary>
        /// <value>Flag to indicate acceptance of customer for the credit card limit.</value>
        ...
        {
            return this.Equals(input as CreditCardProductUpdate);
        }

        /// <summary>
        /// Returns true if CreditCardProductUpdate instances are equal
        /// </summary>
        /// <param name="input">Instance of CreditCardProductUpdate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreditCardProductUpdate input)
        {
            if (input == null)
                return false;
