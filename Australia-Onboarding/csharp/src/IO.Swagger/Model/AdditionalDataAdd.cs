...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class AdditionalDataAdd :  IEquatable<AdditionalDataAdd>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AdditionalDataAdd" /> class.
        /// </summary>
        ...
        public AdditionalDataAdd(string accountFundSource = default(string), decimal? numberOfDependents = default(decimal?), bool? staffIndicator = default(bool?), string businessNature = default(string), string emergencyContactName = default(string), string emergencyContactSurname = default(string), string emergencyContactRelationship = default(string), string emergencyContactPhoneNumber = default(string), bool? overLimitConsentFlag = default(bool?), CountrySpecificGroup countrySpecificGroup = default(CountrySpecificGroup), PrimaryBankDetails primaryBankDetails = default(PrimaryBankDetails), string referralGivenName = default(string), string referralSurname = default(string), string referralCode = default(string), string mediaId = default(string), string introducerId = default(string), bool? relatedToCitiEmployeeFlag = default(bool?), string relatedCitiEmployeeName = default(string), string relatedCitiEmployeeDepartment = default(string), string creditCardUsagePurpose = default(string), bool? cashPinFlag = default(bool?), ReferralTracking referralTracking = default(ReferralTracking), UtilityBillDetails utilityBillDetails = default(UtilityBillDetails), string feeCode = default(string), string billingCycleDay = default(string), string applicationReferenceId = default(string), string customerSegment = default(string), string printingSerialNumber = default(string), string additionalInformation = default(string), TradeReferenceDetails tradeReferenceDetails = default(TradeReferenceDetails), string bureauSessionId_ = default(string))
        {
        ...
        {
            return this.Equals(input as AdditionalDataAdd);
        }

        /// <summary>
        /// Returns true if AdditionalDataAdd instances are equal
        /// </summary>
        /// <param name="input">Instance of AdditionalDataAdd to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AdditionalDataAdd input)
        {
            if (input == null)
                return false;
