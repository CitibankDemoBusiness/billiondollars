...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ECMName :  IEquatable<ECMName>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ECMName" /> class.
        /// </summary>
        ...
        public ECMName(string salutation = default(string), string givenName = default(string), string middleName = default(string), string surname = default(string))
        {
            // to ensure "givenName" is required (not null)
            if (givenName == null)
            {
                throw new InvalidDataException("givenName is a required property for ECMName and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as ECMName);
        }

        /// <summary>
        /// Returns true if ECMName instances are equal
        /// </summary>
        /// <param name="input">Instance of ECMName to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ECMName input)
        {
            if (input == null)
                return false;
