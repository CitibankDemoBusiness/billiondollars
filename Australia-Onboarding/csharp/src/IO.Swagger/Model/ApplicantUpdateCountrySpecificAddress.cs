...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ApplicantUpdateCountrySpecificAddress :  IEquatable<ApplicantUpdateCountrySpecificAddress>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ApplicantUpdateCountrySpecificAddress" /> class.
        /// </summary>
        ...
        public ApplicantUpdateCountrySpecificAddress(string unitNumber = default(string), string floorNumber = default(string), string blockNumber = default(string), string buildingName = default(string), string estateName = default(string), string streetNumber = default(string), string streetName = default(string), string streetType = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ApplicantUpdateCountrySpecificAddress {\n");
        ...
        {
            return this.Equals(input as ApplicantUpdateCountrySpecificAddress);
        }

        /// <summary>
        /// Returns true if ApplicantUpdateCountrySpecificAddress instances are equal
        /// </summary>
        /// <param name="input">Instance of ApplicantUpdateCountrySpecificAddress to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApplicantUpdateCountrySpecificAddress input)
        {
            if (input == null)
                return false;
