...
namespace IO.Swagger.Model
{
        ...
        public partial class ApplicationUpdateResponse :  IEquatable<ApplicationUpdateResponse>, IValidatableObject
    {
        ...
        public ApplicationUpdateResponse(string applicationStage = default(string))
        {
            // to ensure "applicationStage" is required (not null)
            if (applicationStage == null)
            {
                throw new InvalidDataException("applicationStage is a required property for ApplicationUpdateResponse and cannot be null");
            }
            else
            {
