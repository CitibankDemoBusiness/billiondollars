...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ApplicantInquiryIdentificationDocumentDetails :  IEquatable<ApplicantInquiryIdentificationDocumentDetails>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ApplicantInquiryIdentificationDocumentDetails" /> class.
        /// </summary>
        ...
        /// <param name="idIssueState">State from which identification document was issued.</param>
        ...
        /// </summary>
        /// <value>State from which identification document was issued</value>
        ...
        {
            return this.Equals(input as ApplicantInquiryIdentificationDocumentDetails);
        }

        /// <summary>
        /// Returns true if ApplicantInquiryIdentificationDocumentDetails instances are equal
        /// </summary>
        /// <param name="input">Instance of ApplicantInquiryIdentificationDocumentDetails to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApplicantInquiryIdentificationDocumentDetails input)
        {
            if (input == null)
                return false;
