...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ProductAdd :  IEquatable<ProductAdd>, IValidatableObject
    {
        /// <summary>
        ...
        public ProductAdd(CreditCardProductAdd creditCardProduct = default(CreditCardProductAdd), ReadyCreditProductAdd readyCreditProduct = default(ReadyCreditProductAdd), UnsecuredLoanProductAdd unsecuredLoanProduct = default(UnsecuredLoanProductAdd))
        {
        ...
        {
            return this.Equals(input as ProductAdd);
        }

        /// <summary>
        /// Returns true if ProductAdd instances are equal
        /// </summary>
        /// <param name="input">Instance of ProductAdd to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProductAdd input)
        {
            if (input == null)
                return false;
