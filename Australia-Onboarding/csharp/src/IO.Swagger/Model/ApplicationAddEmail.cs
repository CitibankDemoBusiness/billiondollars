...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ApplicationAddEmail :  IEquatable<ApplicationAddEmail>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ApplicationAddEmail" /> class.
        /// </summary>
        ...
        public ApplicationAddEmail(string emailAddress = default(string), bool? okToEmail = default(bool?), bool? isPreferredEmailAddress = default(bool?))
        {
            // to ensure "emailAddress" is required (not null)
            if (emailAddress == null)
            {
                throw new InvalidDataException("emailAddress is a required property for ApplicationAddEmail and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as ApplicationAddEmail);
        }

        /// <summary>
        /// Returns true if ApplicationAddEmail instances are equal
        /// </summary>
        /// <param name="input">Instance of ApplicationAddEmail to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApplicationAddEmail input)
        {
            if (input == null)
                return false;
