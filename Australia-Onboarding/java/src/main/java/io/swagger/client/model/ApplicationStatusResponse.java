...
import io.swagger.client.model.ApplicationStatusInqRequestedProductDecision;
...
public class ApplicationStatusResponse {
  ...
  private List<ApplicationStatusInqRequestedProductDecision> requestedProductDecision = null;
  ...
  public ApplicationStatusResponse applicationStage(String applicationStage) {
  ...
  **/
  ...
  public ApplicationStatusResponse ipaExpiryDate(LocalDate ipaExpiryDate) {
  ...
  **/
  @Schema(example = "Thu Sep 15 00:00:00 UTC 2016", description = "In principle approval expiration date in  ISO 8601 date format YYYY-MM-DD")
  ...
  public ApplicationStatusResponse requestedProductDecision(List<ApplicationStatusInqRequestedProductDecision> requestedProductDecision) {
    this.requestedProductDecision = requestedProductDecision;
    return this;
  }

  public ApplicationStatusResponse addRequestedProductDecisionItem(ApplicationStatusInqRequestedProductDecision requestedProductDecisionItem) {
    if (this.requestedProductDecision == null) {
      this.requestedProductDecision = new ArrayList<ApplicationStatusInqRequestedProductDecision>();
    }
  ...
  **/
  @Schema(description = "")
  public List<ApplicationStatusInqRequestedProductDecision> getRequestedProductDecision() {
    return requestedProductDecision;
  }

  public void setRequestedProductDecision(List<ApplicationStatusInqRequestedProductDecision> requestedProductDecision) {
    this.requestedProductDecision = requestedProductDecision;
  }

  public ApplicationStatusResponse counterOffers(List<CounterOffer> counterOffers) {
    this.counterOffers = counterOffers;
    return this;
  }

  public ApplicationStatusResponse addCounterOffersItem(CounterOffer counterOffersItem) {
  ...
  **/
  ...
  public ApplicationStatusResponse crossSellOffers(List<CrossSellOffer> crossSellOffers) {
    this.crossSellOffers = crossSellOffers;
    return this;
  }

  public ApplicationStatusResponse addCrossSellOffersItem(CrossSellOffer crossSellOffersItem) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.applicationStage, applicationStatusResponse.applicationStage) &&
        Objects.equals(this.ipaExpiryDate, applicationStatusResponse.ipaExpiryDate) &&
        Objects.equals(this.requestedProductDecision, applicationStatusResponse.requestedProductDecision) &&
        Objects.equals(this.counterOffers, applicationStatusResponse.counterOffers) &&
        Objects.equals(this.crossSellOffers, applicationStatusResponse.crossSellOffers);
  }
