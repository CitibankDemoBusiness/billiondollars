...
import io.swagger.client.model.ApplicationInquiryCountrySpecificAddress;
...
public class ApplicationInquiryAddress {
  ...
  private ApplicationInquiryCountrySpecificAddress countrySpecificAddress = null;

  public ApplicationInquiryAddress addressType(String addressType) {
  ...
  **/
  ...
  public ApplicationInquiryAddress addressLine1(String addressLine1) {
  ...
  **/
  ...
  public ApplicationInquiryAddress addressLine2(String addressLine2) {
  ...
  **/
  ...
  public ApplicationInquiryAddress addressLine3(String addressLine3) {
  ...
  **/
  ...
  public ApplicationInquiryAddress addressLine4(String addressLine4) {
  ...
  **/
  ...
  public ApplicationInquiryAddress cityName(String cityName) {
  ...
  **/
  ...
  public ApplicationInquiryAddress state(String state) {
    this.state = state;
    return this;
  }
  ...
  **/
  ...
  public ApplicationInquiryAddress postalCode(String postalCode) {
  ...
  **/
  ...
  public ApplicationInquiryAddress provinceCode(String provinceCode) {
  ...
  **/
  ...
  public ApplicationInquiryAddress countryCode(String countryCode) {
  ...
  **/
  ...
  public ApplicationInquiryAddress okToMail(Boolean okToMail) {
  ...
  **/
  ...
  public ApplicationInquiryAddress residenceDurationInYears(Integer residenceDurationInYears) {
  ...
  **/
  ...
  public ApplicationInquiryAddress residenceDurationInMonths(Integer residenceDurationInMonths) {
  ...
  **/
  ...
  public ApplicationInquiryAddress countrySpecificAddress(ApplicationInquiryCountrySpecificAddress countrySpecificAddress) {
  ...
  **/
  @Schema(description = "")
  public ApplicationInquiryCountrySpecificAddress getCountrySpecificAddress() {
    return countrySpecificAddress;
  }

  public void setCountrySpecificAddress(ApplicationInquiryCountrySpecificAddress countrySpecificAddress) {
    this.countrySpecificAddress = countrySpecificAddress;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    ApplicationInquiryAddress applicationInquiryAddress = (ApplicationInquiryAddress) o;
    return Objects.equals(this.addressType, applicationInquiryAddress.addressType) &&
        Objects.equals(this.addressLine1, applicationInquiryAddress.addressLine1) &&
        Objects.equals(this.addressLine2, applicationInquiryAddress.addressLine2) &&
        Objects.equals(this.addressLine3, applicationInquiryAddress.addressLine3) &&
        Objects.equals(this.addressLine4, applicationInquiryAddress.addressLine4) &&
        Objects.equals(this.cityName, applicationInquiryAddress.cityName) &&
        Objects.equals(this.state, applicationInquiryAddress.state) &&
        Objects.equals(this.postalCode, applicationInquiryAddress.postalCode) &&
        Objects.equals(this.provinceCode, applicationInquiryAddress.provinceCode) &&
        Objects.equals(this.countryCode, applicationInquiryAddress.countryCode) &&
        Objects.equals(this.okToMail, applicationInquiryAddress.okToMail) &&
        Objects.equals(this.residenceDurationInYears, applicationInquiryAddress.residenceDurationInYears) &&
        Objects.equals(this.residenceDurationInMonths, applicationInquiryAddress.residenceDurationInMonths) &&
        Objects.equals(this.countrySpecificAddress, applicationInquiryAddress.countrySpecificAddress);
  }
