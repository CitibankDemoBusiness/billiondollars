...
public class ApplicationUpdateEducation {
  ...
  public ApplicationUpdateEducation highestEducationLevel(String highestEducationLevel) {
  ...
  **/
  ...
  public ApplicationUpdateEducation yearOfGraduation(String yearOfGraduation) {
  ...
  **/
  ...
  public ApplicationUpdateEducation studentId(String studentId) {
  ...
  **/
  ...
  public ApplicationUpdateEducation university(String university) {
   ...
   * @return university
  **/
  @Schema(example = "NTU", description = "University name. This is a reference data data field. Please use /v1/apac/utilities/referenceData/{universityCode} resource to get valid value of this field with description. You can use university field name as the referenceCode parameter to retrieve the values.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    ApplicationUpdateEducation applicationUpdateEducation = (ApplicationUpdateEducation) o;
    return Objects.equals(this.highestEducationLevel, applicationUpdateEducation.highestEducationLevel) &&
        Objects.equals(this.yearOfGraduation, applicationUpdateEducation.yearOfGraduation) &&
        Objects.equals(this.studentId, applicationUpdateEducation.studentId) &&
        Objects.equals(this.university, applicationUpdateEducation.university);
  }
