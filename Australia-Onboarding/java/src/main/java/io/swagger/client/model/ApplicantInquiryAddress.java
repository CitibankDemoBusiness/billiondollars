...
import io.swagger.client.model.ApplicantInquiryCountrySpecificAddress;
...
public class ApplicantInquiryAddress {
  ...
  private ApplicantInquiryCountrySpecificAddress countrySpecificAddress = null;

  public ApplicantInquiryAddress addressType(String addressType) {
  ...
  **/
  ...
  public ApplicantInquiryAddress addressLine1(String addressLine1) {
  ...
  **/
  ...
  public ApplicantInquiryAddress addressLine2(String addressLine2) {
  ...
  **/
  ...
  public ApplicantInquiryAddress addressLine3(String addressLine3) {
  ...
  **/
  ...
  public ApplicantInquiryAddress addressLine4(String addressLine4) {
  ...
  **/
  ...
  public ApplicantInquiryAddress cityName(String cityName) {
  ...
  **/
  ...
  public ApplicantInquiryAddress state(String state) {
    this.state = state;
    return this;
  }
  ...
  **/
  ...
  public ApplicantInquiryAddress postalCode(String postalCode) {
  ...
  **/
  ...
  public ApplicantInquiryAddress countryCode(String countryCode) {
  ...
  **/
  ...
  public ApplicantInquiryAddress residenceDurationInYears(Integer residenceDurationInYears) {
  ...
  **/
  ...
  public ApplicantInquiryAddress residenceDurationInMonths(Integer residenceDurationInMonths) {
  ...
  **/
  ...
  public ApplicantInquiryAddress countrySpecificAddress(ApplicantInquiryCountrySpecificAddress countrySpecificAddress) {
  ...
  **/
  @Schema(description = "")
  public ApplicantInquiryCountrySpecificAddress getCountrySpecificAddress() {
    return countrySpecificAddress;
  }

  public void setCountrySpecificAddress(ApplicantInquiryCountrySpecificAddress countrySpecificAddress) {
    this.countrySpecificAddress = countrySpecificAddress;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    ApplicantInquiryAddress applicantInquiryAddress = (ApplicantInquiryAddress) o;
    return Objects.equals(this.addressType, applicantInquiryAddress.addressType) &&
        Objects.equals(this.addressLine1, applicantInquiryAddress.addressLine1) &&
        Objects.equals(this.addressLine2, applicantInquiryAddress.addressLine2) &&
        Objects.equals(this.addressLine3, applicantInquiryAddress.addressLine3) &&
        Objects.equals(this.addressLine4, applicantInquiryAddress.addressLine4) &&
        Objects.equals(this.cityName, applicantInquiryAddress.cityName) &&
        Objects.equals(this.state, applicantInquiryAddress.state) &&
        Objects.equals(this.postalCode, applicantInquiryAddress.postalCode) &&
        Objects.equals(this.countryCode, applicantInquiryAddress.countryCode) &&
        Objects.equals(this.residenceDurationInYears, applicantInquiryAddress.residenceDurationInYears) &&
        Objects.equals(this.residenceDurationInMonths, applicantInquiryAddress.residenceDurationInMonths) &&
        Objects.equals(this.countrySpecificAddress, applicantInquiryAddress.countrySpecificAddress);
  }
  ...
  public String toString() {
    ...
    sb.append("class ApplicantInquiryAddress {\n");
