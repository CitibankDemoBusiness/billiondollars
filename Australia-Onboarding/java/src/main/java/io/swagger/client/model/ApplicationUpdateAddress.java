...
import io.swagger.client.model.ApplicationUpdateCountrySpecificAddress;
...
public class ApplicationUpdateAddress {
  ...
  private ApplicationUpdateCountrySpecificAddress countrySpecificAddress = null;

  public ApplicationUpdateAddress addressType(String addressType) {
   ...
   * @return addressType
  **/
  @Schema(example = "HOME_ADDRESS", description = "Type of address. This is a reference data data field. Please use /v1/apac/utilities/referenceData/{addressType} resource to get valid value of this field with description. You can use the field name as the referenceCode parameter to retrieve the values.")
  ...
  public ApplicationUpdateAddress addressLine1(String addressLine1) {
  ...
  **/
  ...
  public ApplicationUpdateAddress addressLine2(String addressLine2) {
  ...
  **/
  ...
  public ApplicationUpdateAddress addressLine3(String addressLine3) {
  ...
  **/
  ...
  public ApplicationUpdateAddress addressLine4(String addressLine4) {
  ...
  **/
  ...
  public ApplicationUpdateAddress cityName(String cityName) {
  ...
  **/
  ...
  public ApplicationUpdateAddress state(String state) {
    this.state = state;
    return this;
  }
  ...
  **/
  ...
  public ApplicationUpdateAddress postalCode(String postalCode) {
   ...
   * @return postalCode
  **/
  @Schema(example = "238838", description = "Postal/ZIP code")
  ...
  public ApplicationUpdateAddress provinceCode(String provinceCode) {
  ...
  **/
  ...
  public ApplicationUpdateAddress countryCode(String countryCode) {
   ...
   * @return countryCode
  **/
  @Schema(example = "SG", description = "ISO country code. This is a reference data data field. Please use /v1/apac/utilities/referenceData/{country} resource to get valid value of this field with description. You can use countryCode field name as the referenceCode parameter to retrieve the values.")
  ...
  public ApplicationUpdateAddress okToMail(Boolean okToMail) {
  ...
  **/
  ...
  public ApplicationUpdateAddress residenceDurationInYears(Integer residenceDurationInYears) {
  ...
  **/
  ...
  public ApplicationUpdateAddress residenceDurationInMonths(Integer residenceDurationInMonths) {
  ...
  **/
  ...
  public ApplicationUpdateAddress countrySpecificAddress(ApplicationUpdateCountrySpecificAddress countrySpecificAddress) {
  ...
  **/
  @Schema(description = "")
  public ApplicationUpdateCountrySpecificAddress getCountrySpecificAddress() {
    return countrySpecificAddress;
  }

  public void setCountrySpecificAddress(ApplicationUpdateCountrySpecificAddress countrySpecificAddress) {
    this.countrySpecificAddress = countrySpecificAddress;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    ApplicationUpdateAddress applicationUpdateAddress = (ApplicationUpdateAddress) o;
    return Objects.equals(this.addressType, applicationUpdateAddress.addressType) &&
        Objects.equals(this.addressLine1, applicationUpdateAddress.addressLine1) &&
        Objects.equals(this.addressLine2, applicationUpdateAddress.addressLine2) &&
        Objects.equals(this.addressLine3, applicationUpdateAddress.addressLine3) &&
        Objects.equals(this.addressLine4, applicationUpdateAddress.addressLine4) &&
        Objects.equals(this.cityName, applicationUpdateAddress.cityName) &&
        Objects.equals(this.state, applicationUpdateAddress.state) &&
        Objects.equals(this.postalCode, applicationUpdateAddress.postalCode) &&
        Objects.equals(this.provinceCode, applicationUpdateAddress.provinceCode) &&
        Objects.equals(this.countryCode, applicationUpdateAddress.countryCode) &&
        Objects.equals(this.okToMail, applicationUpdateAddress.okToMail) &&
        Objects.equals(this.residenceDurationInYears, applicationUpdateAddress.residenceDurationInYears) &&
        Objects.equals(this.residenceDurationInMonths, applicationUpdateAddress.residenceDurationInMonths) &&
        Objects.equals(this.countrySpecificAddress, applicationUpdateAddress.countrySpecificAddress);
  }
