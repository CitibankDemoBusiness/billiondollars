...
public class ApplicationUpdateIdentificationDocumentDetails {
  ...
  public ApplicationUpdateIdentificationDocumentDetails idType(String idType) {
    this.idType = idType;
    return this;
  }
   ...
   * @return idType
  **/
  @Schema(example = "PASSPORT", description = "Type of Identification document. This is a reference data data field. Please use /v1/apac/utilities/referenceData/{idType} resource to get valid values of this field with descriptions")
  ...
  public ApplicationUpdateIdentificationDocumentDetails idNumber(String idNumber) {
  ...
  **/
  ...
  public ApplicationUpdateIdentificationDocumentDetails idExpiryDate(LocalDate idExpiryDate) {
  ...
  **/
  ...
  public ApplicationUpdateIdentificationDocumentDetails idIssueDate(LocalDate idIssueDate) {
  ...
  **/
  ...
  public ApplicationUpdateIdentificationDocumentDetails idIssuePlace(String idIssuePlace) {
  ...
  **/
  ...
  public ApplicationUpdateIdentificationDocumentDetails idIssueState(String idIssueState) {
  ...
  **/
  ...
  public ApplicationUpdateIdentificationDocumentDetails idIssueCountry(String idIssueCountry) {
  ...
  **/
  @Schema(example = "AU", description = "Country of issuance. This is a reference data data field. Please use /v1/apac/utilities/referenceData/{country} resource to get valid value of this field with description. You can use idIssueCountry field name as the referenceCode parameter to retrieve the values.")
  ...
  public ApplicationUpdateIdentificationDocumentDetails isPrimaryId(Boolean isPrimaryId) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    ApplicationUpdateIdentificationDocumentDetails applicationUpdateIdentificationDocumentDetails = (ApplicationUpdateIdentificationDocumentDetails) o;
    return Objects.equals(this.idType, applicationUpdateIdentificationDocumentDetails.idType) &&
        Objects.equals(this.idNumber, applicationUpdateIdentificationDocumentDetails.idNumber) &&
        Objects.equals(this.idExpiryDate, applicationUpdateIdentificationDocumentDetails.idExpiryDate) &&
        Objects.equals(this.idIssueDate, applicationUpdateIdentificationDocumentDetails.idIssueDate) &&
        Objects.equals(this.idIssuePlace, applicationUpdateIdentificationDocumentDetails.idIssuePlace) &&
        Objects.equals(this.idIssueState, applicationUpdateIdentificationDocumentDetails.idIssueState) &&
        Objects.equals(this.idIssueCountry, applicationUpdateIdentificationDocumentDetails.idIssueCountry) &&
        Objects.equals(this.isPrimaryId, applicationUpdateIdentificationDocumentDetails.isPrimaryId);
  }
