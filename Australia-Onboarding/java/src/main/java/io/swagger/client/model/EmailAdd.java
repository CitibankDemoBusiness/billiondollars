...
public class EmailAdd {
  ...
  public EmailAdd emailType(String emailType) {
   ...
   * @return emailType
  **/
  @Schema(example = "PERSONAL", description = "The type of email.  This is a reference data field. Please use /v1/utilities/referenceData/{emailType} resource to get valid value of this field with description.")
  ...
  public EmailAdd emailAddress(String emailAddress) {
  ...
  **/
  ...
  public EmailAdd okToEmail(Boolean okToEmail) {
  ...
  **/
  ...
  public EmailAdd isPreferredEmailAddress(Boolean isPreferredEmailAddress) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    EmailAdd emailAdd = (EmailAdd) o;
    return Objects.equals(this.emailType, emailAdd.emailType) &&
        Objects.equals(this.emailAddress, emailAdd.emailAddress) &&
        Objects.equals(this.okToEmail, emailAdd.okToEmail) &&
        Objects.equals(this.isPreferredEmailAddress, emailAdd.isPreferredEmailAddress);
  }

  @Override
  public int hashCode() {
    return Objects.hash(emailType, emailAddress, okToEmail, isPreferredEmailAddress);
  }
