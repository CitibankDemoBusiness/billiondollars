...
import io.swagger.client.model.LoanPaymentAccountDetailsAdd;
...
public class UnsecuredLoanProductAdd {
  ...
  private List<LoanPaymentAccountDetailsAdd> loanPaymentAccountDetails = null;

  public UnsecuredLoanProductAdd productCode(String productCode) {
  ...
  **/
  ...
  public UnsecuredLoanProductAdd sourceCode(String sourceCode) {
  ...
  **/
  ...
  public UnsecuredLoanProductAdd organization(String organization) {
  ...
  **/
  ...
  public UnsecuredLoanProductAdd logo(String logo) {
    this.logo = logo;
    return this;
  }
  ...
  **/
  ...
  public UnsecuredLoanProductAdd requestCreditShield(Boolean requestCreditShield) {
  ...
  **/
  ...
  public UnsecuredLoanProductAdd billingAddress(String billingAddress) {
  ...
  **/
  ...
  public UnsecuredLoanProductAdd giftCode(String giftCode) {
  ...
  **/
  ...
  public UnsecuredLoanProductAdd requestedLoanAmount(Double requestedLoanAmount) {
  ...
  **/
  ...
  public UnsecuredLoanProductAdd disbursementOption(String disbursementOption) {
  ...
  **/
  ...
  public UnsecuredLoanProductAdd loanPurpose(String loanPurpose) {
  ...
  **/
  ...
  public UnsecuredLoanProductAdd tenor(String tenor) {
    this.tenor = tenor;
    return this;
  }
  ...
  **/
  ...
  public UnsecuredLoanProductAdd tenor1(String tenor1) {
    this.tenor1 = tenor1;
    return this;
  }
  ...
  **/
  ...
  public UnsecuredLoanProductAdd penaltyScheme(String penaltyScheme) {
  ...
  **/
  ...
  public UnsecuredLoanProductAdd loanRepaymentDetails(LoanRepaymentDetails loanRepaymentDetails) {
  ...
  **/
  ...
  public UnsecuredLoanProductAdd loanPaymentAccountDetails(List<LoanPaymentAccountDetailsAdd> loanPaymentAccountDetails) {
    this.loanPaymentAccountDetails = loanPaymentAccountDetails;
    return this;
  }

  public UnsecuredLoanProductAdd addLoanPaymentAccountDetailsItem(LoanPaymentAccountDetailsAdd loanPaymentAccountDetailsItem) {
    if (this.loanPaymentAccountDetails == null) {
      this.loanPaymentAccountDetails = new ArrayList<LoanPaymentAccountDetailsAdd>();
    }
  ...
  **/
  @Schema(description = "")
  public List<LoanPaymentAccountDetailsAdd> getLoanPaymentAccountDetails() {
    return loanPaymentAccountDetails;
  }

  public void setLoanPaymentAccountDetails(List<LoanPaymentAccountDetailsAdd> loanPaymentAccountDetails) {
    this.loanPaymentAccountDetails = loanPaymentAccountDetails;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    UnsecuredLoanProductAdd unsecuredLoanProductAdd = (UnsecuredLoanProductAdd) o;
    return Objects.equals(this.productCode, unsecuredLoanProductAdd.productCode) &&
        Objects.equals(this.sourceCode, unsecuredLoanProductAdd.sourceCode) &&
        Objects.equals(this.organization, unsecuredLoanProductAdd.organization) &&
        Objects.equals(this.logo, unsecuredLoanProductAdd.logo) &&
        Objects.equals(this.requestCreditShield, unsecuredLoanProductAdd.requestCreditShield) &&
        Objects.equals(this.billingAddress, unsecuredLoanProductAdd.billingAddress) &&
        Objects.equals(this.giftCode, unsecuredLoanProductAdd.giftCode) &&
        Objects.equals(this.requestedLoanAmount, unsecuredLoanProductAdd.requestedLoanAmount) &&
        Objects.equals(this.disbursementOption, unsecuredLoanProductAdd.disbursementOption) &&
        Objects.equals(this.loanPurpose, unsecuredLoanProductAdd.loanPurpose) &&
        Objects.equals(this.tenor, unsecuredLoanProductAdd.tenor) &&
        Objects.equals(this.tenor1, unsecuredLoanProductAdd.tenor1) &&
        Objects.equals(this.penaltyScheme, unsecuredLoanProductAdd.penaltyScheme) &&
        Objects.equals(this.loanRepaymentDetails, unsecuredLoanProductAdd.loanRepaymentDetails) &&
        Objects.equals(this.loanPaymentAccountDetails, unsecuredLoanProductAdd.loanPaymentAccountDetails);
  }
