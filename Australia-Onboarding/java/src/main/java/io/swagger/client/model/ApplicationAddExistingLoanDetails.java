...
public class ApplicationAddExistingLoanDetails {
  ...
  public ApplicationAddExistingLoanDetails loanType(String loanType) {
  ...
  **/
  ...
  public ApplicationAddExistingLoanDetails otherDebtObligationType(String otherDebtObligationType) {
  ...
  **/
  @Schema(example = "Free text", description = "Other debt obligation type. Free text if others is selected under loan type. Please use /v1/apac/utilities/referenceData/{otherDebtObligationType} resource to get valid value of this field with description. You can use loanType field name as the referenceCode parameter to retrieve the values.")
  ...
  public ApplicationAddExistingLoanDetails monthlyInstallmentAmount(Double monthlyInstallmentAmount) {
  ...
  **/
  ...
  public ApplicationAddExistingLoanDetails outstandingBalanceAmount(Double outstandingBalanceAmount) {
  ...
  **/
  ...
  public ApplicationAddExistingLoanDetails debtOwnership(String debtOwnership) {
  ...
  **/
  ...
  public ApplicationAddExistingLoanDetails lenderName(String lenderName) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    ApplicationAddExistingLoanDetails applicationAddExistingLoanDetails = (ApplicationAddExistingLoanDetails) o;
    return Objects.equals(this.loanType, applicationAddExistingLoanDetails.loanType) &&
        Objects.equals(this.otherDebtObligationType, applicationAddExistingLoanDetails.otherDebtObligationType) &&
        Objects.equals(this.monthlyInstallmentAmount, applicationAddExistingLoanDetails.monthlyInstallmentAmount) &&
        Objects.equals(this.outstandingBalanceAmount, applicationAddExistingLoanDetails.outstandingBalanceAmount) &&
        Objects.equals(this.debtOwnership, applicationAddExistingLoanDetails.debtOwnership) &&
        Objects.equals(this.lenderName, applicationAddExistingLoanDetails.lenderName);
  }
