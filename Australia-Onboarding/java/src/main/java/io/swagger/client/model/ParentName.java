...
public class ParentName {
  ...
  public ParentName salutation(String salutation) {
  ...
  **/
  ...
  public ParentName givenName(String givenName) {
   ...
   * @return givenName
  **/
  @Schema(example = "Matthew", required = true, description = "Given/first name of the Parent")
  ...
  public ParentName middleName(String middleName) {
   ...
   * @return middleName
  **/
  @Schema(example = "Du", description = "Middle name of the Parent")
  ...
  public ParentName surname(String surname) {
   ...
   * @return surname
  **/
  @Schema(example = "Hayden", description = "Surname/last name of the Parent")
  ...
  public ParentName localEnglishGivenName(String localEnglishGivenName) {
  ...
  **/
  ...
  public ParentName localEnglishSurname(String localEnglishSurname) {
  ...
  **/
  ...
  public ParentName aliasName(String aliasName) {
   ...
   * @return aliasName
  **/
  @Schema(example = "Matt", description = "Alias name of the Parent")
  ...
  public ParentName fullName(String fullName) {
   ...
   * @return fullName
  **/
  @Schema(example = "John Bill Smith", description = "Full name of the Parent.")
  ...
  public ParentName saluteBy(String saluteBy) {
   ...
   * @return saluteBy
  **/
  @Schema(example = "SURNAME", description = "Contains value with which Parent like to be addressed. This is a reference data field. Please use /v1/utilities/referenceData/{saluteBy} resource to get valid value of this field with description.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    ParentName parentName = (ParentName) o;
    return Objects.equals(this.salutation, parentName.salutation) &&
        Objects.equals(this.givenName, parentName.givenName) &&
        Objects.equals(this.middleName, parentName.middleName) &&
        Objects.equals(this.surname, parentName.surname) &&
        Objects.equals(this.localEnglishGivenName, parentName.localEnglishGivenName) &&
        Objects.equals(this.localEnglishSurname, parentName.localEnglishSurname) &&
        Objects.equals(this.aliasName, parentName.aliasName) &&
        Objects.equals(this.fullName, parentName.fullName) &&
        Objects.equals(this.saluteBy, parentName.saluteBy);
  }
