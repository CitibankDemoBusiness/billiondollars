...
public class ApplicantInquiryRequiredDocuments {
  ...
  public ApplicantInquiryRequiredDocuments documentIdType(String documentIdType) {
  ...
  **/
  ...
  public ApplicantInquiryRequiredDocuments documentStatus(String documentStatus) {
  ...
  **/
  ...
  public ApplicantInquiryRequiredDocuments productCode(String productCode) {
  ...
  **/
  ...
  public ApplicantInquiryRequiredDocuments proofType(String proofType) {
  ...
  **/
  ...
  public ApplicantInquiryRequiredDocuments linkedDocumentId(String linkedDocumentId) {
  ...
  **/
  ...
  public ApplicantInquiryRequiredDocuments applicantType(String applicantType) {
  ...
  **/
  @Schema(example = "SUPPLEMENTARY_APPLICANT", description = "Applicant's relationship with the Bank. Currently supported is Primary - P.This is a reference data field. Please use /v1/apac/utilities/referenceData/{applicantType} resource to get valid value of this field with description.You can use the documentType as the referenceCode parameter to retrieve the values.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    ApplicantInquiryRequiredDocuments applicantInquiryRequiredDocuments = (ApplicantInquiryRequiredDocuments) o;
    return Objects.equals(this.documentIdType, applicantInquiryRequiredDocuments.documentIdType) &&
        Objects.equals(this.documentStatus, applicantInquiryRequiredDocuments.documentStatus) &&
        Objects.equals(this.productCode, applicantInquiryRequiredDocuments.productCode) &&
        Objects.equals(this.proofType, applicantInquiryRequiredDocuments.proofType) &&
        Objects.equals(this.linkedDocumentId, applicantInquiryRequiredDocuments.linkedDocumentId) &&
        Objects.equals(this.applicantType, applicantInquiryRequiredDocuments.applicantType);
  }
