...
import io.swagger.client.model.ApplicationInquiryCountrySpecificGroup;
...
public class ApplicationInquiryAdditionalData {
  ...
  private ApplicationInquiryCountrySpecificGroup countrySpecificGroup = null;
  ...
  public ApplicationInquiryAdditionalData numberOfDependents(BigDecimal numberOfDependents) {
  ...
  **/
  ...
  public ApplicationInquiryAdditionalData staffIndicator(Boolean staffIndicator) {
  ...
  **/
  ...
  public ApplicationInquiryAdditionalData businessNature(String businessNature) {
  ...
  **/
  ...
  public ApplicationInquiryAdditionalData emergencyContactName(String emergencyContactName) {
  ...
  **/
  ...
  public ApplicationInquiryAdditionalData emergencyContactPhoneNumber(String emergencyContactPhoneNumber) {
  ...
  **/
  @Schema(example = "64042321", description = "Emergency contact Number.")
  ...
  public ApplicationInquiryAdditionalData overLimitConsentFlag(Boolean overLimitConsentFlag) {
  ...
  **/
  ...
  public ApplicationInquiryAdditionalData countrySpecificGroup(ApplicationInquiryCountrySpecificGroup countrySpecificGroup) {
  ...
  **/
  @Schema(description = "")
  public ApplicationInquiryCountrySpecificGroup getCountrySpecificGroup() {
    return countrySpecificGroup;
  }

  public void setCountrySpecificGroup(ApplicationInquiryCountrySpecificGroup countrySpecificGroup) {
    this.countrySpecificGroup = countrySpecificGroup;
  }

  public ApplicationInquiryAdditionalData referralGivenName(String referralGivenName) {
  ...
  **/
  ...
  public ApplicationInquiryAdditionalData referralSurname(String referralSurname) {
  ...
  **/
  ...
  public ApplicationInquiryAdditionalData relatedToCitiEmployeeFlag(Boolean relatedToCitiEmployeeFlag) {
  ...
  **/
  ...
  public ApplicationInquiryAdditionalData relatedCitiEmployeeName(String relatedCitiEmployeeName) {
  ...
  **/
  ...
  public ApplicationInquiryAdditionalData relatedCitiEmployeeDepartment(String relatedCitiEmployeeDepartment) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    ApplicationInquiryAdditionalData applicationInquiryAdditionalData = (ApplicationInquiryAdditionalData) o;
    return Objects.equals(this.numberOfDependents, applicationInquiryAdditionalData.numberOfDependents) &&
        Objects.equals(this.staffIndicator, applicationInquiryAdditionalData.staffIndicator) &&
        Objects.equals(this.businessNature, applicationInquiryAdditionalData.businessNature) &&
        Objects.equals(this.emergencyContactName, applicationInquiryAdditionalData.emergencyContactName) &&
        Objects.equals(this.emergencyContactPhoneNumber, applicationInquiryAdditionalData.emergencyContactPhoneNumber) &&
        Objects.equals(this.overLimitConsentFlag, applicationInquiryAdditionalData.overLimitConsentFlag) &&
        Objects.equals(this.countrySpecificGroup, applicationInquiryAdditionalData.countrySpecificGroup) &&
        Objects.equals(this.referralGivenName, applicationInquiryAdditionalData.referralGivenName) &&
        Objects.equals(this.referralSurname, applicationInquiryAdditionalData.referralSurname) &&
        Objects.equals(this.relatedToCitiEmployeeFlag, applicationInquiryAdditionalData.relatedToCitiEmployeeFlag) &&
        Objects.equals(this.relatedCitiEmployeeName, applicationInquiryAdditionalData.relatedCitiEmployeeName) &&
        Objects.equals(this.relatedCitiEmployeeDepartment, applicationInquiryAdditionalData.relatedCitiEmployeeDepartment);
  }

  @Override
  public int hashCode() {
    return Objects.hash(numberOfDependents, staffIndicator, businessNature, emergencyContactName, emergencyContactPhoneNumber, overLimitConsentFlag, countrySpecificGroup, referralGivenName, referralSurname, relatedToCitiEmployeeFlag, relatedCitiEmployeeName, relatedCitiEmployeeDepartment);
  }
