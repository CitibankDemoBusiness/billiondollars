...
public class ExistingLoanDetails {
  ...
  public ExistingLoanDetails loanType(String loanType) {
   ...
   * @return loanType
  **/
  @Schema(example = "STUDENT_LOAN", description = "Loan Type.This is a reference data field. Please use /v1/utilities/referenceData/{loanType} resource to get valid value of this field with description.")
  ...
  public ExistingLoanDetails otherDebtObligationType(String otherDebtObligationType) {
  ...
  **/
  @Schema(example = "Free text", description = "Other debt obligation type. Free text if others is selected under loan type.")
  ...
  public ExistingLoanDetails monthlyInstallmentAmount(Double monthlyInstallmentAmount) {
  ...
  **/
  ...
  public ExistingLoanDetails outstandingBalanceAmount(Double outstandingBalanceAmount) {
  ...
  **/
  ...
  public ExistingLoanDetails debtOwnership(String debtOwnership) {
  ...
  **/
  @Schema(example = "JOINT", description = "Nature debt ownership. Please use /v1/utilities/referenceData/{debtOwnership} resource to get valid value of this field with description.")
  ...
  public ExistingLoanDetails lenderName(String lenderName) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    ExistingLoanDetails existingLoanDetails = (ExistingLoanDetails) o;
    return Objects.equals(this.loanType, existingLoanDetails.loanType) &&
        Objects.equals(this.otherDebtObligationType, existingLoanDetails.otherDebtObligationType) &&
        Objects.equals(this.monthlyInstallmentAmount, existingLoanDetails.monthlyInstallmentAmount) &&
        Objects.equals(this.outstandingBalanceAmount, existingLoanDetails.outstandingBalanceAmount) &&
        Objects.equals(this.debtOwnership, existingLoanDetails.debtOwnership) &&
        Objects.equals(this.lenderName, existingLoanDetails.lenderName);
  }
