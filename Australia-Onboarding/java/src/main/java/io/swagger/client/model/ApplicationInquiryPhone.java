...
public class ApplicationInquiryPhone {
  ...
  public ApplicationInquiryPhone phoneType(String phoneType) {
  ...
  **/
  ...
  public ApplicationInquiryPhone phoneCountryCode(String phoneCountryCode) {
  ...
  **/
  @Schema(example = "65", required = true, description = "Country code of phone number")
  ...
  public ApplicationInquiryPhone areaCode(String areaCode) {
  ...
  **/
  ...
  public ApplicationInquiryPhone phoneNumber(String phoneNumber) {
   ...
   * @return phoneNumber
  **/
  @Schema(example = "63492610", required = true, description = "Applicant's phone number")
  ...
  public ApplicationInquiryPhone extension(String extension) {
  ...
  **/
  ...
  public ApplicationInquiryPhone okToSms(Boolean okToSms) {
  ...
  **/
  ...
  public ApplicationInquiryPhone okToCall(Boolean okToCall) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    ApplicationInquiryPhone applicationInquiryPhone = (ApplicationInquiryPhone) o;
    return Objects.equals(this.phoneType, applicationInquiryPhone.phoneType) &&
        Objects.equals(this.phoneCountryCode, applicationInquiryPhone.phoneCountryCode) &&
        Objects.equals(this.areaCode, applicationInquiryPhone.areaCode) &&
        Objects.equals(this.phoneNumber, applicationInquiryPhone.phoneNumber) &&
        Objects.equals(this.extension, applicationInquiryPhone.extension) &&
        Objects.equals(this.okToSms, applicationInquiryPhone.okToSms) &&
        Objects.equals(this.okToCall, applicationInquiryPhone.okToCall);
  }
  ...
  public String toString() {
    ...
    sb.append("class ApplicationInquiryPhone {\n");
