 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ParentPhone implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ParentPhone';
...
'ok_to_call' => 'getOkToCall'    ];
     ...
     * Sets ok_to_sms
     *
     * @param bool $ok_to_sms Parent's consent for receiving sms. This is applicable only if phone type is MOBILE. Valid values: true and false
     *
     * @return $this
     */
     ...
     * Sets ok_to_call
     *
     * @param bool $ok_to_call Parent's consent for receiving phone calls. Valid values: true and false
     *
     * @return $this
     */
