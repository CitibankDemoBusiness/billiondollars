...
/**
 * ExistingLoanDetails Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ExistingLoanDetails implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ExistingLoanDetails';
...
'lender_name' => 'getLenderName'    ];
     ...
     * Sets loan_type
     *
     * @param string $loan_type Loan Type.This is a reference data field. Please use /v1/utilities/referenceData/{loanType} resource to get valid value of this field with description.
     *
     * @return $this
     */
     ...
     *
     * @param string $other_debt_obligation_type Other debt obligation type. Free text if others is selected under loan type.
     *
     * @return $this
     */
     ...
     * Sets debt_ownership
     *
     * @param string $debt_ownership Nature debt ownership. Please use /v1/utilities/referenceData/{debtOwnership} resource to get valid value of this field with description.
     *
     * @return $this
     */
