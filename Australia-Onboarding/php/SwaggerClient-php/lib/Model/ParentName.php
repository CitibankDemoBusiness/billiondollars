 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ParentName implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ParentName';
...
'salute_by' => 'getSaluteBy'    ];
     ...
     * Sets salutation
     *
     * @param string $salutation Salutation. This is a reference data field. Please use /v1/utilities/referenceData/{salutation} resource to get valid value of this field with description.
     *
     * @return $this
     */
     ...
     * Sets given_name
     *
     * @param string $given_name Given/first name of the Parent
     *
     * @return $this
     */
     ...
     * Sets middle_name
     *
     * @param string $middle_name Middle name of the Parent
     *
     * @return $this
     */
     ...
     * Sets surname
     *
     * @param string $surname Surname/last name of the Parent
     *
     * @return $this
     */
     ...
     * Sets alias_name
     *
     * @param string $alias_name Alias name of the Parent
     *
     * @return $this
     */
     ...
     * Sets full_name
     *
     * @param string $full_name Full name of the Parent.
     *
     * @return $this
     */
     ...
     * Sets salute_by
     *
     * @param string $salute_by Contains value with which Parent like to be addressed. This is a reference data field. Please use /v1/utilities/referenceData/{saluteBy} resource to get valid value of this field with description.
     *
     * @return $this
     */
