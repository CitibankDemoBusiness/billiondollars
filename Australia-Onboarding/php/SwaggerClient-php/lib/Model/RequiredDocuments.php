...
/**
 * RequiredDocuments Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class RequiredDocuments implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'RequiredDocuments';
...
'applicant_type' => 'getApplicantType'    ];
     ...
     *
     * @param string $document_status Status of document ID proof. This is a reference data data field. Please use /v1/apac/utilities/referenceData/{documentStatus} resource to get valid values of this field with descriptions
     *
     * @return $this
     */
     ...
     *
     * @param string $linked_document_id Linked document id is used to link different documents for the required documents/proof type.
     *
     * @return $this
     */
     ...
     * Sets applicant_type
     *
     * @param string $applicant_type Applicant relationship with the Bank. Currently supported value is primary.This is a reference data data field. Please use /v1/apac/utilities/referenceData/{applicantType} resource to get valid values of this field with descriptions
     *
     * @return $this
     */
