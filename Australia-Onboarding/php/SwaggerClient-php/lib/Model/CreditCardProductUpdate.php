...
/**
 * CreditCardProductUpdate Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CreditCardProductUpdate implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CreditCardProductUpdate';
...
'card_delivery_branch' => 'string',
'card_delivery_option' => 'string',
'gift_code' => 'string',
...
'card_delivery_branch' => null,
'card_delivery_option' => null,
'gift_code' => null,
...
'card_delivery_branch' => 'setCardDeliveryBranch',
'card_delivery_option' => 'setCardDeliveryOption',
...
'card_delivery_branch' => 'getCardDeliveryBranch',
'card_delivery_option' => 'getCardDeliveryOption',
...
'credit_limit_accepted_flag' => 'getCreditLimitAcceptedFlag'    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['card_delivery_branch'] = isset($data['card_delivery_branch']) ? $data['card_delivery_branch'] : null;
        $this->container['card_delivery_option'] = isset($data['card_delivery_option']) ? $data['card_delivery_option'] : null;
     ...
     *
     * @param string $billing_address Billing address of applicant. This is a reference data data field. Please use /v1/utilities/referenceData/{addressType} resource to get valid value of this field with description.
     *
     * @return $this
     */
     ...
     *
     * @param string $card_delivery_address Card delivery address of applicant. This is a reference data data field. Please use /v1/utilities/referenceData/{addressType} resource to get valid value of this field with description.
     *
     * @return $this
     */
     ...
     *
     * @param string $pin_delivery_address Delivery address  for card pin of applicant. This is a reference data data field. Please use /v1/utilities/referenceData/{addressType} resource to get valid value of this field with description.
     *
     * @return $this
     */
    ...
    /**
     * Gets card_delivery_branch
     *
     * @return string
     */
    public function getCardDeliveryBranch()
    {
        return $this->container['card_delivery_branch'];
    }

    /**
     * Sets card_delivery_branch
     *
     * @param string $card_delivery_branch Pick-up branch detail of the Citi bank for card collection. This is a reference data. Please use /v1/utilities/referenceData/{cardDeliveryBranch} resource to get valid value of this field.
     *
     * @return $this
     */
    public function setCardDeliveryBranch($card_delivery_branch)
    {
        $this->container['card_delivery_branch'] = $card_delivery_branch;

        return $this;
    }

    /**
     * Gets card_delivery_option
     *
     * @return string
     */
    public function getCardDeliveryOption()
    {
        return $this->container['card_delivery_option'];
    }

    /**
     * Sets card_delivery_option
     *
     * @param string $card_delivery_option Pick-up option for card collection. This is a reference data. Please use /v1/utilities/referenceData/{cardDeliveryOption} resource to get valid value of this field.
     *
     * @return $this
     */
    public function setCardDeliveryOption($card_delivery_option)
    {
        $this->container['card_delivery_option'] = $card_delivery_option;
     ...
     *
     * @param bool $credit_limit_accepted_flag Flag to indicate acceptance of customer for the credit card limit.
     *
     * @return $this
     */
