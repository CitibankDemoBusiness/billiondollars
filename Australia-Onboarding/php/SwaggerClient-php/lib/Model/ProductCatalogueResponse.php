...
/**
 * ProductCatalogueResponse Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ProductCatalogueResponse implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ProductCatalogueResponse';
...
'next_start_index' => 'getNextStartIndex'    ];
     ...
     *
     * @param string $next_start_index The next start index of the next subset of products.
     *
     * @return $this
     */
