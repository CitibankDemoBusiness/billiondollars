...
/**
 * ReadyCreditProduct Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ReadyCreditProduct implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ReadyCreditProduct';
...
'balance_transfer_details' => '\Swagger\Client\Model\BalanceTransferDetails[]',
'loan_purpose' => 'string',
'requested_credit_limit' => 'double',
'equal_payment_plan' => '\Swagger\Client\Model\EqualPaymentPlan[]',
...
'loan_purpose' => null,
'requested_credit_limit' => 'double',
'equal_payment_plan' => null,
'atm_pin_registration_flag' => null,
'credit_limit_accepted_flag' => null    ];
...
'equal_payment_plan' => 'setEqualPaymentPlan',
'atm_pin_registration_flag' => 'setAtmPinRegistrationFlag',
'credit_limit_accepted_flag' => 'setCreditLimitAcceptedFlag'    ];
...
'equal_payment_plan' => 'getEqualPaymentPlan',
'atm_pin_registration_flag' => 'getAtmPinRegistrationFlag',
'credit_limit_accepted_flag' => 'getCreditLimitAcceptedFlag'    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['equal_payment_plan'] = isset($data['equal_payment_plan']) ? $data['equal_payment_plan'] : null;
        $this->container['atm_pin_registration_flag'] = isset($data['atm_pin_registration_flag']) ? $data['atm_pin_registration_flag'] : null;
        $this->container['credit_limit_accepted_flag'] = isset($data['credit_limit_accepted_flag']) ? $data['credit_limit_accepted_flag'] : null;
    }
     ...
     *
     * @param string $card_delivery_address Card delivery address of applicant. This is a reference data field. Please use /v1/utilities/referenceData/{addressType} resource to get valid value of this field with description.
     *
     * @return $this
     */
     ...
     *
     * @param string $pin_delivery_address Delivery address  for card pin of applicant. This is a reference data field. Please use /v1/utilities/referenceData/{addressType} resource to get valid value of this field with description.
     *
     * @return $this
     */
     ...
     *
     * @param bool $credit_limit_increase_indicator Option for to review the credit limit in the future.Valid values: true and false
     *
     * @return $this
     */
     ...
     *
     * @return \Swagger\Client\Model\BalanceTransferDetails[]
     */
     ...
     *
     * @param \Swagger\Client\Model\BalanceTransferDetails[] $balance_transfer_details balance_transfer_details
     *
     * @return $this
     */
     ...
     * Sets loan_purpose
     *
     * @param string $loan_purpose Purpose of loan. This is a reference data field. Please use /v1/utilities/referenceData/{loanPurpose} resource to get valid value of this field with description.
     *
     * @return $this
     */
     ...
     *
     * @param double $requested_credit_limit Credit limit requested by applicant for the product.
     *
     * @return $this
     */
    ...
    /**
     * Gets equal_payment_plan
     *
     * @return \Swagger\Client\Model\EqualPaymentPlan[]
     */
    public function getEqualPaymentPlan()
    {
        return $this->container['equal_payment_plan'];
    }

    /**
     * Sets equal_payment_plan
     *
     * @param \Swagger\Client\Model\EqualPaymentPlan[] $equal_payment_plan equal_payment_plan
     *
     * @return $this
     */
    public function setEqualPaymentPlan($equal_payment_plan)
    {
        $this->container['equal_payment_plan'] = $equal_payment_plan;
    ...
    /**
     * Gets credit_limit_accepted_flag
     *
     * @return bool
     */
    public function getCreditLimitAcceptedFlag()
    {
        return $this->container['credit_limit_accepted_flag'];
    }

    /**
     * Sets credit_limit_accepted_flag
     *
     * @param bool $credit_limit_accepted_flag Flag to indicate acceptance of customer for the ready credit limit.
     *
     * @return $this
     */
    public function setCreditLimitAcceptedFlag($credit_limit_accepted_flag)
    {
        $this->container['credit_limit_accepted_flag'] = $credit_limit_accepted_flag;
