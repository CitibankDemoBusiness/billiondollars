...
/**
 * ExternalCreditCardDetailsAdd Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ExternalCreditCardDetailsAdd implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ExternalCreditCardDetailsAdd';
...
'credit_card_number' => 'getCreditCardNumber'    ];
     ...
     *
     * @param string $credit_card_number Other Credit Card Number of the applicant, to be used for bill payments
     *
     * @return $this
     */
