...
/**
 * PartnerCustomerDetails Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class PartnerCustomerDetails implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'PartnerCustomerDetails';
...
'verified_by_partner_flag' => 'setVerifiedByPartnerFlag'    ];
...
'verified_by_partner_flag' => 'getVerifiedByPartnerFlag'    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['verified_by_partner_flag'] = isset($data['verified_by_partner_flag']) ? $data['verified_by_partner_flag'] : null;
    }
     ...
     *
     * @param string $partner_customer_segment Partner customer segment.Partner customer segment.This is a reference data field. Please use /v1/utilities/referenceData/{partnerCustomerSegment} resource to get possible value of this field with description.
     *
     * @return $this
     */
    ...
    /**
     * Gets verified_by_partner_flag
     *
     * @return bool
     */
    public function getVerifiedByPartnerFlag()
    {
        return $this->container['verified_by_partner_flag'];
    }

    /**
     * Sets verified_by_partner_flag
     *
     * @param bool $verified_by_partner_flag Flag to indicate whether phone and address are verified by partner.
     *
     * @return $this
     */
    public function setVerifiedByPartnerFlag($verified_by_partner_flag)
    {
        $this->container['verified_by_partner_flag'] = $verified_by_partner_flag;
