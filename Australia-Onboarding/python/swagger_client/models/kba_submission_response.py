...
class KbaSubmissionResponse(object):
    ...
    def __init__(self, application_stage=None):  # noqa: E501
        """KbaSubmissionResponse - a model defined in Swagger"""  # noqa: E501
    ...
    def application_stage(self):
        """Gets the application_stage of this KbaSubmissionResponse.  # noqa: E501
        ...
        :return: The application_stage of this KbaSubmissionResponse.  # noqa: E501
        :rtype: str
        """
    ...
    def application_stage(self, application_stage):
        """Sets the application_stage of this KbaSubmissionResponse.

        Current stage of an application.This is a reference data field. Please use /v1/apac/utilities/referenceData/{applicationStage} resource to get possible value of this field with description. You can use applicationStage field name as the referenceCode parameter to retrieve the values.  # noqa: E501

        :param application_stage: The application_stage of this KbaSubmissionResponse.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(KbaSubmissionResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, KbaSubmissionResponse):
            return False
