...
module SwaggerClient
  class ECMEmploymentDetailsUpdate
    # Name of the employer.
    attr_accessor :employer_name

    # Employer registration number
    attr_accessor :employer_registration_number
    ...
    attr_accessor :other_occupation_description
    ...
    attr_accessor :previous_employer_name
    ...
    def self.openapi_types
      {
        ...
        :'employer_registration_number' => :'Object',
        :'occupation_code' => :'Object',
        :'other_occupation_description' => :'Object',
        :'industry_code' => :'Object',
        :'other_industry_description' => :'Object',
        :'employment_duration_in_years' => :'Object',
        :'employment_duration_in_months' => :'Object',
        :'previous_employer_name' => :'Object',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `SwaggerClient::ECMEmploymentDetailsUpdate` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SwaggerClient::ECMEmploymentDetailsUpdate`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'employer_registration_number')
        self.employer_registration_number = attributes[:'employer_registration_number']
      end
      ...
      if attributes.key?(:'other_occupation_description')
        self.other_occupation_description = attributes[:'other_occupation_description']
      end
      ...
      if attributes.key?(:'other_industry_description')
        self.other_industry_description = attributes[:'other_industry_description']
      end
      ...
      if attributes.key?(:'previous_employer_name')
        self.previous_employer_name = attributes[:'previous_employer_name']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          employer_registration_number == o.employer_registration_number &&
          occupation_code == o.occupation_code &&
          other_occupation_description == o.other_occupation_description &&
          industry_code == o.industry_code &&
          other_industry_description == o.other_industry_description &&
          employment_duration_in_years == o.employment_duration_in_years &&
          employment_duration_in_months == o.employment_duration_in_months &&
          previous_employer_name == o.previous_employer_name &&
    ...
    def hash
      [employer_name, employer_registration_number, occupation_code, other_occupation_description, industry_code, other_industry_description, employment_duration_in_years, employment_duration_in_months, previous_employer_name, months_in_previous_employment, years_in_previous_employment, email_address, employment_status].hash
    end
