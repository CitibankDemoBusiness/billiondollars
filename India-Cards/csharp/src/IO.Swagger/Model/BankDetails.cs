...
namespace IO.Swagger.Model
{
        ...
        public partial class BankDetails :  IEquatable<BankDetails>, IValidatableObject
    {
        ...
        /// <param name="branchCode">Branch Code to which the loan will be credited.</param>
        ...
        public BankDetails(string bankCode = default(string), string accountNumber = default(string), string branchCode = default(string), string bankName = default(string), string payeeName = default(string))
        {
        ...
        /// </summary>
        /// <value>Branch Code to which the loan will be credited</value>
