...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class OverseasTravelPlanUpdateRequest :  IEquatable<OverseasTravelPlanUpdateRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OverseasTravelPlanUpdateRequest" /> class.
        /// </summary>
        ...
        public OverseasTravelPlanUpdateRequest(DateTime? travelPlanStartDate = default(DateTime?), DateTime? travelPlanEndDate = default(DateTime?), List<CountryCodes> countryCodes = default(List<CountryCodes>))
        {
            // to ensure "travelPlanStartDate" is required (not null)
            if (travelPlanStartDate == null)
            {
                throw new InvalidDataException("travelPlanStartDate is a required property for OverseasTravelPlanUpdateRequest and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("travelPlanEndDate is a required property for OverseasTravelPlanUpdateRequest and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class OverseasTravelPlanUpdateRequest {\n");
        ...
        {
            return this.Equals(input as OverseasTravelPlanUpdateRequest);
        }

        /// <summary>
        /// Returns true if OverseasTravelPlanUpdateRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of OverseasTravelPlanUpdateRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OverseasTravelPlanUpdateRequest input)
        {
            if (input == null)
                return false;
