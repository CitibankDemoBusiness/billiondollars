...
namespace IO.Swagger.Model
{
        ...
        public partial class IdentificationDocumentDetails :  IEquatable<IdentificationDocumentDetails>, IValidatableObject
    {
        ...
        public IdentificationDocumentDetails(string idIssueState = default(string), string idType = default(string), DateTime? idIssueDate = default(DateTime?), DateTime? idExpiryDate = default(DateTime?), string idNumber = default(string), string idIssuePlace = default(string), string idIssueCountry = default(string))
        {
