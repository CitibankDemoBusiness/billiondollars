...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class RetrieveCreditChargeCardCorporateCardsCashLimitRequest :  IEquatable<RetrieveCreditChargeCardCorporateCardsCashLimitRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RetrieveCreditChargeCardCorporateCardsCashLimitRequest" /> class.
        /// </summary>
        ...
        public RetrieveCreditChargeCardCorporateCardsCashLimitRequest(string tokenizedCardNumber = default(string), CorporateOfficerDetails corporateOfficerDetails = default(CorporateOfficerDetails))
        {
            // to ensure "tokenizedCardNumber" is required (not null)
            if (tokenizedCardNumber == null)
            {
                throw new InvalidDataException("tokenizedCardNumber is a required property for RetrieveCreditChargeCardCorporateCardsCashLimitRequest and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class RetrieveCreditChargeCardCorporateCardsCashLimitRequest {\n");
        ...
        {
            return this.Equals(input as RetrieveCreditChargeCardCorporateCardsCashLimitRequest);
        }

        /// <summary>
        /// Returns true if RetrieveCreditChargeCardCorporateCardsCashLimitRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of RetrieveCreditChargeCardCorporateCardsCashLimitRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RetrieveCreditChargeCardCorporateCardsCashLimitRequest input)
        {
            if (input == null)
                return false;
