...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class TravelPlan :  IEquatable<TravelPlan>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TravelPlan" /> class.
        /// </summary>
        ...
        public TravelPlan(List<CountryCodes> countryCodes = default(List<CountryCodes>), DateTime? travelPlanStartDate = default(DateTime?), DateTime? travelPlanEndDate = default(DateTime?), string cardId = default(string))
        {
            // to ensure "travelPlanStartDate" is required (not null)
            if (travelPlanStartDate == null)
            {
                throw new InvalidDataException("travelPlanStartDate is a required property for TravelPlan and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("travelPlanEndDate is a required property for TravelPlan and cannot be null");
            }
            else
            {
            ...
            if (cardId == null)
            {
                throw new InvalidDataException("cardId is a required property for TravelPlan and cannot be null");
            }
            else
            {
                this.CardId = cardId;
        ...
        {
            return this.Equals(input as TravelPlan);
        }

        /// <summary>
        /// Returns true if TravelPlan instances are equal
        /// </summary>
        /// <param name="input">Instance of TravelPlan to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TravelPlan input)
        {
            if (input == null)
                return false;
