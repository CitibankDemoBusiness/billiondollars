...
module SwaggerClient
  class RequestCreditChargeCardFulfillmentArrangementCorporateCardsDamageReplacementRequest
    ...
    attr_accessor :replacement_reason_code
    ...
    def self.openapi_types
      {
        ...
        :'replacement_reason_code' => :'Object'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `SwaggerClient::RequestCreditChargeCardFulfillmentArrangementCorporateCardsDamageReplacementRequest` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SwaggerClient::RequestCreditChargeCardFulfillmentArrangementCorporateCardsDamageReplacementRequest`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'replacement_reason_code')
        self.replacement_reason_code = attributes[:'replacement_reason_code']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          replacement_reason_code == o.replacement_reason_code
    end
    ...
    def hash
      [tokenized_card_number, corporate_officer_details, embossed_name, replacement_reason_code].hash
    end
