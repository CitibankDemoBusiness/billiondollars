...
module SwaggerClient
  class EppOffers
    ...
    attr_accessor :total_repayment_amount
    ...
    attr_accessor :monthly_servicing_fee_amount
    ...
    def self.openapi_types
      {
        ...
        :'offer_indicator' => :'Object',
        :'total_interest_amount' => :'Object',
        :'total_repayment_amount' => :'Object',
        :'monthly_servicing_fee_amount' => :'Object',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `SwaggerClient::EppOffers` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SwaggerClient::EppOffers`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'offer_indicator')
        self.offer_indicator = attributes[:'offer_indicator']
      end
      ...
      if attributes.key?(:'total_repayment_amount')
        self.total_repayment_amount = attributes[:'total_repayment_amount']
      end

      if attributes.key?(:'monthly_servicing_fee_amount')
        self.monthly_servicing_fee_amount = attributes[:'monthly_servicing_fee_amount']
      end

      if attributes.key?(:'interest_calculation_method')
        self.interest_calculation_method = attributes[:'interest_calculation_method']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @effective_interest_rate.nil?
        invalid_properties.push('invalid value for "effective_interest_rate", effective_interest_rate cannot be nil.')
      end
      ...
      if @offer_indicator.nil?
        invalid_properties.push('invalid value for "offer_indicator", offer_indicator cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @effective_interest_rate.nil?
      return false if @installment_amount.nil?
      return false if @offer_indicator.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          offer_indicator == o.offer_indicator &&
          total_interest_amount == o.total_interest_amount &&
          total_repayment_amount == o.total_repayment_amount &&
          monthly_servicing_fee_amount == o.monthly_servicing_fee_amount &&
          interest_calculation_method == o.interest_calculation_method
    end
    ...
    def hash
      [tenor, effective_interest_rate, annual_percentage_rate, installment_amount, one_time_processing_fee_indicator, one_time_processing_fee_amount, one_time_processing_fee_percentage, offer_indicator, total_interest_amount, total_repayment_amount, monthly_servicing_fee_amount, interest_calculation_method].hash
    end
