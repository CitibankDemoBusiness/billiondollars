...
module SwaggerClient
  class EmploymentDetails
    ...
    def list_invalid_properties
      ...
      if @occupation_code.nil?
        invalid_properties.push('invalid value for "occupation_code", occupation_code cannot be nil.')
      end
    ...
    def valid?
      return false if @occupation_code.nil?
      true
    end
