...
module SwaggerClient
  class Name
    ...
    def list_invalid_properties
      ...
      if @salutation.nil?
        invalid_properties.push('invalid value for "salutation", salutation cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @salutation.nil?
      true
    end
    ...
    def hash
      [surname, given_name, middle_name, salutation].hash
    end
