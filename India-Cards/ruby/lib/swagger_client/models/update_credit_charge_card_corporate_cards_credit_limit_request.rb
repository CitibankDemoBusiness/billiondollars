...
module SwaggerClient
  class UpdateCreditChargeCardCorporateCardsCreditLimitRequest
    ...
    attr_accessor :credit_limit_indicator
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `SwaggerClient::UpdateCreditChargeCardCorporateCardsCreditLimitRequest` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SwaggerClient::UpdateCreditChargeCardCorporateCardsCreditLimitRequest`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'credit_limit_indicator')
        self.credit_limit_indicator = attributes[:'credit_limit_indicator']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @credit_limit_amount.nil?
        invalid_properties.push('invalid value for "credit_limit_amount", credit_limit_amount cannot be nil.')
      end

      if @credit_limit_indicator.nil?
        invalid_properties.push('invalid value for "credit_limit_indicator", credit_limit_indicator cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @credit_limit_amount.nil?
      return false if @credit_limit_indicator.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          credit_limit_indicator == o.credit_limit_indicator
    end
    ...
    def hash
      [tokenized_card_number, corporate_officer_details, credit_limit_amount, credit_limit_indicator].hash
    end
