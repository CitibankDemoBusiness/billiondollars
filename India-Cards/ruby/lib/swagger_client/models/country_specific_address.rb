...
module SwaggerClient
  class CountrySpecificAddress
    ...
    def list_invalid_properties
      ...
      if @street_type.nil?
        invalid_properties.push('invalid value for "street_type", street_type cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @street_type.nil?
    ...
    def hash
      [street_name, street_type, street_number, unit_number].hash
    end
