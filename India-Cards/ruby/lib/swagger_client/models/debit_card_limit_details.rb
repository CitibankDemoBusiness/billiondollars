...
module SwaggerClient
  class DebitCardLimitDetails
    ...
    attr_accessor :daily_internet_purchase_limit_amount
    ...
    def self.openapi_types
      {
        ...
        :'daily_internet_purchase_limit_amount' => :'Object'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `SwaggerClient::DebitCardLimitDetails` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SwaggerClient::DebitCardLimitDetails`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'daily_internet_purchase_limit_amount')
        self.daily_internet_purchase_limit_amount = attributes[:'daily_internet_purchase_limit_amount']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          daily_internet_purchase_limit_amount == o.daily_internet_purchase_limit_amount
    end
    ...
    def hash
      [pos_spending_limit_amount, daily_atm_withdrawal_limit_amount, daily_internet_purchase_limit_amount].hash
    end
