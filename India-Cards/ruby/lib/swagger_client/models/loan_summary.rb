...
module SwaggerClient
  class LoanSummary
    ...
    attr_accessor :interest_rate_effectivity_date
    ...
    def self.openapi_types
      {
        ...
        :'interest_rate_effectivity_date' => :'Object',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `SwaggerClient::LoanSummary` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SwaggerClient::LoanSummary`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'interest_rate_effectivity_date')
        self.interest_rate_effectivity_date = attributes[:'interest_rate_effectivity_date']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          interest_rate_effectivity_date == o.interest_rate_effectivity_date &&
    ...
    def hash
      [loan_amount, loan_tenure, promotion_id, interest_rate, interest_rate_effectivity_date, total_interest_amount, total_loan_amount, loan_remaining_term_number].hash
    end
