...
module SwaggerClient
  class RequestCreditChargeCardCorporateCardsSuspensionAndCashLimitAllowedRequest
    ...
    attr_accessor :cash_limit_update_allowed_flag
    ...
    def self.openapi_types
      {
        ...
        :'cash_limit_update_allowed_flag' => :'Object',
        :'card_status' => :'Object'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `SwaggerClient::RequestCreditChargeCardCorporateCardsSuspensionAndCashLimitAllowedRequest` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SwaggerClient::RequestCreditChargeCardCorporateCardsSuspensionAndCashLimitAllowedRequest`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'cash_limit_update_allowed_flag')
        self.cash_limit_update_allowed_flag = attributes[:'cash_limit_update_allowed_flag']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          cash_limit_update_allowed_flag == o.cash_limit_update_allowed_flag &&
    ...
    def hash
      [tokenized_card_number, corporate_officer_details, cash_limit_update_allowed_flag, card_status].hash
    end
