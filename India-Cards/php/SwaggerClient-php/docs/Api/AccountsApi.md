...
# **creditLimitDecrease**
> \Swagger\Client\Model\CreditLimitDecreaseResponse creditLimitDecrease($body, $authorization, $uuid, $accept, $client_id, $content_type, $client_details)
...
------------- | ------------- | ------------- | -------------
 **body** | [**\Swagger\Client\Model\CreditLimitDecreaseRequest**](../Model/CreditLimitDecreaseRequest.md)| CreditLimitDecreaseRequest |
...
[**\Swagger\Client\Model\CreditLimitDecreaseResponse**](../Model/CreditLimitDecreaseResponse.md)
...
> \Swagger\Client\Model\CreditLimitDecreaseConsentResponse creditLimitDecreaseConsent($body, $authorization, $uuid, $accept, $client_id, $content_type, $client_details)
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**\Swagger\Client\Model\CreditLimitDecreaseConsentRequest**](../Model/CreditLimitDecreaseConsentRequest.md)| CreditLimitDecreaseConsentRequest |
 **authorization** | **string**| The most recent Authorization token. This will have the format Bearer + {space} + {accessToken}. Example: Bearer KGNsaWVudF9pZDpjbGllbnRfc2VjcmV0KQ&#x3D;&#x3D; |
 **uuid** | **string**| 128 bit random UUID generated uniquely for every request. |
 **accept** | **string**| Content-Type that are acceptable for the response. |
 **client_id** | **string**| client id generated during consumer on-boarding |
...
[**\Swagger\Client\Model\CreditLimitDecreaseConsentResponse**](../Model/CreditLimitDecreaseConsentResponse.md)
