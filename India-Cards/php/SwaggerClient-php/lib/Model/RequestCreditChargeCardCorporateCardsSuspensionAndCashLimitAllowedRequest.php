...
/**
 * RequestCreditChargeCardCorporateCardsSuspensionAndCashLimitAllowedRequest Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class RequestCreditChargeCardCorporateCardsSuspensionAndCashLimitAllowedRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'RequestCreditChargeCardCorporateCardsSuspensionAndCashLimitAllowedRequest';
...
'cash_limit_update_allowed_flag' => null,
'card_status' => null    ];
...
'cash_limit_update_allowed_flag' => 'setCashLimitUpdateAllowedFlag',
...
'cash_limit_update_allowed_flag' => 'getCashLimitUpdateAllowedFlag',
'card_status' => 'getCardStatus'    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['cash_limit_update_allowed_flag'] = isset($data['cash_limit_update_allowed_flag']) ? $data['cash_limit_update_allowed_flag'] : null;
    ...
    /**
     * Gets cash_limit_update_allowed_flag
     *
     * @return bool
     */
    public function getCashLimitUpdateAllowedFlag()
    {
        return $this->container['cash_limit_update_allowed_flag'];
    }

    /**
     * Sets cash_limit_update_allowed_flag
     *
     * @param bool $cash_limit_update_allowed_flag This field is used to indicate whether cash withdrawal is allowed for the corporate card
     *
     * @return $this
     */
    public function setCashLimitUpdateAllowedFlag($cash_limit_update_allowed_flag)
    {
        $this->container['cash_limit_update_allowed_flag'] = $cash_limit_update_allowed_flag;
     ...
     * Sets card_status
     *
     * @param string $card_status This field is used to indicate whether to  suspend or unsuspend the corporate card.This is a reference data field. Please use /v1/utilities/referenceData/{cardStatus} resource to get possible values of this field with descriptions
     *
     * @return $this
     */
