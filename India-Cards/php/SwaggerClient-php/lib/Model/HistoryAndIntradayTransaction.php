...
/**
 * HistoryAndIntradayTransaction Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class HistoryAndIntradayTransaction implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'HistoryAndIntradayTransaction';
...
'next_start_index' => 'getNextStartIndex'    ];
     ...
     *
     * @param string $activity_indicator This field is used to indicate whether History or Current or All transactions records to be fetched. This is a reference data field. Please use /v1/utilities/referenceData/{activityIndicator} resource to get possible values of this field with descriptions.
     *
     * @return $this
     */
     ...
     * Sets more_indicator
     *
     * @param string $more_indicator This field is used for  pagination, it indicates that more records are available for retrieval.
     *
     * @return $this
     */
