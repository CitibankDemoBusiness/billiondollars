...
class EmploymentDetails implements ModelInterface, ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['occupation_code'] === null) {
            $invalidProperties[] = "'occupation_code' can't be null";
        }
     ...
     *
     * @param string $occupation_code Occupation code. This is a reference data field. Please use /utilities/referenceData/{occupationCode} resource to get valid values of this field with descriptions.
     *
     * @return $this
     */
