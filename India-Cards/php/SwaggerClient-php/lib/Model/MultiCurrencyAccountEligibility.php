...
/**
 * MultiCurrencyAccountEligibility Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class MultiCurrencyAccountEligibility implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'MultiCurrencyAccountEligibility';
...
'relationship_id_type' => 'string',
'account_details' => '\Swagger\Client\Model\AccountDtls[]',
...
'relationship_id_type' => 'setRelationshipIdType',
...
'relationship_id_type' => 'getRelationshipIdType',
...
'currency_details' => 'getCurrencyDetails'    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['relationship_id_type'] = isset($data['relationship_id_type']) ? $data['relationship_id_type'] : null;
     ...
     *
     * @param string $relationship_id The customer relationship identifier in encrypted format
     *
     * @return $this
     */
    ...
    /**
     * Gets relationship_id_type
     *
     * @return string
     */
    public function getRelationshipIdType()
    {
        return $this->container['relationship_id_type'];
    }

    /**
     * Sets relationship_id_type
     *
     * @param string $relationship_id_type The type of customer relationship
     *
     * @return $this
     */
    public function setRelationshipIdType($relationship_id_type)
    {
        $this->container['relationship_id_type'] = $relationship_id_type;
     ...
     *
     * @return \Swagger\Client\Model\AccountDtls[]
     */
     ...
     *
     * @param \Swagger\Client\Model\AccountDtls[] $account_details account_details
     *
     * @return $this
     */
