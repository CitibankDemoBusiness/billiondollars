...
/**
 * EasyPaymentPlansEligibilityInquiryResponse Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class EasyPaymentPlansEligibilityInquiryResponse implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'EasyPaymentPlansEligibilityInquiryResponse';
    ...
    protected static $swaggerTypes = [
        'unbilled_transaction' => '\Swagger\Client\Model\UnbilledTransaction[]',
...
'next_start_index' => 'nextStartIndex'    ];
    ...
    protected static $setters = [
        'unbilled_transaction' => 'setUnbilledTransaction',
...
'next_start_index' => 'setNextStartIndex'    ];
    ...
    protected static $getters = [
        'unbilled_transaction' => 'getUnbilledTransaction',
...
'next_start_index' => 'getNextStartIndex'    ];
    ...
    {
        $this->container['unbilled_transaction'] = isset($data['unbilled_transaction']) ? $data['unbilled_transaction'] : null;
    ...
    /**
     * Gets unbilled_transaction
     *
     * @return \Swagger\Client\Model\UnbilledTransaction[]
     */
    public function getUnbilledTransaction()
    {
        return $this->container['unbilled_transaction'];
    }

    /**
     * Sets unbilled_transaction
     *
     * @param \Swagger\Client\Model\UnbilledTransaction[] $unbilled_transaction unbilled_transaction
     *
     * @return $this
     */
    public function setUnbilledTransaction($unbilled_transaction)
    {
        $this->container['unbilled_transaction'] = $unbilled_transaction;
