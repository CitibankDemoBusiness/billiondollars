 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class StatementList implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'StatementList';
...
'statement_date' => 'getStatementDate'    ];
     ...
     * Sets statement_date
     *
     * @param \DateTime $statement_date Date on which the account statement has been generated in ISO 8601 date format YYYY-MM-DD. Applicable only for credit cards.
     *
     * @return $this
     */
