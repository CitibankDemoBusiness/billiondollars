...
/**
 * EligibleForEqualPaymentPlan Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class EligibleForEqualPaymentPlan implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'EligibleForEqualPaymentPlan';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['eligible_for_equal_payment_plan'] === null) {
            $invalidProperties[] = "'eligible_for_equal_payment_plan' can't be null";
        }
     ...
     *
     * @param string $eligible_for_equal_payment_plan The EPP allowed indicator. This is applicable for credit cards transactions only. This is a reference data field. Please use /v1/apac/utilities/referenceData/{eligibleForEqualPaymentPlan} resource to get possible value of This field with description.
     *
     * @return $this
     */
