...
/**
 * LoanAmortizationSchedule Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class LoanAmortizationSchedule implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'LoanAmortizationSchedule';
...
'installment_date' => 'getInstallmentDate'    ];
     ...
     *
     * @param double $outstanding_principal_amount The portion of the Principal Amount not Paid for the loan.
     *
     * @return $this
     */
