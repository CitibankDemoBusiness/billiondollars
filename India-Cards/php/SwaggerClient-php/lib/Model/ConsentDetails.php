...
'consent_given_flag' => 'getConsentGivenFlag'    ];
     ...
     * Sets consent_type
     *
     * @param string $consent_type Applicant's consent types. This is a reference data field. Please use /v1/apac/utilities/referenceData/{consentType} resource to get valid value of this field with description.
     *
     * @return $this
     */
