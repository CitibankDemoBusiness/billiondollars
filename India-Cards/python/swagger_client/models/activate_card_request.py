...
class ActivateCardRequest(object):
    ...
    def __init__(self, control_flow_id=None):  # noqa: E501
        """ActivateCardRequest - a model defined in Swagger"""  # noqa: E501
    ...
    def control_flow_id(self):
        """Gets the control_flow_id of this ActivateCardRequest.  # noqa: E501

        Control flow id is used to control the flow for subsequent requests in the session.  # noqa: E501

        :return: The control_flow_id of this ActivateCardRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def control_flow_id(self, control_flow_id):
        """Sets the control_flow_id of this ActivateCardRequest.

        Control flow id is used to control the flow for subsequent requests in the session.  # noqa: E501

        :param control_flow_id: The control_flow_id of this ActivateCardRequest.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ActivateCardRequest, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ActivateCardRequest):
            return False
