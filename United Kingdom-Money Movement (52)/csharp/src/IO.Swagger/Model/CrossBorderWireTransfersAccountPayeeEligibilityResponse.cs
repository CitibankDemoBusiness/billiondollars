...
{
    /// <summary>
    /// CrossBorderWireTransfersAccountPayeeEligibilityResponse
    /// </summary>
    [DataContract]
        public partial class CrossBorderWireTransfersAccountPayeeEligibilityResponse :  IEquatable<CrossBorderWireTransfersAccountPayeeEligibilityResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CrossBorderWireTransfersAccountPayeeEligibilityResponse" /> class.
        /// </summary>
        ...
        public CrossBorderWireTransfersAccountPayeeEligibilityResponse(List<SourceAccountsCrossBorderWireTransfer> sourceAccounts = default(List<SourceAccountsCrossBorderWireTransfer>), List<PayeeSourceAccountCombinationsCrossBorderWireTransfer> payeeSourceAccountCombinations = default(List<PayeeSourceAccountCombinationsCrossBorderWireTransfer>), string nextStartIndex = default(string))
        {
            // to ensure "sourceAccounts" is required (not null)
            if (sourceAccounts == null)
            {
                throw new InvalidDataException("sourceAccounts is a required property for CrossBorderWireTransfersAccountPayeeEligibilityResponse and cannot be null");
            }
            else
            {
        ...
        public List<SourceAccountsCrossBorderWireTransfer> SourceAccounts { get; set; }

        /// <summary>
        /// Gets or Sets PayeeSourceAccountCombinations
        /// </summary>
        [DataMember(Name="payeeSourceAccountCombinations", EmitDefaultValue=false)]
        public List<PayeeSourceAccountCombinationsCrossBorderWireTransfer> PayeeSourceAccountCombinations { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CrossBorderWireTransfersAccountPayeeEligibilityResponse {\n");
        ...
        {
            return this.Equals(input as CrossBorderWireTransfersAccountPayeeEligibilityResponse);
        }

        /// <summary>
        /// Returns true if CrossBorderWireTransfersAccountPayeeEligibilityResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of CrossBorderWireTransfersAccountPayeeEligibilityResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CrossBorderWireTransfersAccountPayeeEligibilityResponse input)
        {
            if (input == null)
                return false;
