...
{
    /// <summary>
    /// SourceAccountsCitiGlobalTransfer
    /// </summary>
    [DataContract]
        public partial class SourceAccountsCitiGlobalTransfer :  IEquatable<SourceAccountsCitiGlobalTransfer>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SourceAccountsCitiGlobalTransfer" /> class.
        /// </summary>
        ...
        public SourceAccountsCitiGlobalTransfer(string sourceAccountId = default(string), string displaySourceAccountNumber = default(string), string productName = default(string), string sourceAccountCurrencyCode = default(string), string accountNickname = default(string), string accountGroup = default(string), double? availableBalance = default(double?))
        {
            // to ensure "sourceAccountId" is required (not null)
            if (sourceAccountId == null)
            {
                throw new InvalidDataException("sourceAccountId is a required property for SourceAccountsCitiGlobalTransfer and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("displaySourceAccountNumber is a required property for SourceAccountsCitiGlobalTransfer and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("sourceAccountCurrencyCode is a required property for SourceAccountsCitiGlobalTransfer and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SourceAccountsCitiGlobalTransfer {\n");
        ...
        {
            return this.Equals(input as SourceAccountsCitiGlobalTransfer);
        }

        /// <summary>
        /// Returns true if SourceAccountsCitiGlobalTransfer instances are equal
        /// </summary>
        /// <param name="input">Instance of SourceAccountsCitiGlobalTransfer to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SourceAccountsCitiGlobalTransfer input)
        {
            if (input == null)
                return false;
