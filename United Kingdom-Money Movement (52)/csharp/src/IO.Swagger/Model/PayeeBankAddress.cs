...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class PayeeBankAddress :  IEquatable<PayeeBankAddress>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PayeeBankAddress" /> class.
        /// </summary>
        ...
        public PayeeBankAddress(string addressLine1 = default(string), string addressLine2 = default(string), string addressLine3 = default(string), string countryName = default(string))
        {
            // to ensure "addressLine1" is required (not null)
            if (addressLine1 == null)
            {
                throw new InvalidDataException("addressLine1 is a required property for PayeeBankAddress and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PayeeBankAddress {\n");
        ...
        {
            return this.Equals(input as PayeeBankAddress);
        }

        /// <summary>
        /// Returns true if PayeeBankAddress instances are equal
        /// </summary>
        /// <param name="input">Instance of PayeeBankAddress to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PayeeBankAddress input)
        {
            if (input == null)
                return false;
