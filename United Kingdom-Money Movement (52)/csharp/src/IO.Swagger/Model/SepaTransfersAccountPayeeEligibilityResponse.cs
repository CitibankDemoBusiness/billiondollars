...
{
    /// <summary>
    /// SepaTransfersAccountPayeeEligibilityResponse
    /// </summary>
    [DataContract]
        public partial class SepaTransfersAccountPayeeEligibilityResponse :  IEquatable<SepaTransfersAccountPayeeEligibilityResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SepaTransfersAccountPayeeEligibilityResponse" /> class.
        /// </summary>
        ...
        public SepaTransfersAccountPayeeEligibilityResponse(List<SourceAccounts> sourceAccounts = default(List<SourceAccounts>), List<PayeeSourceAccountCombinationsSEPATransfer> payeeSourceAccountCombinations = default(List<PayeeSourceAccountCombinationsSEPATransfer>), string nextStartIndex = default(string))
        {
            // to ensure "sourceAccounts" is required (not null)
            if (sourceAccounts == null)
            {
                throw new InvalidDataException("sourceAccounts is a required property for SepaTransfersAccountPayeeEligibilityResponse and cannot be null");
            }
            else
            {
        ...
        public List<PayeeSourceAccountCombinationsSEPATransfer> PayeeSourceAccountCombinations { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SepaTransfersAccountPayeeEligibilityResponse {\n");
        ...
        {
            return this.Equals(input as SepaTransfersAccountPayeeEligibilityResponse);
        }

        /// <summary>
        /// Returns true if SepaTransfersAccountPayeeEligibilityResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of SepaTransfersAccountPayeeEligibilityResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SepaTransfersAccountPayeeEligibilityResponse input)
        {
            if (input == null)
                return false;
