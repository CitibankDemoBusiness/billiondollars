...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class CrossBorderWireTransfersPreprocessResponse :  IEquatable<CrossBorderWireTransfersPreprocessResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CrossBorderWireTransfersPreprocessResponse" /> class.
        /// </summary>
        ...
        public CrossBorderWireTransfersPreprocessResponse(string controlFlowId = default(string), DebitDetails debitDetails = default(DebitDetails), CreditDetails creditDetails = default(CreditDetails), double? foreignExchangeRate = default(double?), double? transactionFee = default(double?), string feeCurrencyCode = default(string))
        {
            // to ensure "controlFlowId" is required (not null)
            if (controlFlowId == null)
            {
                throw new InvalidDataException("controlFlowId is a required property for CrossBorderWireTransfersPreprocessResponse and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CrossBorderWireTransfersPreprocessResponse {\n");
        ...
        {
            return this.Equals(input as CrossBorderWireTransfersPreprocessResponse);
        }

        /// <summary>
        /// Returns true if CrossBorderWireTransfersPreprocessResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of CrossBorderWireTransfersPreprocessResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CrossBorderWireTransfersPreprocessResponse input)
        {
            if (input == null)
                return false;
