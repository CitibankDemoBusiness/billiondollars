...
{
    /// <summary>
    /// InternalDomesticSourceAccounts
    /// </summary>
    [DataContract]
        public partial class InternalDomesticSourceAccounts :  IEquatable<InternalDomesticSourceAccounts>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InternalDomesticSourceAccounts" /> class.
        /// </summary>
        ...
        /// <param name="accountNickName">Nick name of the source account..</param>
        /// <param name="productName">The name of the product.</param>
        public InternalDomesticSourceAccounts(string sourceAccountId = default(string), string displaySourceAccountNumber = default(string), string sourceAccountCurrencyCode = default(string), string accountGroup = default(string), double? availableBalance = default(double?), double? nextPaymentAmount = default(double?), string accountNickName = default(string), string productName = default(string))
        {
            // to ensure "sourceAccountId" is required (not null)
            if (sourceAccountId == null)
            {
                throw new InvalidDataException("sourceAccountId is a required property for InternalDomesticSourceAccounts and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("displaySourceAccountNumber is a required property for InternalDomesticSourceAccounts and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("sourceAccountCurrencyCode is a required property for InternalDomesticSourceAccounts and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("accountGroup is a required property for InternalDomesticSourceAccounts and cannot be null");
            }
            else
            {
        ...
        /// </summary>
        /// <value>Nick name of the source account.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InternalDomesticSourceAccounts {\n");
        ...
        {
            return this.Equals(input as InternalDomesticSourceAccounts);
        }

        /// <summary>
        /// Returns true if InternalDomesticSourceAccounts instances are equal
        /// </summary>
        /// <param name="input">Instance of InternalDomesticSourceAccounts to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InternalDomesticSourceAccounts input)
        {
            if (input == null)
                return false;
