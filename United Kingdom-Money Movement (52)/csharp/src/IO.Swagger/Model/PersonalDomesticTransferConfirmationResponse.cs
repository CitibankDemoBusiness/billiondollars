...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class PersonalDomesticTransferConfirmationResponse :  IEquatable<PersonalDomesticTransferConfirmationResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PersonalDomesticTransferConfirmationResponse" /> class.
        /// </summary>
        /// <param name="sourceAccount">sourceAccount.</param>
        /// <param name="destinationAccount">destinationAccount (required).</param>
        ...
        public PersonalDomesticTransferConfirmationResponse(SourceAccount sourceAccount = default(SourceAccount), DestinationAccount destinationAccount = default(DestinationAccount), string transactionReferenceId = default(string))
        {
            // to ensure "destinationAccount" is required (not null)
            if (destinationAccount == null)
            {
                throw new InvalidDataException("destinationAccount is a required property for PersonalDomesticTransferConfirmationResponse and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("transactionReferenceId is a required property for PersonalDomesticTransferConfirmationResponse and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PersonalDomesticTransferConfirmationResponse {\n");
        ...
        {
            return this.Equals(input as PersonalDomesticTransferConfirmationResponse);
        }

        /// <summary>
        /// Returns true if PersonalDomesticTransferConfirmationResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of PersonalDomesticTransferConfirmationResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PersonalDomesticTransferConfirmationResponse input)
        {
            if (input == null)
                return false;
