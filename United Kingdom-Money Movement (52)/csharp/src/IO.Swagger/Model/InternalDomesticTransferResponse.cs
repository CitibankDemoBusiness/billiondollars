...
{
    /// <summary>
    /// InternalDomesticTransferResponse
    /// </summary>
    [DataContract]
        public partial class InternalDomesticTransferResponse :  IEquatable<InternalDomesticTransferResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InternalDomesticTransferResponse" /> class.
        /// </summary>
        ...
        public InternalDomesticTransferResponse(SourceAccount sourceAccount = default(SourceAccount), string transactionReferenceId = default(string))
        {
            // to ensure "sourceAccount" is required (not null)
            if (sourceAccount == null)
            {
                throw new InvalidDataException("sourceAccount is a required property for InternalDomesticTransferResponse and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("transactionReferenceId is a required property for InternalDomesticTransferResponse and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InternalDomesticTransferResponse {\n");
        ...
        {
            return this.Equals(input as InternalDomesticTransferResponse);
        }

        /// <summary>
        /// Returns true if InternalDomesticTransferResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of InternalDomesticTransferResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InternalDomesticTransferResponse input)
        {
            if (input == null)
                return false;
