...
{
    /// <summary>
    /// SepaTransfersPreprocessResponse
    /// </summary>
    [DataContract]
        public partial class SepaTransfersPreprocessResponse :  IEquatable<SepaTransfersPreprocessResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SepaTransfersPreprocessResponse" /> class.
        /// </summary>
        ...
        public SepaTransfersPreprocessResponse(string controlFlowId = default(string), DebitDetails debitDetails = default(DebitDetails), CreditDetails creditDetails = default(CreditDetails), double? foreignExchangeRate = default(double?), double? transactionFee = default(double?), string feeCurrencyCode = default(string))
        {
            // to ensure "controlFlowId" is required (not null)
            if (controlFlowId == null)
            {
                throw new InvalidDataException("controlFlowId is a required property for SepaTransfersPreprocessResponse and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SepaTransfersPreprocessResponse {\n");
        ...
        {
            return this.Equals(input as SepaTransfersPreprocessResponse);
        }

        /// <summary>
        /// Returns true if SepaTransfersPreprocessResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of SepaTransfersPreprocessResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SepaTransfersPreprocessResponse input)
        {
            if (input == null)
                return false;
