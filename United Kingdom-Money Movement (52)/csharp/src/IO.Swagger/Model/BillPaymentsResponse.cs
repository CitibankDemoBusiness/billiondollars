...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class BillPaymentsResponse :  IEquatable<BillPaymentsResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BillPaymentsResponse" /> class.
        /// </summary>
        ...
        public BillPaymentsResponse(SourceAccount sourceAccount = default(SourceAccount), string transactionReferenceId = default(string))
        {
            // to ensure "sourceAccount" is required (not null)
            if (sourceAccount == null)
            {
                throw new InvalidDataException("sourceAccount is a required property for BillPaymentsResponse and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("transactionReferenceId is a required property for BillPaymentsResponse and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class BillPaymentsResponse {\n");
        ...
        {
            return this.Equals(input as BillPaymentsResponse);
        }

        /// <summary>
        /// Returns true if BillPaymentsResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of BillPaymentsResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BillPaymentsResponse input)
        {
            if (input == null)
                return false;
