...
{
    /// <summary>
    /// InternalDomesticValidSourceDestinationAcccountsResponse
    /// </summary>
    [DataContract]
        public partial class InternalDomesticValidSourceDestinationAcccountsResponse :  IEquatable<InternalDomesticValidSourceDestinationAcccountsResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InternalDomesticValidSourceDestinationAcccountsResponse" /> class.
        /// </summary>
        /// <param name="sourceAccounts">sourceAccounts (required).</param>
        /// <param name="payeeSourceAccountCombinations">payeeSourceAccountCombinations (required).</param>
        ...
        public InternalDomesticValidSourceDestinationAcccountsResponse(List<InternalDomesticSourceAccounts> sourceAccounts = default(List<InternalDomesticSourceAccounts>), List<InternalDomesticPayeeSourceAccountCombinations> payeeSourceAccountCombinations = default(List<InternalDomesticPayeeSourceAccountCombinations>), string nextStartIndex = default(string))
        {
            // to ensure "sourceAccounts" is required (not null)
            if (sourceAccounts == null)
            {
                throw new InvalidDataException("sourceAccounts is a required property for InternalDomesticValidSourceDestinationAcccountsResponse and cannot be null");
            }
            else
            {
                this.SourceAccounts = sourceAccounts;
            }
            // to ensure "payeeSourceAccountCombinations" is required (not null)
            if (payeeSourceAccountCombinations == null)
            {
                throw new InvalidDataException("payeeSourceAccountCombinations is a required property for InternalDomesticValidSourceDestinationAcccountsResponse and cannot be null");
            }
            else
            {
        ...
        public List<InternalDomesticSourceAccounts> SourceAccounts { get; set; }

        /// <summary>
        /// Gets or Sets PayeeSourceAccountCombinations
        /// </summary>
        [DataMember(Name="payeeSourceAccountCombinations", EmitDefaultValue=false)]
        public List<InternalDomesticPayeeSourceAccountCombinations> PayeeSourceAccountCombinations { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InternalDomesticValidSourceDestinationAcccountsResponse {\n");
        ...
        {
            return this.Equals(input as InternalDomesticValidSourceDestinationAcccountsResponse);
        }

        /// <summary>
        /// Returns true if InternalDomesticValidSourceDestinationAcccountsResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of InternalDomesticValidSourceDestinationAcccountsResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InternalDomesticValidSourceDestinationAcccountsResponse input)
        {
            if (input == null)
                return false;
