...
{
    /// <summary>
    /// AdhocSepaTransfersSrcAcctEligibilityResponse
    /// </summary>
    [DataContract]
        public partial class AdhocSepaTransfersSrcAcctEligibilityResponse :  IEquatable<AdhocSepaTransfersSrcAcctEligibilityResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AdhocSepaTransfersSrcAcctEligibilityResponse" /> class.
        /// </summary>
        ...
        public AdhocSepaTransfersSrcAcctEligibilityResponse(List<SourceAccounts> sourceAccounts = default(List<SourceAccounts>), string nextStartIndex = default(string))
        {
            // to ensure "sourceAccounts" is required (not null)
            if (sourceAccounts == null)
            {
                throw new InvalidDataException("sourceAccounts is a required property for AdhocSepaTransfersSrcAcctEligibilityResponse and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AdhocSepaTransfersSrcAcctEligibilityResponse {\n");
        ...
        {
            return this.Equals(input as AdhocSepaTransfersSrcAcctEligibilityResponse);
        }

        /// <summary>
        /// Returns true if AdhocSepaTransfersSrcAcctEligibilityResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of AdhocSepaTransfersSrcAcctEligibilityResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AdhocSepaTransfersSrcAcctEligibilityResponse input)
        {
            if (input == null)
                return false;
