...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class BankAddress :  IEquatable<BankAddress>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BankAddress" /> class.
        /// </summary>
        ...
        public BankAddress(string addressLine1 = default(string), string addressLine2 = default(string), string addressLine3 = default(string))
        {
        ...
        {
            return this.Equals(input as BankAddress);
        }

        /// <summary>
        /// Returns true if BankAddress instances are equal
        /// </summary>
        /// <param name="input">Instance of BankAddress to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BankAddress input)
        {
            if (input == null)
                return false;
