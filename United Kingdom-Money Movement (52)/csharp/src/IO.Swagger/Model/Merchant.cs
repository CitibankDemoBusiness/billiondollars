...
namespace IO.Swagger.Model
{
        ...
        public partial class Merchant :  IEquatable<Merchant>, IValidatableObject
    {
        ...
        /// <param name="merchantNumber">A string that uniquely identifies a merchant. (required).</param>
        public Merchant(string merchantName = default(string), string merchantNameLocal = default(string), string merchantNumber = default(string))
        {
            // to ensure "merchantName" is required (not null)
            if (merchantName == null)
            {
                throw new InvalidDataException("merchantName is a required property for Merchant and cannot be null");
            }
            else
            {
                this.MerchantName = merchantName;
            }
            // to ensure "merchantNumber" is required (not null)
            if (merchantNumber == null)
            {
                throw new InvalidDataException("merchantNumber is a required property for Merchant and cannot be null");
            }
            else
            {
