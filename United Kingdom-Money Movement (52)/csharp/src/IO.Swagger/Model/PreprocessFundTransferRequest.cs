...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class PreprocessFundTransferRequest :  IEquatable<PreprocessFundTransferRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PreprocessFundTransferRequest" /> class.
        /// </summary>
        ...
        /// <param name="transferCurrencyIndicator">Indicator to specify whether the transfer is in source or destination account currency.The payment type.This is a reference data field. Please use /v1/utilities/referenceData/{transferCurrencyIndicator} resource to get valid value of this field with description. (required).</param>
        ...
        /// <param name="chargeBearer">Field to identify charge bearer.The payment type.This is a reference data field. Please use /v1/utilities/referenceData/{chargeBearer} resource to get valid value of this field with description. (required).</param>
        ...
        public PreprocessFundTransferRequest(string sourceAccountId = default(string), double? transactionAmount = default(double?), string transferCurrencyIndicator = default(string), string destinationAccountId = default(string), string chargeBearer = default(string), string fxDealReferenceNumber = default(string), string paymentScheduleType = default(string), FutureDatedTransaction futureDatedTransaction = default(FutureDatedTransaction), StandingInstruction standingInstruction = default(StandingInstruction), string remarks = default(string))
        {
            // to ensure "sourceAccountId" is required (not null)
            if (sourceAccountId == null)
            {
                throw new InvalidDataException("sourceAccountId is a required property for PreprocessFundTransferRequest and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("transactionAmount is a required property for PreprocessFundTransferRequest and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("transferCurrencyIndicator is a required property for PreprocessFundTransferRequest and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("destinationAccountId is a required property for PreprocessFundTransferRequest and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("chargeBearer is a required property for PreprocessFundTransferRequest and cannot be null");
            }
            else
            {
        ...
        /// <summary>
        /// Indicator to specify whether the transfer is in source or destination account currency.The payment type.This is a reference data field. Please use /v1/utilities/referenceData/{transferCurrencyIndicator} resource to get valid value of this field with description.
        /// </summary>
        /// <value>Indicator to specify whether the transfer is in source or destination account currency.The payment type.This is a reference data field. Please use /v1/utilities/referenceData/{transferCurrencyIndicator} resource to get valid value of this field with description.</value>
        ...
        /// <summary>
        /// Field to identify charge bearer.The payment type.This is a reference data field. Please use /v1/utilities/referenceData/{chargeBearer} resource to get valid value of this field with description.
        /// </summary>
        /// <value>Field to identify charge bearer.The payment type.This is a reference data field. Please use /v1/utilities/referenceData/{chargeBearer} resource to get valid value of this field with description.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PreprocessFundTransferRequest {\n");
        ...
        {
            return this.Equals(input as PreprocessFundTransferRequest);
        }

        /// <summary>
        /// Returns true if PreprocessFundTransferRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of PreprocessFundTransferRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PreprocessFundTransferRequest input)
        {
            if (input == null)
                return false;
