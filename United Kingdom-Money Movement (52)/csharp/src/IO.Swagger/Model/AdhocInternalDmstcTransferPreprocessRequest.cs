...
{
    /// <summary>
    /// AdhocInternalDmstcTransferPreprocessRequest
    /// </summary>
    [DataContract]
        public partial class AdhocInternalDmstcTransferPreprocessRequest :  IEquatable<AdhocInternalDmstcTransferPreprocessRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AdhocInternalDmstcTransferPreprocessRequest" /> class.
        /// </summary>
        ...
        public AdhocInternalDmstcTransferPreprocessRequest(string sourceAccountId = default(string), PayeeAccountDetailsAdhocIntTransferPreprocess payeeAccountDetails = default(PayeeAccountDetailsAdhocIntTransferPreprocess), double? transactionAmount = default(double?), string transferCurrencyIndicator = default(string), string paymentScheduleType = default(string), FutureDatedTransaction futureDatedTransaction = default(FutureDatedTransaction), StandingInstruction standingInstruction = default(StandingInstruction), string remarks = default(string))
        {
            // to ensure "sourceAccountId" is required (not null)
            if (sourceAccountId == null)
            {
                throw new InvalidDataException("sourceAccountId is a required property for AdhocInternalDmstcTransferPreprocessRequest and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("payeeAccountDetails is a required property for AdhocInternalDmstcTransferPreprocessRequest and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("transactionAmount is a required property for AdhocInternalDmstcTransferPreprocessRequest and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("transferCurrencyIndicator is a required property for AdhocInternalDmstcTransferPreprocessRequest and cannot be null");
            }
            else
            {
        ...
        public PayeeAccountDetailsAdhocIntTransferPreprocess PayeeAccountDetails { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AdhocInternalDmstcTransferPreprocessRequest {\n");
        ...
        {
            return this.Equals(input as AdhocInternalDmstcTransferPreprocessRequest);
        }

        /// <summary>
        /// Returns true if AdhocInternalDmstcTransferPreprocessRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of AdhocInternalDmstcTransferPreprocessRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AdhocInternalDmstcTransferPreprocessRequest input)
        {
            if (input == null)
                return false;
