...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class BillPaymentsPreprocessResponse :  IEquatable<BillPaymentsPreprocessResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BillPaymentsPreprocessResponse" /> class.
        /// </summary>
        ...
        public BillPaymentsPreprocessResponse(string controlFlowId = default(string), DebitDetails debitDetails = default(DebitDetails), CreditDetails creditDetails = default(CreditDetails), double? foreignExchangeRate = default(double?), double? transactionFee = default(double?), string feeCurrencyCode = default(string), string payeeName = default(string), string merchantNumber = default(string))
        {
            // to ensure "controlFlowId" is required (not null)
            if (controlFlowId == null)
            {
                throw new InvalidDataException("controlFlowId is a required property for BillPaymentsPreprocessResponse and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class BillPaymentsPreprocessResponse {\n");
        ...
        {
            return this.Equals(input as BillPaymentsPreprocessResponse);
        }

        /// <summary>
        /// Returns true if BillPaymentsPreprocessResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of BillPaymentsPreprocessResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BillPaymentsPreprocessResponse input)
        {
            if (input == null)
                return false;
