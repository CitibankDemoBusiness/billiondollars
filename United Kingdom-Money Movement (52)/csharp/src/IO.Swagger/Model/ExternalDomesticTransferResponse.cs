...
{
    /// <summary>
    /// ExternalDomesticTransferResponse
    /// </summary>
    [DataContract]
        public partial class ExternalDomesticTransferResponse :  IEquatable<ExternalDomesticTransferResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ExternalDomesticTransferResponse" /> class.
        /// </summary>
        ...
        public ExternalDomesticTransferResponse(SourceAccount sourceAccount = default(SourceAccount), string transactionReferenceId = default(string))
        {
            // to ensure "sourceAccount" is required (not null)
            if (sourceAccount == null)
            {
                throw new InvalidDataException("sourceAccount is a required property for ExternalDomesticTransferResponse and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("transactionReferenceId is a required property for ExternalDomesticTransferResponse and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ExternalDomesticTransferResponse {\n");
        ...
        {
            return this.Equals(input as ExternalDomesticTransferResponse);
        }

        /// <summary>
        /// Returns true if ExternalDomesticTransferResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of ExternalDomesticTransferResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ExternalDomesticTransferResponse input)
        {
            if (input == null)
                return false;
