...
{
    /// <summary>
    /// CrossBorderWireTransfersPreprocessRequest
    /// </summary>
    [DataContract]
        public partial class CrossBorderWireTransfersPreprocessRequest :  IEquatable<CrossBorderWireTransfersPreprocessRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CrossBorderWireTransfersPreprocessRequest" /> class.
        /// </summary>
        ...
        public CrossBorderWireTransfersPreprocessRequest(string sourceAccountId = default(string), string payeeId = default(string), double? transactionAmount = default(double?), string transactionCurrencyCode = default(string), string chargeBearer = default(string), string paymentScheduleType = default(string), FutureDatedTransaction futureDatedTransaction = default(FutureDatedTransaction), StandingInstruction standingInstruction = default(StandingInstruction), List<Remarks> remarks = default(List<Remarks>))
        {
            ...
            if (payeeId == null)
            {
                throw new InvalidDataException("payeeId is a required property for CrossBorderWireTransfersPreprocessRequest and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("transactionAmount is a required property for CrossBorderWireTransfersPreprocessRequest and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("chargeBearer is a required property for CrossBorderWireTransfersPreprocessRequest and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CrossBorderWireTransfersPreprocessRequest {\n");
        ...
        {
            return this.Equals(input as CrossBorderWireTransfersPreprocessRequest);
        }

        /// <summary>
        /// Returns true if CrossBorderWireTransfersPreprocessRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of CrossBorderWireTransfersPreprocessRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CrossBorderWireTransfersPreprocessRequest input)
        {
            if (input == null)
                return false;
