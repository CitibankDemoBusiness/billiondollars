...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class DestinationSourceAcctCombinations :  IEquatable<DestinationSourceAcctCombinations>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DestinationSourceAcctCombinations" /> class.
        /// </summary>
        ...
        public DestinationSourceAcctCombinations(string destinationAccountId = default(string), string displayDestinationAccountNumber = default(string), string destinationAccountCurrencyCode = default(string), string productName = default(string), double? availableBalance = default(double?), double? nextPaymentAmount = default(double?), double? outstandingBalance = default(double?), double? minimumDueAmount = default(double?), DateTime? lastStatementDate = default(DateTime?), DateTime? paymentDueDate = default(DateTime?), List<SourceAccountIds> sourceAccountIds = default(List<SourceAccountIds>), string accountNickName = default(string))
        {
            // to ensure "destinationAccountId" is required (not null)
            if (destinationAccountId == null)
            {
                throw new InvalidDataException("destinationAccountId is a required property for DestinationSourceAcctCombinations and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("displayDestinationAccountNumber is a required property for DestinationSourceAcctCombinations and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("destinationAccountCurrencyCode is a required property for DestinationSourceAcctCombinations and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("sourceAccountIds is a required property for DestinationSourceAcctCombinations and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DestinationSourceAcctCombinations {\n");
        ...
        {
            return this.Equals(input as DestinationSourceAcctCombinations);
        }

        /// <summary>
        /// Returns true if DestinationSourceAcctCombinations instances are equal
        /// </summary>
        /// <param name="input">Instance of DestinationSourceAcctCombinations to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DestinationSourceAcctCombinations input)
        {
            if (input == null)
                return false;
