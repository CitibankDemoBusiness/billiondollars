...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class AccountProxyTransfersResponse :  IEquatable<AccountProxyTransfersResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AccountProxyTransfersResponse" /> class.
        /// </summary>
        ...
        public AccountProxyTransfersResponse(SourceAccount sourceAccount = default(SourceAccount), string transactionReferenceId = default(string), string payeeEnrollmentStatus = default(string))
        {
            // to ensure "sourceAccount" is required (not null)
            if (sourceAccount == null)
            {
                throw new InvalidDataException("sourceAccount is a required property for AccountProxyTransfersResponse and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("transactionReferenceId is a required property for AccountProxyTransfersResponse and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AccountProxyTransfersResponse {\n");
        ...
        {
            return this.Equals(input as AccountProxyTransfersResponse);
        }

        /// <summary>
        /// Returns true if AccountProxyTransfersResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of AccountProxyTransfersResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AccountProxyTransfersResponse input)
        {
            if (input == null)
                return false;
