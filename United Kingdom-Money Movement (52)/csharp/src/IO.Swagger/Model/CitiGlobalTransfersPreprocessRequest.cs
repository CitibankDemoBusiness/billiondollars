...
{
    /// <summary>
    /// CitiGlobalTransfersPreprocessRequest
    /// </summary>
    [DataContract]
        public partial class CitiGlobalTransfersPreprocessRequest :  IEquatable<CitiGlobalTransfersPreprocessRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CitiGlobalTransfersPreprocessRequest" /> class.
        /// </summary>
        ...
        /// <param name="transferPurpose">Purpose of transfer.Please use /v1/utilities/referenceData/{transferPurpose} resource to get valid value of this field with description..</param>
        public CitiGlobalTransfersPreprocessRequest(string sourceAccountId = default(string), string payeeId = default(string), double? transactionAmount = default(double?), string transactionCurrencyCode = default(string), string transferPurpose = default(string))
        {
            // to ensure "sourceAccountId" is required (not null)
            if (sourceAccountId == null)
            {
                throw new InvalidDataException("sourceAccountId is a required property for CitiGlobalTransfersPreprocessRequest and cannot be null");
            }
            else
            {
            ...
            if (payeeId == null)
            {
                throw new InvalidDataException("payeeId is a required property for CitiGlobalTransfersPreprocessRequest and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("transactionAmount is a required property for CitiGlobalTransfersPreprocessRequest and cannot be null");
            }
            else
            {
        ...
        /// <summary>
        /// Purpose of transfer.Please use /v1/utilities/referenceData/{transferPurpose} resource to get valid value of this field with description.
        /// </summary>
        /// <value>Purpose of transfer.Please use /v1/utilities/referenceData/{transferPurpose} resource to get valid value of this field with description.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CitiGlobalTransfersPreprocessRequest {\n");
        ...
        {
            return this.Equals(input as CitiGlobalTransfersPreprocessRequest);
        }

        /// <summary>
        /// Returns true if CitiGlobalTransfersPreprocessRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of CitiGlobalTransfersPreprocessRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CitiGlobalTransfersPreprocessRequest input)
        {
            if (input == null)
                return false;
