...
{
    /// <summary>
    /// CitiGlobalTransfersAccountPayeeEligibilityResponse
    /// </summary>
    [DataContract]
        public partial class CitiGlobalTransfersAccountPayeeEligibilityResponse :  IEquatable<CitiGlobalTransfersAccountPayeeEligibilityResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CitiGlobalTransfersAccountPayeeEligibilityResponse" /> class.
        /// </summary>
        ...
        public CitiGlobalTransfersAccountPayeeEligibilityResponse(List<SourceAccountsCitiGlobalTransfer> sourceAccounts = default(List<SourceAccountsCitiGlobalTransfer>), List<PayeeSourceAccountCombinationsCitiGlobalTransfer> payeeSourceAccountCombinations = default(List<PayeeSourceAccountCombinationsCitiGlobalTransfer>), string nextStartIndex = default(string))
        {
            // to ensure "sourceAccounts" is required (not null)
            if (sourceAccounts == null)
            {
                throw new InvalidDataException("sourceAccounts is a required property for CitiGlobalTransfersAccountPayeeEligibilityResponse and cannot be null");
            }
            else
            {
        ...
        public List<SourceAccountsCitiGlobalTransfer> SourceAccounts { get; set; }

        /// <summary>
        /// Gets or Sets PayeeSourceAccountCombinations
        /// </summary>
        [DataMember(Name="payeeSourceAccountCombinations", EmitDefaultValue=false)]
        public List<PayeeSourceAccountCombinationsCitiGlobalTransfer> PayeeSourceAccountCombinations { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CitiGlobalTransfersAccountPayeeEligibilityResponse {\n");
        ...
        {
            return this.Equals(input as CitiGlobalTransfersAccountPayeeEligibilityResponse);
        }

        /// <summary>
        /// Returns true if CitiGlobalTransfersAccountPayeeEligibilityResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of CitiGlobalTransfersAccountPayeeEligibilityResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CitiGlobalTransfersAccountPayeeEligibilityResponse input)
        {
            if (input == null)
                return false;
