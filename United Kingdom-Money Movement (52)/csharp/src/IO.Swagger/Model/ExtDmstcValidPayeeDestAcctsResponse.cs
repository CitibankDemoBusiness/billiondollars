...
{
    /// <summary>
    /// ExtDmstcValidPayeeDestAcctsResponse
    /// </summary>
    [DataContract]
        public partial class ExtDmstcValidPayeeDestAcctsResponse :  IEquatable<ExtDmstcValidPayeeDestAcctsResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ExtDmstcValidPayeeDestAcctsResponse" /> class.
        /// </summary>
        ...
        public ExtDmstcValidPayeeDestAcctsResponse(List<ExternalDomesticSourceAccounts> sourceAccounts = default(List<ExternalDomesticSourceAccounts>), List<ExternalDomesticPayeeSourceAccountCombinations> payeeSourceAccountCombinations = default(List<ExternalDomesticPayeeSourceAccountCombinations>), string nextStartIndex = default(string))
        {
            // to ensure "sourceAccounts" is required (not null)
            if (sourceAccounts == null)
            {
                throw new InvalidDataException("sourceAccounts is a required property for ExtDmstcValidPayeeDestAcctsResponse and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("payeeSourceAccountCombinations is a required property for ExtDmstcValidPayeeDestAcctsResponse and cannot be null");
            }
            else
            {
        ...
        public List<ExternalDomesticSourceAccounts> SourceAccounts { get; set; }

        /// <summary>
        /// Gets or Sets PayeeSourceAccountCombinations
        /// </summary>
        [DataMember(Name="payeeSourceAccountCombinations", EmitDefaultValue=false)]
        public List<ExternalDomesticPayeeSourceAccountCombinations> PayeeSourceAccountCombinations { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ExtDmstcValidPayeeDestAcctsResponse {\n");
        ...
        {
            return this.Equals(input as ExtDmstcValidPayeeDestAcctsResponse);
        }

        /// <summary>
        /// Returns true if ExtDmstcValidPayeeDestAcctsResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of ExtDmstcValidPayeeDestAcctsResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ExtDmstcValidPayeeDestAcctsResponse input)
        {
            if (input == null)
                return false;
