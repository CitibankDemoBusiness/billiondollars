...
{
    /// <summary>
    /// PersonalDomesticSourceAccounts
    /// </summary>
    [DataContract]
        public partial class PersonalDomesticSourceAccounts :  IEquatable<PersonalDomesticSourceAccounts>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PersonalDomesticSourceAccounts" /> class.
        /// </summary>
        /// <param name="sourceAccountId">The source account ID in encrypted format. Typically, this is not displayed to the customer,use displayAccountNumber instead. (required).</param>
        ...
        public PersonalDomesticSourceAccounts(string sourceAccountId = default(string), string displaySourceAccountNumber = default(string), string sourceAccountCurrencyCode = default(string), string accountGroup = default(string), double? availableBalance = default(double?), double? nextPaymentAmount = default(double?), string productName = default(string), string accountNickName = default(string))
        {
            // to ensure "sourceAccountId" is required (not null)
            if (sourceAccountId == null)
            {
                throw new InvalidDataException("sourceAccountId is a required property for PersonalDomesticSourceAccounts and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("displaySourceAccountNumber is a required property for PersonalDomesticSourceAccounts and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("sourceAccountCurrencyCode is a required property for PersonalDomesticSourceAccounts and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("accountGroup is a required property for PersonalDomesticSourceAccounts and cannot be null");
            }
            else
            {
        ...
        /// </summary>
        /// <value>The source account ID in encrypted format. Typically, this is not displayed to the customer,use displayAccountNumber instead.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PersonalDomesticSourceAccounts {\n");
        ...
        {
            return this.Equals(input as PersonalDomesticSourceAccounts);
        }

        /// <summary>
        /// Returns true if PersonalDomesticSourceAccounts instances are equal
        /// </summary>
        /// <param name="input">Instance of PersonalDomesticSourceAccounts to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PersonalDomesticSourceAccounts input)
        {
            if (input == null)
                return false;
