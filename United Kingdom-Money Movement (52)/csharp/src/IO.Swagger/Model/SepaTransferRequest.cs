...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class SepaTransferRequest :  IEquatable<SepaTransferRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SepaTransferRequest" /> class.
        /// </summary>
        /// <param name="controlFlowId">Control flow Id (required).</param>
        public SepaTransferRequest(string controlFlowId = default(string))
        {
            // to ensure "controlFlowId" is required (not null)
            if (controlFlowId == null)
            {
                throw new InvalidDataException("controlFlowId is a required property for SepaTransferRequest and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SepaTransferRequest {\n");
        ...
        {
            return this.Equals(input as SepaTransferRequest);
        }

        /// <summary>
        /// Returns true if SepaTransferRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of SepaTransferRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SepaTransferRequest input)
        {
            if (input == null)
                return false;
