...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class SourceAccountIds :  IEquatable<SourceAccountIds>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SourceAccountIds" /> class.
        /// </summary>
        ...
        public SourceAccountIds(string sourceAccountId = default(string))
        {
            // to ensure "sourceAccountId" is required (not null)
            if (sourceAccountId == null)
            {
                throw new InvalidDataException("sourceAccountId is a required property for SourceAccountIds and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SourceAccountIds {\n");
        ...
        {
            return this.Equals(input as SourceAccountIds);
        }

        /// <summary>
        /// Returns true if SourceAccountIds instances are equal
        /// </summary>
        /// <param name="input">Instance of SourceAccountIds to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SourceAccountIds input)
        {
            if (input == null)
                return false;
