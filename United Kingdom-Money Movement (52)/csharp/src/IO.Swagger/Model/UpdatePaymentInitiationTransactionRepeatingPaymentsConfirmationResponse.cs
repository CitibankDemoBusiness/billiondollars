...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class UpdatePaymentInitiationTransactionRepeatingPaymentsConfirmationResponse :  IEquatable<UpdatePaymentInitiationTransactionRepeatingPaymentsConfirmationResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdatePaymentInitiationTransactionRepeatingPaymentsConfirmationResponse" /> class.
        /// </summary>
        ...
        public UpdatePaymentInitiationTransactionRepeatingPaymentsConfirmationResponse(string accountId = default(string), string transactionReferenceId = default(string))
        {
            // to ensure "accountId" is required (not null)
            if (accountId == null)
            {
                throw new InvalidDataException("accountId is a required property for UpdatePaymentInitiationTransactionRepeatingPaymentsConfirmationResponse and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("transactionReferenceId is a required property for UpdatePaymentInitiationTransactionRepeatingPaymentsConfirmationResponse and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class UpdatePaymentInitiationTransactionRepeatingPaymentsConfirmationResponse {\n");
        ...
        {
            return this.Equals(input as UpdatePaymentInitiationTransactionRepeatingPaymentsConfirmationResponse);
        }

        /// <summary>
        /// Returns true if UpdatePaymentInitiationTransactionRepeatingPaymentsConfirmationResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of UpdatePaymentInitiationTransactionRepeatingPaymentsConfirmationResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UpdatePaymentInitiationTransactionRepeatingPaymentsConfirmationResponse input)
        {
            if (input == null)
                return false;
