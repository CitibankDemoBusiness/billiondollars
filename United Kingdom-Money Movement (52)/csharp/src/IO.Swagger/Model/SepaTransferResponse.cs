...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class SepaTransferResponse :  IEquatable<SepaTransferResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SepaTransferResponse" /> class.
        /// </summary>
        ...
        public SepaTransferResponse(string transactionReferenceId = default(string), SourceAccountDetails sourceAccountDetails = default(SourceAccountDetails))
        {
            // to ensure "transactionReferenceId" is required (not null)
            if (transactionReferenceId == null)
            {
                throw new InvalidDataException("transactionReferenceId is a required property for SepaTransferResponse and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("sourceAccountDetails is a required property for SepaTransferResponse and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SepaTransferResponse {\n");
        ...
        {
            return this.Equals(input as SepaTransferResponse);
        }

        /// <summary>
        /// Returns true if SepaTransferResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of SepaTransferResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SepaTransferResponse input)
        {
            if (input == null)
                return false;
