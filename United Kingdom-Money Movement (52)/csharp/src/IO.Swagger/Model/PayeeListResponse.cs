...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class PayeeListResponse :  IEquatable<PayeeListResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PayeeListResponse" /> class.
        /// </summary>
        /// <param name="payeeList">payeeList (required).</param>
        ...
        public PayeeListResponse(List<Payee> payeeList = default(List<Payee>), string nextStartIndex = default(string))
        {
            // to ensure "payeeList" is required (not null)
            if (payeeList == null)
            {
                throw new InvalidDataException("payeeList is a required property for PayeeListResponse and cannot be null");
            }
            else
            {
        ...
        /// <summary>
        /// Gets or Sets PayeeList
        /// </summary>
        [DataMember(Name="payeeList", EmitDefaultValue=false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PayeeListResponse {\n");
            sb.Append("  PayeeList: ").Append(PayeeList).Append("\n");
        ...
        {
            return this.Equals(input as PayeeListResponse);
        }

        /// <summary>
        /// Returns true if PayeeListResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of PayeeListResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PayeeListResponse input)
        {
            if (input == null)
                return false;
            ...
            return 
                (
                    this.PayeeList == input.PayeeList ||
                    this.PayeeList != null &&
                    input.PayeeList != null &&
                    this.PayeeList.SequenceEqual(input.PayeeList)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.PayeeList != null)
                    hashCode = hashCode * 59 + this.PayeeList.GetHashCode();
