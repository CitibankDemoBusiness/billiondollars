...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class UpdatePaymentInitiationTransactionRepeatingPaymentsPreprocessResponse :  IEquatable<UpdatePaymentInitiationTransactionRepeatingPaymentsPreprocessResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdatePaymentInitiationTransactionRepeatingPaymentsPreprocessResponse" /> class.
        /// </summary>
        /// <param name="controlFlowId">This is control Flow id for next API (required).</param>
        ...
        /// <param name="feeCurrencyCode">This is fee currency code in ISO 4217 format..</param>
        public UpdatePaymentInitiationTransactionRepeatingPaymentsPreprocessResponse(string controlFlowId = default(string), List<DebitDetails> debitDetails = default(List<DebitDetails>), List<CreditDetails> creditDetails = default(List<CreditDetails>), double? foreignExchangeRate = default(double?), double? transactionFee = default(double?), string feeCurrencyCode = default(string))
        {
            // to ensure "controlFlowId" is required (not null)
            if (controlFlowId == null)
            {
                throw new InvalidDataException("controlFlowId is a required property for UpdatePaymentInitiationTransactionRepeatingPaymentsPreprocessResponse and cannot be null");
            }
            else
            {
        ...
        /// <summary>
        /// This is control Flow id for next API
        /// </summary>
        /// <value>This is control Flow id for next API</value>
        ...
        /// <summary>
        /// This is fee currency code in ISO 4217 format.
        /// </summary>
        /// <value>This is fee currency code in ISO 4217 format.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class UpdatePaymentInitiationTransactionRepeatingPaymentsPreprocessResponse {\n");
        ...
        {
            return this.Equals(input as UpdatePaymentInitiationTransactionRepeatingPaymentsPreprocessResponse);
        }

        /// <summary>
        /// Returns true if UpdatePaymentInitiationTransactionRepeatingPaymentsPreprocessResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of UpdatePaymentInitiationTransactionRepeatingPaymentsPreprocessResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UpdatePaymentInitiationTransactionRepeatingPaymentsPreprocessResponse input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    ...
                    input.DebitDetails != null &&
                    this.DebitDetails.SequenceEqual(input.DebitDetails)
                ) && 
                (
                    this.CreditDetails == input.CreditDetails ||
                    this.CreditDetails != null &&
                    input.CreditDetails != null &&
                    this.CreditDetails.SequenceEqual(input.CreditDetails)
                ) && 
                (
