...
{
    /// <summary>
    /// AdhocCitiGlobalTransfersSrcAcctEligibilityResponse
    /// </summary>
    [DataContract]
        public partial class AdhocCitiGlobalTransfersSrcAcctEligibilityResponse :  IEquatable<AdhocCitiGlobalTransfersSrcAcctEligibilityResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AdhocCitiGlobalTransfersSrcAcctEligibilityResponse" /> class.
        /// </summary>
        ...
        public AdhocCitiGlobalTransfersSrcAcctEligibilityResponse(List<SourceAccounts> sourceAccounts = default(List<SourceAccounts>), string nextStartIndex = default(string))
        {
            // to ensure "sourceAccounts" is required (not null)
            if (sourceAccounts == null)
            {
                throw new InvalidDataException("sourceAccounts is a required property for AdhocCitiGlobalTransfersSrcAcctEligibilityResponse and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AdhocCitiGlobalTransfersSrcAcctEligibilityResponse {\n");
        ...
        {
            return this.Equals(input as AdhocCitiGlobalTransfersSrcAcctEligibilityResponse);
        }

        /// <summary>
        /// Returns true if AdhocCitiGlobalTransfersSrcAcctEligibilityResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of AdhocCitiGlobalTransfersSrcAcctEligibilityResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AdhocCitiGlobalTransfersSrcAcctEligibilityResponse input)
        {
            if (input == null)
                return false;
