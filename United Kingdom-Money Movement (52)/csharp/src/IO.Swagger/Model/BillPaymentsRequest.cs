...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class BillPaymentsRequest :  IEquatable<BillPaymentsRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BillPaymentsRequest" /> class.
        /// </summary>
        /// <param name="controlFlowId">Control Flow Id (required).</param>
        public BillPaymentsRequest(string controlFlowId = default(string))
        {
            // to ensure "controlFlowId" is required (not null)
            if (controlFlowId == null)
            {
                throw new InvalidDataException("controlFlowId is a required property for BillPaymentsRequest and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class BillPaymentsRequest {\n");
        ...
        {
            return this.Equals(input as BillPaymentsRequest);
        }

        /// <summary>
        /// Returns true if BillPaymentsRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of BillPaymentsRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BillPaymentsRequest input)
        {
            if (input == null)
                return false;
