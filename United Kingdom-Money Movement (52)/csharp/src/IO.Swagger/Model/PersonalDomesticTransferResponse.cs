...
{
    /// <summary>
    /// PersonalDomesticTransferResponse
    /// </summary>
    [DataContract]
        public partial class PersonalDomesticTransferResponse :  IEquatable<PersonalDomesticTransferResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PersonalDomesticTransferResponse" /> class.
        /// </summary>
        ...
        public PersonalDomesticTransferResponse(SourceAccount sourceAccount = default(SourceAccount), DestinationAccount destinationAccount = default(DestinationAccount), string transactionReferenceId = default(string))
        {
            // to ensure "destinationAccount" is required (not null)
            if (destinationAccount == null)
            {
                throw new InvalidDataException("destinationAccount is a required property for PersonalDomesticTransferResponse and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("transactionReferenceId is a required property for PersonalDomesticTransferResponse and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PersonalDomesticTransferResponse {\n");
        ...
        {
            return this.Equals(input as PersonalDomesticTransferResponse);
        }

        /// <summary>
        /// Returns true if PersonalDomesticTransferResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of PersonalDomesticTransferResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PersonalDomesticTransferResponse input)
        {
            if (input == null)
                return false;
