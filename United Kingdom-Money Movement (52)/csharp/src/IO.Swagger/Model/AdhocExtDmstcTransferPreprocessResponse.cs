...
{
    /// <summary>
    /// AdhocExtDmstcTransferPreprocessResponse
    /// </summary>
    [DataContract]
        public partial class AdhocExtDmstcTransferPreprocessResponse :  IEquatable<AdhocExtDmstcTransferPreprocessResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AdhocExtDmstcTransferPreprocessResponse" /> class.
        /// </summary>
        ...
        public AdhocExtDmstcTransferPreprocessResponse(string controlFlowId = default(string), DebitDetails debitDetails = default(DebitDetails), CreditDetails creditDetails = default(CreditDetails), double? foreignExchangeRate = default(double?), double? transactionFee = default(double?), string feeCurrencyCode = default(string))
        {
            // to ensure "controlFlowId" is required (not null)
            if (controlFlowId == null)
            {
                throw new InvalidDataException("controlFlowId is a required property for AdhocExtDmstcTransferPreprocessResponse and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("debitDetails is a required property for AdhocExtDmstcTransferPreprocessResponse and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("creditDetails is a required property for AdhocExtDmstcTransferPreprocessResponse and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AdhocExtDmstcTransferPreprocessResponse {\n");
        ...
        {
            return this.Equals(input as AdhocExtDmstcTransferPreprocessResponse);
        }

        /// <summary>
        /// Returns true if AdhocExtDmstcTransferPreprocessResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of AdhocExtDmstcTransferPreprocessResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AdhocExtDmstcTransferPreprocessResponse input)
        {
            if (input == null)
                return false;
