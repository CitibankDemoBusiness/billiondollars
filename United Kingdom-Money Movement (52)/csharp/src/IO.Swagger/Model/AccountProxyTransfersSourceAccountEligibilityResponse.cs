...
{
    /// <summary>
    /// AccountProxyTransfersSourceAccountEligibilityResponse
    /// </summary>
    [DataContract]
        public partial class AccountProxyTransfersSourceAccountEligibilityResponse :  IEquatable<AccountProxyTransfersSourceAccountEligibilityResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AccountProxyTransfersSourceAccountEligibilityResponse" /> class.
        /// </summary>
        ...
        public AccountProxyTransfersSourceAccountEligibilityResponse(List<SourceAccounts> sourceAccounts = default(List<SourceAccounts>), string nextStartIndex = default(string))
        {
            // to ensure "sourceAccounts" is required (not null)
            if (sourceAccounts == null)
            {
                throw new InvalidDataException("sourceAccounts is a required property for AccountProxyTransfersSourceAccountEligibilityResponse and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AccountProxyTransfersSourceAccountEligibilityResponse {\n");
        ...
        {
            return this.Equals(input as AccountProxyTransfersSourceAccountEligibilityResponse);
        }

        /// <summary>
        /// Returns true if AccountProxyTransfersSourceAccountEligibilityResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of AccountProxyTransfersSourceAccountEligibilityResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AccountProxyTransfersSourceAccountEligibilityResponse input)
        {
            if (input == null)
                return false;
