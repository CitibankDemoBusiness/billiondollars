...
{
    /// <summary>
    /// InternalDomesticTransferConfirmationResponse
    /// </summary>
    [DataContract]
        public partial class InternalDomesticTransferConfirmationResponse :  IEquatable<InternalDomesticTransferConfirmationResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InternalDomesticTransferConfirmationResponse" /> class.
        /// </summary>
        ...
        public InternalDomesticTransferConfirmationResponse(SourceAccount sourceAccount = default(SourceAccount), string payeeEnrollmentStatus = default(string), string transactionReferenceId = default(string))
        {
            // to ensure "transactionReferenceId" is required (not null)
            if (transactionReferenceId == null)
            {
                throw new InvalidDataException("transactionReferenceId is a required property for InternalDomesticTransferConfirmationResponse and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InternalDomesticTransferConfirmationResponse {\n");
        ...
        {
            return this.Equals(input as InternalDomesticTransferConfirmationResponse);
        }

        /// <summary>
        /// Returns true if InternalDomesticTransferConfirmationResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of InternalDomesticTransferConfirmationResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InternalDomesticTransferConfirmationResponse input)
        {
            if (input == null)
                return false;
