...
{
    /// <summary>
    /// AccountProxyTransfersPreprocessRequest
    /// </summary>
    [DataContract]
        public partial class AccountProxyTransfersPreprocessRequest :  IEquatable<AccountProxyTransfersPreprocessRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AccountProxyTransfersPreprocessRequest" /> class.
        /// </summary>
        ...
        public AccountProxyTransfersPreprocessRequest(string proxyPaymentType = default(string), string sourceAccountId = default(string), double? transactionAmount = default(double?), string transactionCurrencyCode = default(string), string transferCurrencyIndicator = default(string), string proxyAccountId = default(string), string proxyAccountIdType = default(string), string chargeBearer = default(string), string billReferenceNumber = default(string), string remarks = default(string), string transferPurpose = default(string))
        {
            // to ensure "proxyPaymentType" is required (not null)
            if (proxyPaymentType == null)
            {
                throw new InvalidDataException("proxyPaymentType is a required property for AccountProxyTransfersPreprocessRequest and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("sourceAccountId is a required property for AccountProxyTransfersPreprocessRequest and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("transactionAmount is a required property for AccountProxyTransfersPreprocessRequest and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("transferCurrencyIndicator is a required property for AccountProxyTransfersPreprocessRequest and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("proxyAccountId is a required property for AccountProxyTransfersPreprocessRequest and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("proxyAccountIdType is a required property for AccountProxyTransfersPreprocessRequest and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("chargeBearer is a required property for AccountProxyTransfersPreprocessRequest and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AccountProxyTransfersPreprocessRequest {\n");
        ...
        {
            return this.Equals(input as AccountProxyTransfersPreprocessRequest);
        }

        /// <summary>
        /// Returns true if AccountProxyTransfersPreprocessRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of AccountProxyTransfersPreprocessRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AccountProxyTransfersPreprocessRequest input)
        {
            if (input == null)
                return false;
