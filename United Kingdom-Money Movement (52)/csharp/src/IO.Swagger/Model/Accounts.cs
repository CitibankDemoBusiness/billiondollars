...
namespace IO.Swagger.Model
{
        ...
        public partial class Accounts :  IEquatable<Accounts>, IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="unmaskedAccountNumber">An unmasked account number to be displayed to the customer (required).</param>
        ...
        public Accounts(string unmaskedAccountNumber = default(string), string accountId = default(string))
        {
            // to ensure "unmaskedAccountNumber" is required (not null)
            if (unmaskedAccountNumber == null)
            {
                throw new InvalidDataException("unmaskedAccountNumber is a required property for Accounts and cannot be null");
            }
            else
            {
            ...
            if (accountId == null)
            {
                throw new InvalidDataException("accountId is a required property for Accounts and cannot be null");
            }
            else
            {
        ...
        /// </summary>
        /// <value>An unmasked account number to be displayed to the customer</value>
