...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class AdhocAccountProxyTransfersPreprocessWithAddPayeeResponse :  IEquatable<AdhocAccountProxyTransfersPreprocessWithAddPayeeResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AdhocAccountProxyTransfersPreprocessWithAddPayeeResponse" /> class.
        /// </summary>
        ...
        /// <param name="forexType">This is an indicator if exchange rate received from host is Counter or Live. This is a reference data field. Please use /v1/utilities/referenceData/{forexType} resource to get valid value of this field with description..</param>
        /// <param name="forexConversionIndicator">This is the indicator if FX rate sent in response is computed on one Unit of Source Currency to Destination currency or one Unit of Destination Currency to Source Currency.This is a reference data field. Please use /v1/utilities/referenceData/{forexConversionIndicator} resource to get valid value of this field with description..</param>
        ...
        /// <param name="transactionLimitRange">This refers if customer&#x27;s daily limit is witin in defined criteria.Valid values are &lt;50K&#x3D;0 , &gt;50K and &lt;300K&#x3D;1 , &gt;300K &#x3D;2.</param>
        public AdhocAccountProxyTransfersPreprocessWithAddPayeeResponse(string controlFlowId = default(string), DebitDetails debitDetails = default(DebitDetails), CreditDetails creditDetails = default(CreditDetails), double? foreignExchangeRate = default(double?), string forexType = default(string), string forexConversionIndicator = default(string), double? transactionFee = default(double?), string feeCurrencyCode = default(string), double? localCurrencyTransactionFee = default(double?), string localCurrencyCode = default(string), string transactionLimitRange = default(string))
        {
            // to ensure "controlFlowId" is required (not null)
            if (controlFlowId == null)
            {
                throw new InvalidDataException("controlFlowId is a required property for AdhocAccountProxyTransfersPreprocessWithAddPayeeResponse and cannot be null");
            }
            else
            {
            ...
            this.TransactionLimitRange = transactionLimitRange;
        }
        ...
        /// <summary>
        /// This is an indicator if exchange rate received from host is Counter or Live. This is a reference data field. Please use /v1/utilities/referenceData/{forexType} resource to get valid value of this field with description.
        /// </summary>
        /// <value>This is an indicator if exchange rate received from host is Counter or Live. This is a reference data field. Please use /v1/utilities/referenceData/{forexType} resource to get valid value of this field with description.</value>
        [DataMember(Name="forexType", EmitDefaultValue=false)]
        public string ForexType { get; set; }

        /// <summary>
        /// This is the indicator if FX rate sent in response is computed on one Unit of Source Currency to Destination currency or one Unit of Destination Currency to Source Currency.This is a reference data field. Please use /v1/utilities/referenceData/{forexConversionIndicator} resource to get valid value of this field with description.
        /// </summary>
        /// <value>This is the indicator if FX rate sent in response is computed on one Unit of Source Currency to Destination currency or one Unit of Destination Currency to Source Currency.This is a reference data field. Please use /v1/utilities/referenceData/{forexConversionIndicator} resource to get valid value of this field with description.</value>
        ...
        /// <summary>
        /// This refers if customer&#x27;s daily limit is witin in defined criteria.Valid values are &lt;50K&#x3D;0 , &gt;50K and &lt;300K&#x3D;1 , &gt;300K &#x3D;2
        /// </summary>
        /// <value>This refers if customer&#x27;s daily limit is witin in defined criteria.Valid values are &lt;50K&#x3D;0 , &gt;50K and &lt;300K&#x3D;1 , &gt;300K &#x3D;2</value>
        [DataMember(Name="transactionLimitRange", EmitDefaultValue=false)]
        public string TransactionLimitRange { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AdhocAccountProxyTransfersPreprocessWithAddPayeeResponse {\n");
            ...
            sb.Append("  TransactionLimitRange: ").Append(TransactionLimitRange).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as AdhocAccountProxyTransfersPreprocessWithAddPayeeResponse);
        }

        /// <summary>
        /// Returns true if AdhocAccountProxyTransfersPreprocessWithAddPayeeResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of AdhocAccountProxyTransfersPreprocessWithAddPayeeResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AdhocAccountProxyTransfersPreprocessWithAddPayeeResponse input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.TransactionLimitRange == input.TransactionLimitRange ||
                    (this.TransactionLimitRange != null &&
                    this.TransactionLimitRange.Equals(input.TransactionLimitRange))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.TransactionLimitRange != null)
                    hashCode = hashCode * 59 + this.TransactionLimitRange.GetHashCode();
                return hashCode;
            }
        }
