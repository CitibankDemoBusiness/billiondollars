...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class StandingInstructions :  IEquatable<StandingInstructions>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="StandingInstructions" /> class.
        /// </summary>
        ...
        /// <param name="payee">The payee name with which this transfer was made with (required).</param>
        /// <param name="paymentType">This defines the type of payment made by customer for which SI needs to be enabled..</param>
        ...
        public StandingInstructions(string transactionReferenceId = default(string), string displayAccountNumber = default(string), string accountId = default(string), string paymentMethod = default(string), string bankSortCode = default(string), double? transactionAmount = default(double?), string payee = default(string), string paymentType = default(string), FutureDatedTransaction futureDatedTransaction = default(FutureDatedTransaction), StandingInstruction standingInstruction = default(StandingInstruction), string remarks = default(string))
        {
            // to ensure "transactionReferenceId" is required (not null)
            if (transactionReferenceId == null)
            {
                throw new InvalidDataException("transactionReferenceId is a required property for StandingInstructions and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("displayAccountNumber is a required property for StandingInstructions and cannot be null");
            }
            else
            {
            ...
            if (accountId == null)
            {
                throw new InvalidDataException("accountId is a required property for StandingInstructions and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("paymentMethod is a required property for StandingInstructions and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("transactionAmount is a required property for StandingInstructions and cannot be null");
            }
            else
            {
            ...
            if (payee == null)
            {
                throw new InvalidDataException("payee is a required property for StandingInstructions and cannot be null");
            }
            else
            {
                this.Payee = payee;
        ...
        /// <summary>
        /// The payee name with which this transfer was made with
        /// </summary>
        /// <value>The payee name with which this transfer was made with</value>
        [DataMember(Name="payee", EmitDefaultValue=false)]
        public string Payee { get; set; }

        /// <summary>
        /// This defines the type of payment made by customer for which SI needs to be enabled.
        /// </summary>
        /// <value>This defines the type of payment made by customer for which SI needs to be enabled.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class StandingInstructions {\n");
        ...
        {
            return this.Equals(input as StandingInstructions);
        }

        /// <summary>
        /// Returns true if StandingInstructions instances are equal
        /// </summary>
        /// <param name="input">Instance of StandingInstructions to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(StandingInstructions input)
        {
            if (input == null)
                return false;
