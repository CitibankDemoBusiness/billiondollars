...
{
    /// <summary>
    /// PreprocessFundTransferRequestPersonalTransfer
    /// </summary>
    [DataContract]
        public partial class PreprocessFundTransferRequestPersonalTransfer :  IEquatable<PreprocessFundTransferRequestPersonalTransfer>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PreprocessFundTransferRequestPersonalTransfer" /> class.
        /// </summary>
        ...
        public PreprocessFundTransferRequestPersonalTransfer(string sourceAccountId = default(string), double? transactionAmount = default(double?), string transferCurrencyIndicator = default(string), string destinationAccountId = default(string), string fxDealReferenceNumber = default(string), string paymentScheduleType = default(string), FutureDatedTransaction futureDatedTransaction = default(FutureDatedTransaction), StandingInstruction standingInstruction = default(StandingInstruction), string remarks = default(string))
        {
            // to ensure "sourceAccountId" is required (not null)
            if (sourceAccountId == null)
            {
                throw new InvalidDataException("sourceAccountId is a required property for PreprocessFundTransferRequestPersonalTransfer and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("transactionAmount is a required property for PreprocessFundTransferRequestPersonalTransfer and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("transferCurrencyIndicator is a required property for PreprocessFundTransferRequestPersonalTransfer and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("destinationAccountId is a required property for PreprocessFundTransferRequestPersonalTransfer and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PreprocessFundTransferRequestPersonalTransfer {\n");
        ...
        {
            return this.Equals(input as PreprocessFundTransferRequestPersonalTransfer);
        }

        /// <summary>
        /// Returns true if PreprocessFundTransferRequestPersonalTransfer instances are equal
        /// </summary>
        /// <param name="input">Instance of PreprocessFundTransferRequestPersonalTransfer to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PreprocessFundTransferRequestPersonalTransfer input)
        {
            if (input == null)
                return false;
