...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class BillPaymentAccountPayeeEligibilityResponse :  IEquatable<BillPaymentAccountPayeeEligibilityResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BillPaymentAccountPayeeEligibilityResponse" /> class.
        /// </summary>
        ...
        public BillPaymentAccountPayeeEligibilityResponse(List<BillPaymentSourceAccounts> sourceAccounts = default(List<BillPaymentSourceAccounts>), List<BillPaymentPayeeSourceAccountCombinations> payeeSourceAccountCombinations = default(List<BillPaymentPayeeSourceAccountCombinations>), string nextStartIndex = default(string))
        {
            // to ensure "sourceAccounts" is required (not null)
            if (sourceAccounts == null)
            {
                throw new InvalidDataException("sourceAccounts is a required property for BillPaymentAccountPayeeEligibilityResponse and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("payeeSourceAccountCombinations is a required property for BillPaymentAccountPayeeEligibilityResponse and cannot be null");
            }
            else
            {
        ...
        public List<BillPaymentSourceAccounts> SourceAccounts { get; set; }

        /// <summary>
        /// Gets or Sets PayeeSourceAccountCombinations
        /// </summary>
        [DataMember(Name="payeeSourceAccountCombinations", EmitDefaultValue=false)]
        public List<BillPaymentPayeeSourceAccountCombinations> PayeeSourceAccountCombinations { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class BillPaymentAccountPayeeEligibilityResponse {\n");
        ...
        {
            return this.Equals(input as BillPaymentAccountPayeeEligibilityResponse);
        }

        /// <summary>
        /// Returns true if BillPaymentAccountPayeeEligibilityResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of BillPaymentAccountPayeeEligibilityResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BillPaymentAccountPayeeEligibilityResponse input)
        {
            if (input == null)
                return false;
