...
{
    /// <summary>
    /// CitiGlobalTransfersPreprocessResponse
    /// </summary>
    [DataContract]
        public partial class CitiGlobalTransfersPreprocessResponse :  IEquatable<CitiGlobalTransfersPreprocessResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CitiGlobalTransfersPreprocessResponse" /> class.
        /// </summary>
        ...
        public CitiGlobalTransfersPreprocessResponse(string controlFlowId = default(string), DebitDetails debitDetails = default(DebitDetails), CreditDetails creditDetails = default(CreditDetails), double? foreignExchangeRate = default(double?), double? transactionFee = default(double?), string feeCurrencyCode = default(string))
        {
            // to ensure "controlFlowId" is required (not null)
            if (controlFlowId == null)
            {
                throw new InvalidDataException("controlFlowId is a required property for CitiGlobalTransfersPreprocessResponse and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CitiGlobalTransfersPreprocessResponse {\n");
        ...
        {
            return this.Equals(input as CitiGlobalTransfersPreprocessResponse);
        }

        /// <summary>
        /// Returns true if CitiGlobalTransfersPreprocessResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of CitiGlobalTransfersPreprocessResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CitiGlobalTransfersPreprocessResponse input)
        {
            if (input == null)
                return false;
