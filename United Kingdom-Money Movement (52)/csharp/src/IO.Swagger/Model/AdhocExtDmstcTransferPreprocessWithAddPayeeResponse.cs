...
{
    /// <summary>
    /// AdhocExtDmstcTransferPreprocessWithAddPayeeResponse
    /// </summary>
    [DataContract]
        public partial class AdhocExtDmstcTransferPreprocessWithAddPayeeResponse :  IEquatable<AdhocExtDmstcTransferPreprocessWithAddPayeeResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AdhocExtDmstcTransferPreprocessWithAddPayeeResponse" /> class.
        /// </summary>
        ...
        public AdhocExtDmstcTransferPreprocessWithAddPayeeResponse(string controlFlowId = default(string), DebitDetails debitDetails = default(DebitDetails), CreditDetails creditDetails = default(CreditDetails), double? foreignExchangeRate = default(double?), string forexType = default(string), string forexConversionIndicator = default(string), double? transactionFee = default(double?), string feeCurrencyCode = default(string), double? localCurrencyTransactionFee = default(double?), string localCurrencyCode = default(string), string paymentPriority = default(string))
        {
            ...
            {
                throw new InvalidDataException("debitDetails is a required property for AdhocExtDmstcTransferPreprocessWithAddPayeeResponse and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("creditDetails is a required property for AdhocExtDmstcTransferPreprocessWithAddPayeeResponse and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AdhocExtDmstcTransferPreprocessWithAddPayeeResponse {\n");
        ...
        {
            return this.Equals(input as AdhocExtDmstcTransferPreprocessWithAddPayeeResponse);
        }

        /// <summary>
        /// Returns true if AdhocExtDmstcTransferPreprocessWithAddPayeeResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of AdhocExtDmstcTransferPreprocessWithAddPayeeResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AdhocExtDmstcTransferPreprocessWithAddPayeeResponse input)
        {
            if (input == null)
                return false;
