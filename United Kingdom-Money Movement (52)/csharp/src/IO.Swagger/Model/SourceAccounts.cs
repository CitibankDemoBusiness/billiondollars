...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class SourceAccounts :  IEquatable<SourceAccounts>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SourceAccounts" /> class.
        /// </summary>
        ...
        public SourceAccounts(string sourceAccountId = default(string), string displaySourceAccountNumber = default(string), string sourceAccountCurrencyCode = default(string), string accountGroup = default(string), double? availableBalance = default(double?), double? nextPaymentAmount = default(double?), string productName = default(string), string accountNickName = default(string))
        {
            ...
            {
                throw new InvalidDataException("displaySourceAccountNumber is a required property for SourceAccounts and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("sourceAccountCurrencyCode is a required property for SourceAccounts and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("accountGroup is a required property for SourceAccounts and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SourceAccounts {\n");
        ...
        {
            return this.Equals(input as SourceAccounts);
        }

        /// <summary>
        /// Returns true if SourceAccounts instances are equal
        /// </summary>
        /// <param name="input">Instance of SourceAccounts to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SourceAccounts input)
        {
            if (input == null)
                return false;
