...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ExternalDomesticDetails :  IEquatable<ExternalDomesticDetails>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ExternalDomesticDetails" /> class.
        /// </summary>
        ...
        public ExternalDomesticDetails(string sourceAccountId = default(string), string transferCurrencyIndicator = default(string), string chargeBearer = default(string), string paymentMethod = default(string), double? transactionAmount = default(double?), string paymentType = default(string), string foreignExchangeReferenceNumber = default(string), string paymentScheduleType = default(string), PayeeAccountDetails payeeAccountDetails = default(PayeeAccountDetails), List<Remarks> remarks = default(List<Remarks>), string transferPurpose = default(string))
        {
            // to ensure "sourceAccountId" is required (not null)
            if (sourceAccountId == null)
            {
                throw new InvalidDataException("sourceAccountId is a required property for ExternalDomesticDetails and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("transferCurrencyIndicator is a required property for ExternalDomesticDetails and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("chargeBearer is a required property for ExternalDomesticDetails and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("paymentMethod is a required property for ExternalDomesticDetails and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("transactionAmount is a required property for ExternalDomesticDetails and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ExternalDomesticDetails {\n");
        ...
        {
            return this.Equals(input as ExternalDomesticDetails);
        }

        /// <summary>
        /// Returns true if ExternalDomesticDetails instances are equal
        /// </summary>
        /// <param name="input">Instance of ExternalDomesticDetails to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ExternalDomesticDetails input)
        {
            if (input == null)
                return false;
