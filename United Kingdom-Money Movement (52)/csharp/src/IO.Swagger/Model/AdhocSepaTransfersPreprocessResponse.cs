...
{
    /// <summary>
    /// AdhocSepaTransfersPreprocessResponse
    /// </summary>
    [DataContract]
        public partial class AdhocSepaTransfersPreprocessResponse :  IEquatable<AdhocSepaTransfersPreprocessResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AdhocSepaTransfersPreprocessResponse" /> class.
        /// </summary>
        ...
        public AdhocSepaTransfersPreprocessResponse(string controlFlowId = default(string), DebitDetails debitDetails = default(DebitDetails), CreditDetails creditDetails = default(CreditDetails), double? foreignExchangeRate = default(double?), double? transactionFee = default(double?), string feeCurrencyCode = default(string))
        {
            // to ensure "controlFlowId" is required (not null)
            if (controlFlowId == null)
            {
                throw new InvalidDataException("controlFlowId is a required property for AdhocSepaTransfersPreprocessResponse and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("foreignExchangeRate is a required property for AdhocSepaTransfersPreprocessResponse and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AdhocSepaTransfersPreprocessResponse {\n");
        ...
        {
            return this.Equals(input as AdhocSepaTransfersPreprocessResponse);
        }

        /// <summary>
        /// Returns true if AdhocSepaTransfersPreprocessResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of AdhocSepaTransfersPreprocessResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AdhocSepaTransfersPreprocessResponse input)
        {
            if (input == null)
                return false;
