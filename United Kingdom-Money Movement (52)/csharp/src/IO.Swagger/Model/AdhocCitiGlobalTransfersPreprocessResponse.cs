...
{
    /// <summary>
    /// AdhocCitiGlobalTransfersPreprocessResponse
    /// </summary>
    [DataContract]
        public partial class AdhocCitiGlobalTransfersPreprocessResponse :  IEquatable<AdhocCitiGlobalTransfersPreprocessResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AdhocCitiGlobalTransfersPreprocessResponse" /> class.
        /// </summary>
        ...
        /// <param name="foreignExchangeRate">The exchange rate that is applicable for the particular transfer. .</param>
        /// <param name="transactionFee">The charges that is being charged by the source bank for doing the transfer..</param>
        /// <param name="feeCurrencyCode">Fee currency code in ISO 4217 Format..</param>
        public AdhocCitiGlobalTransfersPreprocessResponse(string controlFlowId = default(string), DebitDetails debitDetails = default(DebitDetails), CreditDetails creditDetails = default(CreditDetails), double? foreignExchangeRate = default(double?), double? transactionFee = default(double?), string feeCurrencyCode = default(string))
        {
            // to ensure "controlFlowId" is required (not null)
            if (controlFlowId == null)
            {
                throw new InvalidDataException("controlFlowId is a required property for AdhocCitiGlobalTransfersPreprocessResponse and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AdhocCitiGlobalTransfersPreprocessResponse {\n");
        ...
        {
            return this.Equals(input as AdhocCitiGlobalTransfersPreprocessResponse);
        }

        /// <summary>
        /// Returns true if AdhocCitiGlobalTransfersPreprocessResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of AdhocCitiGlobalTransfersPreprocessResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AdhocCitiGlobalTransfersPreprocessResponse input)
        {
            if (input == null)
                return false;
