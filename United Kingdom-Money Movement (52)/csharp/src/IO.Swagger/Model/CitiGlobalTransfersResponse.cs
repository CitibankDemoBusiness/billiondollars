...
{
    /// <summary>
    /// CitiGlobalTransfersResponse
    /// </summary>
    [DataContract]
        public partial class CitiGlobalTransfersResponse :  IEquatable<CitiGlobalTransfersResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CitiGlobalTransfersResponse" /> class.
        /// </summary>
        ...
        public CitiGlobalTransfersResponse(string transactionReferenceId = default(string), SourceAccountDetails sourceAccountDetails = default(SourceAccountDetails))
        {
            // to ensure "transactionReferenceId" is required (not null)
            if (transactionReferenceId == null)
            {
                throw new InvalidDataException("transactionReferenceId is a required property for CitiGlobalTransfersResponse and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("sourceAccountDetails is a required property for CitiGlobalTransfersResponse and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CitiGlobalTransfersResponse {\n");
        ...
        {
            return this.Equals(input as CitiGlobalTransfersResponse);
        }

        /// <summary>
        /// Returns true if CitiGlobalTransfersResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of CitiGlobalTransfersResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CitiGlobalTransfersResponse input)
        {
            if (input == null)
                return false;
