...
{
    /// <summary>
    /// PayeeSourceAccountCombinationsCitiGlobalTransfer
    /// </summary>
    [DataContract]
        public partial class PayeeSourceAccountCombinationsCitiGlobalTransfer :  IEquatable<PayeeSourceAccountCombinationsCitiGlobalTransfer>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PayeeSourceAccountCombinationsCitiGlobalTransfer" /> class.
        /// </summary>
        ...
        public PayeeSourceAccountCombinationsCitiGlobalTransfer(string payeeId = default(string), string displayPayeeAccountNumber = default(string), string payeeAccountCurrencyCode = default(string), string payeeName = default(string), string payeeNickName = default(string), PayeeBankDetailsCitiGlobalTransfer payeeBankDetails = default(PayeeBankDetailsCitiGlobalTransfer), SourceAccountIds sourceAccountIds = default(SourceAccountIds))
        {
            // to ensure "payeeId" is required (not null)
            if (payeeId == null)
            {
                throw new InvalidDataException("payeeId is a required property for PayeeSourceAccountCombinationsCitiGlobalTransfer and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("displayPayeeAccountNumber is a required property for PayeeSourceAccountCombinationsCitiGlobalTransfer and cannot be null");
            }
            else
            {
        ...
        public PayeeBankDetailsCitiGlobalTransfer PayeeBankDetails { get; set; }

        /// <summary>
        /// Gets or Sets SourceAccountIds
        /// </summary>
        [DataMember(Name="sourceAccountIds", EmitDefaultValue=false)]
        public SourceAccountIds SourceAccountIds { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PayeeSourceAccountCombinationsCitiGlobalTransfer {\n");
        ...
        {
            return this.Equals(input as PayeeSourceAccountCombinationsCitiGlobalTransfer);
        }

        /// <summary>
        /// Returns true if PayeeSourceAccountCombinationsCitiGlobalTransfer instances are equal
        /// </summary>
        /// <param name="input">Instance of PayeeSourceAccountCombinationsCitiGlobalTransfer to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PayeeSourceAccountCombinationsCitiGlobalTransfer input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    ...
                    this.SourceAccountIds.Equals(input.SourceAccountIds))
                );
        }
