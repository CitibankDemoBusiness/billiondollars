...
{
    /// <summary>
    /// ExternalDomesticSourceAccounts
    /// </summary>
    [DataContract]
        public partial class ExternalDomesticSourceAccounts :  IEquatable<ExternalDomesticSourceAccounts>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ExternalDomesticSourceAccounts" /> class.
        /// </summary>
        ...
        public ExternalDomesticSourceAccounts(string sourceAccountId = default(string), string displaySourceAccountNumber = default(string), string sourceAccountCurrencyCode = default(string), string accountGroup = default(string), double? availableBalance = default(double?), double? nextPaymentAmount = default(double?), string accountNickName = default(string), string productName = default(string))
        {
            // to ensure "sourceAccountId" is required (not null)
            if (sourceAccountId == null)
            {
                throw new InvalidDataException("sourceAccountId is a required property for ExternalDomesticSourceAccounts and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("displaySourceAccountNumber is a required property for ExternalDomesticSourceAccounts and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("sourceAccountCurrencyCode is a required property for ExternalDomesticSourceAccounts and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("accountGroup is a required property for ExternalDomesticSourceAccounts and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ExternalDomesticSourceAccounts {\n");
        ...
        {
            return this.Equals(input as ExternalDomesticSourceAccounts);
        }

        /// <summary>
        /// Returns true if ExternalDomesticSourceAccounts instances are equal
        /// </summary>
        /// <param name="input">Instance of ExternalDomesticSourceAccounts to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ExternalDomesticSourceAccounts input)
        {
            if (input == null)
                return false;
