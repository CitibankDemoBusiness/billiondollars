# IO.Swagger.Model.AdhocCrossBorderWireTransfersPreprocessResponse
## Properties
...
**TransactionFee** | **double?** | The charges that is being charged by the source bank for doing the transfer. | 
