...
/**
 * ApplicationInquiryCreditCardProduct Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ApplicationInquiryCreditCardProduct implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ApplicationInquiryCreditCardProduct';
...
'balance_transfer_details' => '\Swagger\Client\Model\ApplicationInquiryBalanceTransferDetails[]'    ];
...
'balance_transfer_details' => 'getBalanceTransferDetails'    ];
     ...
     *
     * @param string $billing_address Billing address of applicant. This is a reference data field. Please use /v1/apac/utilities/referenceData/{addressType} resource to get valid value of this field with description. You can use addressType field as the referenceCode parameter to retrieve the values.
     *
     * @return $this
     */
     ...
     *
     * @return \Swagger\Client\Model\ApplicationInquiryBalanceTransferDetails[]
     */
     ...
     *
     * @param \Swagger\Client\Model\ApplicationInquiryBalanceTransferDetails[] $balance_transfer_details balance_transfer_details
     *
     * @return $this
     */
