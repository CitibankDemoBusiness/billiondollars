...
/**
 * CrossSellOffer Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CrossSellOffer implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CrossSellOffer';
...
'required_documents' => 'getRequiredDocuments'    ];
     ...
     *
     * @param string $offer_product_code A unique code that identifies the product
     *
     * @return $this
     */
     ...
     *
     * @param string $offer_product_organisation Card issuing organization name
     *
     * @return $this
     */
