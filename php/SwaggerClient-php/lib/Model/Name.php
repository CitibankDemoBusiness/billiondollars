...
'salute_by' => 'getSaluteBy'    ];
     ...
     * Sets salutation
     *
     * @param string $salutation Salutation. This is a reference data field. Please use /v1/apac/utilities/referenceData/{salutation} resource to get possible value of this field with description. You can use salutation field name as the referenceCode parameter to retrieve the values.
     *
     * @return $this
     */
     ...
     * Sets given_name
     *
     * @param string $given_name Given/first name of the prospect
     *
     * @return $this
     */
     ...
     * Sets surname
     *
     * @param string $surname Surname/last name of the prospect
     *
     * @return $this
     */
     ...
     * Sets alias_name
     *
     * @param string $alias_name Alias name of the prospect
     *
     * @return $this
     */
     ...
     * Sets suffix
     *
     * @param string $suffix Generational qualifier that follow a person given name. It is used to explicitly identify the named individual within the same family.
     *
     * @return $this
     */
