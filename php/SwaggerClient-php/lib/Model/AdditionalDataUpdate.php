...
/**
 * AdditionalDataUpdate Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class AdditionalDataUpdate implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'AdditionalDataUpdate';
...
'otp_authentication_success_flag' => null,
'bureau_data_pre_populate_consent_flag' => null,
...
'otp_authentication_success_flag' => 'setOtpAuthenticationSuccessFlag',
'bureau_data_pre_populate_consent_flag' => 'setBureauDataPrePopulateConsentFlag',
...
'otp_authentication_success_flag' => 'getOtpAuthenticationSuccessFlag',
'bureau_data_pre_populate_consent_flag' => 'getBureauDataPrePopulateConsentFlag',
...
'bureau_session_id_' => 'getBureauSessionId_'    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['otp_authentication_success_flag'] = isset($data['otp_authentication_success_flag']) ? $data['otp_authentication_success_flag'] : null;
        $this->container['bureau_data_pre_populate_consent_flag'] = isset($data['bureau_data_pre_populate_consent_flag']) ? $data['bureau_data_pre_populate_consent_flag'] : null;
    ...
    /**
     * Gets otp_authentication_success_flag
     *
     * @return bool
     */
    public function getOtpAuthenticationSuccessFlag()
    {
        return $this->container['otp_authentication_success_flag'];
    }

    /**
     * Sets otp_authentication_success_flag
     *
     * @param bool $otp_authentication_success_flag Flag to indicate if customer is authenticated successfully
     *
     * @return $this
     */
    public function setOtpAuthenticationSuccessFlag($otp_authentication_success_flag)
    {
        $this->container['otp_authentication_success_flag'] = $otp_authentication_success_flag;

        return $this;
    }

    /**
     * Gets bureau_data_pre_populate_consent_flag
     *
     * @return bool
     */
    public function getBureauDataPrePopulateConsentFlag()
    {
        return $this->container['bureau_data_pre_populate_consent_flag'];
    }

    /**
     * Sets bureau_data_pre_populate_consent_flag
     *
     * @param bool $bureau_data_pre_populate_consent_flag Flag to capture applicant's consent for Bureau Data Prepopulation
     *
     * @return $this
     */
    public function setBureauDataPrePopulateConsentFlag($bureau_data_pre_populate_consent_flag)
    {
        $this->container['bureau_data_pre_populate_consent_flag'] = $bureau_data_pre_populate_consent_flag;
     ...
     *
     * @param string $business_nature Business nature of the applicant. This is a reference data data field. Please use /v1/utilities/referenceData/{businessNature} resource to get valid value of this field with description.
     *
     * @return $this
     */
