...
/**
 * ApplicationStatusInqRequestedProductDecision Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ApplicationStatusInqRequestedProductDecision implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ApplicationStatusInqRequestedProductDecision';
...
'required_documents' => 'getRequiredDocuments'    ];
     ...
     *
     * @param string $organisation_name Card issuing Organisation
     *
     * @return $this
     */
     ...
     *
     * @param string $credit_decision Evaluated Applicant Credit Decision. This is a reference data field. Please use /v1/apac/utilities/referenceData/{creditDecision} resource to get valid value of this field with description.
     *
     * @return $this
     */
