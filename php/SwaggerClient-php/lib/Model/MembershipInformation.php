...
/**
 * MembershipInformation Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class MembershipInformation implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'MembershipInformation';
...
'membership_type' => 'getMembershipType'    ];
     ...
     *
     * @param string $membership_number Applicants 12-digit membership number.
     *
     * @return $this
     */
     ...
     *
     * @param string $membership_type Applicants membership type. This is a reference data field. Please use /v1/apac/utilities/referenceData/{membershipType} resource to get valid value of this field with description.
     *
     * @return $this
     */
