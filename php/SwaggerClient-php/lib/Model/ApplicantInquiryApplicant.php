...
/**
 * ApplicantInquiryApplicant Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ApplicantInquiryApplicant implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ApplicantInquiryApplicant';
...
'name' => '\Swagger\Client\Model\ApplicantInquiryName',
'demographics' => '\Swagger\Client\Model\ApplicantInquiryDemographics',
'address' => '\Swagger\Client\Model\ApplicantInquiryAddress[]',
'email' => '\Swagger\Client\Model\ApplicantInquiryEmail[]',
'phone' => '\Swagger\Client\Model\ApplicantInquiryPhone[]',
'financial_information' => '\Swagger\Client\Model\ApplicantInquiryFinancialInformation',
'employment_details' => '\Swagger\Client\Model\ApplicantInquiryEmploymentDetails[]',
'identification_document_details' => '\Swagger\Client\Model\ApplicantInquiryIdentificationDocumentDetails[]',
'additional_data' => '\Swagger\Client\Model\ApplicantInquiryAdditionalData',
'partner_customer_details' => '\Swagger\Client\Model\ApplicantInquiryPartnerCustomerDetails',
'consent_details' => '\Swagger\Client\Model\ApplicantInquiryConsentDetails[]',
'required_documents' => '\Swagger\Client\Model\ApplicantInquiryRequiredDocuments[]',
'kyc_information' => '\Swagger\Client\Model\ApplicantInquiryKycInformation',
'contact_consent' => '\Swagger\Client\Model\ApplicantInquiryContactConsent'    ];
...
'contact_consent' => 'getContactConsent'    ];
     ...
     * Sets applicant_id
     *
     * @param string $applicant_id Unique ID created for an Applicant. This is retuned back in ApplicantAdd response and the same should be passed here.
     *
     * @return $this
     */
     ...
     * Gets name
     *
     * @return \Swagger\Client\Model\ApplicantInquiryName
     */
     ...
     * Sets name
     *
     * @param \Swagger\Client\Model\ApplicantInquiryName $name name
     *
     * @return $this
     */
     ...
     * Gets demographics
     *
     * @return \Swagger\Client\Model\ApplicantInquiryDemographics
     */
     ...
     * Sets demographics
     *
     * @param \Swagger\Client\Model\ApplicantInquiryDemographics $demographics demographics
     *
     * @return $this
     */
     ...
     * Gets address
     *
     * @return \Swagger\Client\Model\ApplicantInquiryAddress[]
     */
     ...
     * Sets address
     *
     * @param \Swagger\Client\Model\ApplicantInquiryAddress[] $address address
     *
     * @return $this
     */
     ...
     * Gets email
     *
     * @return \Swagger\Client\Model\ApplicantInquiryEmail[]
     */
     ...
     * Sets email
     *
     * @param \Swagger\Client\Model\ApplicantInquiryEmail[] $email email
     *
     * @return $this
     */
     ...
     * Gets phone
     *
     * @return \Swagger\Client\Model\ApplicantInquiryPhone[]
     */
     ...
     * Sets phone
     *
     * @param \Swagger\Client\Model\ApplicantInquiryPhone[] $phone phone
     *
     * @return $this
     */
     ...
     *
     * @return \Swagger\Client\Model\ApplicantInquiryFinancialInformation
     */
     ...
     *
     * @param \Swagger\Client\Model\ApplicantInquiryFinancialInformation $financial_information financial_information
     *
     * @return $this
     */
     ...
     *
     * @return \Swagger\Client\Model\ApplicantInquiryEmploymentDetails[]
     */
     ...
     *
     * @param \Swagger\Client\Model\ApplicantInquiryEmploymentDetails[] $employment_details employment_details
     *
     * @return $this
     */
     ...
     *
     * @return \Swagger\Client\Model\ApplicantInquiryIdentificationDocumentDetails[]
     */
     ...
     *
     * @param \Swagger\Client\Model\ApplicantInquiryIdentificationDocumentDetails[] $identification_document_details identification_document_details
     *
     * @return $this
     */
     ...
     *
     * @return \Swagger\Client\Model\ApplicantInquiryAdditionalData
     */
     ...
     *
     * @param \Swagger\Client\Model\ApplicantInquiryAdditionalData $additional_data additional_data
     *
     * @return $this
     */
     ...
     *
     * @return \Swagger\Client\Model\ApplicantInquiryPartnerCustomerDetails
     */
     ...
     *
     * @param \Swagger\Client\Model\ApplicantInquiryPartnerCustomerDetails $partner_customer_details partner_customer_details
     *
     * @return $this
     */
     ...
     *
     * @return \Swagger\Client\Model\ApplicantInquiryConsentDetails[]
     */
     ...
     *
     * @param \Swagger\Client\Model\ApplicantInquiryConsentDetails[] $consent_details consent_details
     *
     * @return $this
     */
     ...
     *
     * @return \Swagger\Client\Model\ApplicantInquiryRequiredDocuments[]
     */
     ...
     *
     * @param \Swagger\Client\Model\ApplicantInquiryRequiredDocuments[] $required_documents required_documents
     *
     * @return $this
     */
     ...
     *
     * @return \Swagger\Client\Model\ApplicantInquiryKycInformation
     */
     ...
     *
     * @param \Swagger\Client\Model\ApplicantInquiryKycInformation $kyc_information kyc_information
     *
     * @return $this
     */
     ...
     *
     * @return \Swagger\Client\Model\ApplicantInquiryContactConsent
     */
     ...
     *
     * @param \Swagger\Client\Model\ApplicantInquiryContactConsent $contact_consent contact_consent
     *
     * @return $this
     */
