...
/**
 * ApplicationUpdatePhone Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ApplicationUpdatePhone implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ApplicationUpdatePhone';
...
'ok_to_call' => 'getOkToCall'    ];
     ...
     *
     * @param string $phone_country_code Country code of telephone number
     *
     * @return $this
     */
     ...
     * Sets area_code
     *
     * @param string $area_code The area code of telephone number
     *
     * @return $this
     */
     ...
     * Sets phone_number
     *
     * @param string $phone_number The phone number of applicant
     *
     * @return $this
     */
