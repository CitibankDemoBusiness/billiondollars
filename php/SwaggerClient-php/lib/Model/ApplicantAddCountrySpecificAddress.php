...
/**
 * ApplicantAddCountrySpecificAddress Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ApplicantAddCountrySpecificAddress implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ApplicantAddCountrySpecificAddress';
...
'street_type' => 'getStreetType'    ];
     ...
     * Sets street_type
     *
     * @param string $street_type Applicant's street type. This is a reference data field.Please use /v1/apac/utilities/referenceData/{streetType} resource to get valid value of this field with description. You can use streetType field name as the referenceCode parameter to retrieve the values
     *
     * @return $this
     */
