...
/**
 * ApplicantUpdatePhone Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ApplicantUpdatePhone implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ApplicantUpdatePhone';
...
'ok_to_call' => 'getOkToCall'    ];
     ...
     * Sets phone_type
     *
     * @param string $phone_type The type of phone.This is a reference data field. Please use /v1/apac/utilities/referenceData/{phoneType} resource to get valid value of this field with description. You can use phoneType field name as the referenceCode parameter to retrieve the values.
     *
     * @return $this
     */
     ...
     * Sets extension
     *
     * @param string $extension Extension of phone number
     *
     * @return $this
     */
