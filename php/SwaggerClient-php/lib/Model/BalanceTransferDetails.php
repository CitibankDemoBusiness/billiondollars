...
/**
 * BalanceTransferDetails Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class BalanceTransferDetails implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'BalanceTransferDetails';
...
'bsb_code' => 'getBsbCode'    ];
     ...
     *
     * @param string $issuing_organization_name Name of the Organization to which the fund has to be transferred. This is a reference data field. Please use /v1/utilities/referenceData/{cardIssuingOrganization} resource to get valid value of this field with description.
     *
     * @return $this
     */
     ...
     * Sets payment_type
     *
     * @param string $payment_type Mode of payment.This is a reference data field. Please use /v1/apac/utilities/referenceData/{paymentType} resource to get valid value of this field with description. You can use paymentType field name as the referenceCode parameter to retrieve the values.
     *
     * @return $this
     */
     ...
     * Sets bsb_code
     *
     * @param string $bsb_code BSB Code for EFT payment mode.
     *
     * @return $this
     */
