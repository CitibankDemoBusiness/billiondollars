...
Gem::Specification.new do |s|
  ...
  s.summary     = "TaxStatement_Digital_Orchestation Ruby Gem"
  s.description = "Account Documents APIs Version 2.0. These APIs will be used by Citi Partners to retrieve tax documents for existing Accounts from various regions. PCF Deployment Reference name --> DM-O-DocumentServices-Statements  </br>Version 2.0.0 Added new Tax statements apis."
  s.license     = "Unlicense"
