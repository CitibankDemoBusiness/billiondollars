...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ApplicantUpdatePhone :  IEquatable<ApplicantUpdatePhone>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ApplicantUpdatePhone" /> class.
        /// </summary>
        ...
        public ApplicantUpdatePhone(string phoneType = default(string), string phoneCountryCode = default(string), string areaCode = default(string), string phoneNumber = default(string), string extension = default(string), bool? okToSms = default(bool?), bool? okToCall = default(bool?))
        {
            // to ensure "phoneType" is required (not null)
            if (phoneType == null)
            {
                throw new InvalidDataException("phoneType is a required property for ApplicantUpdatePhone and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("phoneCountryCode is a required property for ApplicantUpdatePhone and cannot be null");
            }
            else
            {
            ...
            if (phoneNumber == null)
            {
                throw new InvalidDataException("phoneNumber is a required property for ApplicantUpdatePhone and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ApplicantUpdatePhone {\n");
        ...
        {
            return this.Equals(input as ApplicantUpdatePhone);
        }

        /// <summary>
        /// Returns true if ApplicantUpdatePhone instances are equal
        /// </summary>
        /// <param name="input">Instance of ApplicantUpdatePhone to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApplicantUpdatePhone input)
        {
            if (input == null)
                return false;
