...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ApplicantAddIncomeDetails :  IEquatable<ApplicantAddIncomeDetails>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ApplicantAddIncomeDetails" /> class.
        /// </summary>
        ...
        public ApplicantAddIncomeDetails(string incomeType = default(string), double? fixedAmount = default(double?), double? variableAmount = default(double?), string frequency = default(string))
        {
        ...
        {
            return this.Equals(input as ApplicantAddIncomeDetails);
        }

        /// <summary>
        /// Returns true if ApplicantAddIncomeDetails instances are equal
        /// </summary>
        /// <param name="input">Instance of ApplicantAddIncomeDetails to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApplicantAddIncomeDetails input)
        {
            if (input == null)
                return false;
