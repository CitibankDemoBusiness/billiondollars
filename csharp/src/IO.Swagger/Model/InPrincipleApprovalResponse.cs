...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class InPrincipleApprovalResponse :  IEquatable<InPrincipleApprovalResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InPrincipleApprovalResponse" /> class.
        /// </summary>
        ...
        public InPrincipleApprovalResponse(string applicationStage = default(string), DateTime? ipaExpiryDate = default(DateTime?), List<RequestedProductDecision> requestedProductDecision = default(List<RequestedProductDecision>), List<CounterOffer> counterOffers = default(List<CounterOffer>), List<CrossSellOffer> crossSellOffers = default(List<CrossSellOffer>))
        {
            // to ensure "applicationStage" is required (not null)
            if (applicationStage == null)
            {
                throw new InvalidDataException("applicationStage is a required property for InPrincipleApprovalResponse and cannot be null");
            }
            else
            {
        ...
        public List<RequestedProductDecision> RequestedProductDecision { get; set; }
        ...
        {
            return this.Equals(input as InPrincipleApprovalResponse);
        }

        /// <summary>
        /// Returns true if InPrincipleApprovalResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of InPrincipleApprovalResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InPrincipleApprovalResponse input)
        {
            if (input == null)
                return false;
