...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ApplicationAddFinancialInformation :  IEquatable<ApplicationAddFinancialInformation>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ApplicationAddFinancialInformation" /> class.
        /// </summary>
        ...
        public ApplicationAddFinancialInformation(bool? hasForeseeableFinancialChanges = default(bool?), bool? nonBankDebtObligationFlag = default(bool?), List<ApplicationAddExpenseDetails> expenseDetails = default(List<ApplicationAddExpenseDetails>), List<ApplicationAddIncomeDetails> incomeDetails = default(List<ApplicationAddIncomeDetails>), List<ApplicationAddExistingLoanDetails> existingLoanDetails = default(List<ApplicationAddExistingLoanDetails>))
        {
        ...
        public List<ApplicationAddExpenseDetails> ExpenseDetails { get; set; }

        /// <summary>
        /// Gets or Sets IncomeDetails
        /// </summary>
        [DataMember(Name="incomeDetails", EmitDefaultValue=false)]
        public List<ApplicationAddIncomeDetails> IncomeDetails { get; set; }

        /// <summary>
        /// Gets or Sets ExistingLoanDetails
        /// </summary>
        [DataMember(Name="existingLoanDetails", EmitDefaultValue=false)]
        public List<ApplicationAddExistingLoanDetails> ExistingLoanDetails { get; set; }
        ...
        {
            return this.Equals(input as ApplicationAddFinancialInformation);
        }

        /// <summary>
        /// Returns true if ApplicationAddFinancialInformation instances are equal
        /// </summary>
        /// <param name="input">Instance of ApplicationAddFinancialInformation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApplicationAddFinancialInformation input)
        {
            if (input == null)
                return false;
