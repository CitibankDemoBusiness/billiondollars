...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ApplicantAddAddress :  IEquatable<ApplicantAddAddress>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ApplicantAddAddress" /> class.
        /// </summary>
        ...
        public ApplicantAddAddress(string addressType = default(string), string addressLine1 = default(string), string addressLine2 = default(string), string addressLine3 = default(string), string addressLine4 = default(string), string cityName = default(string), string state = default(string), string postalCode = default(string), string countryCode = default(string), int? residenceDurationInYears = default(int?), int? residenceDurationInMonths = default(int?), ApplicantAddCountrySpecificAddress countrySpecificAddress = default(ApplicantAddCountrySpecificAddress))
        {
        ...
        public ApplicantAddCountrySpecificAddress CountrySpecificAddress { get; set; }
        ...
        {
            return this.Equals(input as ApplicantAddAddress);
        }

        /// <summary>
        /// Returns true if ApplicantAddAddress instances are equal
        /// </summary>
        /// <param name="input">Instance of ApplicantAddAddress to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApplicantAddAddress input)
        {
            if (input == null)
                return false;
