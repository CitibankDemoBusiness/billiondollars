...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ApplicantInquiryPhone :  IEquatable<ApplicantInquiryPhone>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ApplicantInquiryPhone" /> class.
        /// </summary>
        ...
        public ApplicantInquiryPhone(string phoneType = default(string), string phoneCountryCode = default(string), string areaCode = default(string), string phoneNumber = default(string), string extension = default(string), bool? okToSms = default(bool?), bool? okToCall = default(bool?))
        {
            // to ensure "phoneType" is required (not null)
            if (phoneType == null)
            {
                throw new InvalidDataException("phoneType is a required property for ApplicantInquiryPhone and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("phoneCountryCode is a required property for ApplicantInquiryPhone and cannot be null");
            }
            else
            {
            ...
            if (phoneNumber == null)
            {
                throw new InvalidDataException("phoneNumber is a required property for ApplicantInquiryPhone and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as ApplicantInquiryPhone);
        }

        /// <summary>
        /// Returns true if ApplicantInquiryPhone instances are equal
        /// </summary>
        /// <param name="input">Instance of ApplicantInquiryPhone to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApplicantInquiryPhone input)
        {
            if (input == null)
                return false;
