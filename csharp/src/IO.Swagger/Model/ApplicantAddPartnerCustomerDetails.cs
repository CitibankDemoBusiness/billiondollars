...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ApplicantAddPartnerCustomerDetails :  IEquatable<ApplicantAddPartnerCustomerDetails>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ApplicantAddPartnerCustomerDetails" /> class.
        /// </summary>
        ...
        public ApplicantAddPartnerCustomerDetails(string partnerCustomerInternalId = default(string), string partnerCustomerId = default(string), string partnerCustomerSegment = default(string))
        {
        ...
        {
            return this.Equals(input as ApplicantAddPartnerCustomerDetails);
        }

        /// <summary>
        /// Returns true if ApplicantAddPartnerCustomerDetails instances are equal
        /// </summary>
        /// <param name="input">Instance of ApplicantAddPartnerCustomerDetails to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApplicantAddPartnerCustomerDetails input)
        {
            if (input == null)
                return false;
