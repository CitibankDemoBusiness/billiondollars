...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ApplicationStageResponse :  IEquatable<ApplicationStageResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ApplicationStageResponse" /> class.
        /// </summary>
        ...
        public ApplicationStageResponse(string applicationStage = default(string), DateTime? ipaExpiryDate = default(DateTime?))
        {
            // to ensure "applicationStage" is required (not null)
            if (applicationStage == null)
            {
                throw new InvalidDataException("applicationStage is a required property for ApplicationStageResponse and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as ApplicationStageResponse);
        }

        /// <summary>
        /// Returns true if ApplicationStageResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of ApplicationStageResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApplicationStageResponse input)
        {
            if (input == null)
                return false;
