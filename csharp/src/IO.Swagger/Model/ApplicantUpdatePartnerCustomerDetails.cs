...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ApplicantUpdatePartnerCustomerDetails :  IEquatable<ApplicantUpdatePartnerCustomerDetails>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ApplicantUpdatePartnerCustomerDetails" /> class.
        /// </summary>
        ...
        public ApplicantUpdatePartnerCustomerDetails(string partnerCustomerInternalId = default(string), string partnerCustomerId = default(string), string partnerCustomerSegment = default(string))
        {
        ...
        {
            return this.Equals(input as ApplicantUpdatePartnerCustomerDetails);
        }

        /// <summary>
        /// Returns true if ApplicantUpdatePartnerCustomerDetails instances are equal
        /// </summary>
        /// <param name="input">Instance of ApplicantUpdatePartnerCustomerDetails to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApplicantUpdatePartnerCustomerDetails input)
        {
            if (input == null)
                return false;
