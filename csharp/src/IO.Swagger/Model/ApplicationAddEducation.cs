...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ApplicationAddEducation :  IEquatable<ApplicationAddEducation>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ApplicationAddEducation" /> class.
        /// </summary>
        ...
        public ApplicationAddEducation(string highestEducationLevel = default(string), string yearOfGraduation = default(string), string studentId = default(string), string university = default(string))
        {
        ...
        {
            return this.Equals(input as ApplicationAddEducation);
        }

        /// <summary>
        /// Returns true if ApplicationAddEducation instances are equal
        /// </summary>
        /// <param name="input">Instance of ApplicationAddEducation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApplicationAddEducation input)
        {
            if (input == null)
                return false;
