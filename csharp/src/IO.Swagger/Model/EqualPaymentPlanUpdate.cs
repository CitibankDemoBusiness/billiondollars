...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class EqualPaymentPlanUpdate :  IEquatable<EqualPaymentPlanUpdate>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EqualPaymentPlanUpdate" /> class.
        /// </summary>
        ...
        /// <param name="disbursementType">DisbursementType . This is a reference data field. Please use /v1/utilities/referenceData/{DisbursementOptionGCG} resource to get valid value of this field with description..</param>
        /// <param name="accountNumber">Account number or reference to which the amount will be disbursed.</param>
        public EqualPaymentPlanUpdate(string tenor = default(string), string bankCode = default(string), double? amountToTransfer = default(double?), string accountName = default(string), string campaignCode = default(string), string disbursementType = default(string), string accountNumber = default(string))
        {
            this.Tenor = tenor;
        ...
        /// </summary>
        /// <value>DisbursementType . This is a reference data field. Please use /v1/utilities/referenceData/{DisbursementOptionGCG} resource to get valid value of this field with description.</value>
        ...
        /// </summary>
        /// <value>Account number or reference to which the amount will be disbursed</value>
        ...
        {
            return this.Equals(input as EqualPaymentPlanUpdate);
        }

        /// <summary>
        /// Returns true if EqualPaymentPlanUpdate instances are equal
        /// </summary>
        /// <param name="input">Instance of EqualPaymentPlanUpdate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EqualPaymentPlanUpdate input)
        {
            if (input == null)
                return false;
