...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ApplicationUpdateCreditCardProduct :  IEquatable<ApplicationUpdateCreditCardProduct>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ApplicationUpdateCreditCardProduct" /> class.
        /// </summary>
        ...
        /// <param name="billingAddress">Billing address of applicant. This is a reference data data field. Please use /v1/apac/utilities/referenceData/{addressType} resource to get valid value of this field with description. You can use addressType field name as the referenceCode parameter to retrieve the values..</param>
        ...
        public ApplicationUpdateCreditCardProduct(string productCode = default(string), string sourceCode = default(string), string organization = default(string), string logo = default(string), bool? requestCreditShield = default(bool?), string embossName = default(string), string billingAddress = default(string), string cardDeliveryAddress = default(string), string pinDeliveryAddress = default(string), string giftCode = default(string), bool? creditLimitIncreaseIndicator = default(bool?), List<ApplicationUpdateBalanceTransferDetails> balanceTransferDetails = default(List<ApplicationUpdateBalanceTransferDetails>))
        {
        ...
        /// </summary>
        /// <value>Billing address of applicant. This is a reference data data field. Please use /v1/apac/utilities/referenceData/{addressType} resource to get valid value of this field with description. You can use addressType field name as the referenceCode parameter to retrieve the values.</value>
        ...
        /// </summary>
        /// <value>Card delivery address of applicant. This is a reference data data field. Please use /v1/apac/utilities/referenceData/{addressType} resource to get valid value of this field with description. You can use addressType field name as the referenceCode parameter to retrieve the values.</value>
        ...
        /// </summary>
        /// <value>Delivery address  for card pin of applicant. This is a reference data data field. Please use /v1/apac/utilities/referenceData/{addressType} resource to get valid value of this field with description. You can use addressType field name as the referenceCode parameter to retrieve the values.</value>
        ...
        public List<ApplicationUpdateBalanceTransferDetails> BalanceTransferDetails { get; set; }
        ...
        {
            return this.Equals(input as ApplicationUpdateCreditCardProduct);
        }

        /// <summary>
        /// Returns true if ApplicationUpdateCreditCardProduct instances are equal
        /// </summary>
        /// <param name="input">Instance of ApplicationUpdateCreditCardProduct to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApplicationUpdateCreditCardProduct input)
        {
            if (input == null)
                return false;
