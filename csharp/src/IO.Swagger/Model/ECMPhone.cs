...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ECMPhone :  IEquatable<ECMPhone>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ECMPhone" /> class.
        /// </summary>
        ...
        /// <param name="phoneNumber">Applicants phone number (required).</param>
        /// <param name="areaCode">The area code of phone number.</param>
        /// <param name="extension">Extension of telephone number.</param>
        public ECMPhone(string phoneType = default(string), string phoneCountryCode = default(string), string phoneNumber = default(string), string areaCode = default(string), string extension = default(string))
        {
            // to ensure "phoneType" is required (not null)
            if (phoneType == null)
            {
                throw new InvalidDataException("phoneType is a required property for ECMPhone and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("phoneCountryCode is a required property for ECMPhone and cannot be null");
            }
            else
            {
            ...
            if (phoneNumber == null)
            {
                throw new InvalidDataException("phoneNumber is a required property for ECMPhone and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as ECMPhone);
        }

        /// <summary>
        /// Returns true if ECMPhone instances are equal
        /// </summary>
        /// <param name="input">Instance of ECMPhone to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ECMPhone input)
        {
            if (input == null)
                return false;
