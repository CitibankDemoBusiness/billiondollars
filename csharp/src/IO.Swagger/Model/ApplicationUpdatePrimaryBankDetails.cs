...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ApplicationUpdatePrimaryBankDetails :  IEquatable<ApplicationUpdatePrimaryBankDetails>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ApplicationUpdatePrimaryBankDetails" /> class.
        /// </summary>
        ...
        public ApplicationUpdatePrimaryBankDetails(string bankName = default(string), string accountType = default(string))
        {
        ...
        {
            return this.Equals(input as ApplicationUpdatePrimaryBankDetails);
        }

        /// <summary>
        /// Returns true if ApplicationUpdatePrimaryBankDetails instances are equal
        /// </summary>
        /// <param name="input">Instance of ApplicationUpdatePrimaryBankDetails to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApplicationUpdatePrimaryBankDetails input)
        {
            if (input == null)
                return false;
