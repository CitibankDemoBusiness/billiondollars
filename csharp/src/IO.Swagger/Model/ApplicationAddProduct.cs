...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ApplicationAddProduct :  IEquatable<ApplicationAddProduct>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ApplicationAddProduct" /> class.
        /// </summary>
        ...
        public ApplicationAddProduct(ApplicationAddCreditCardProduct creditCardProduct = default(ApplicationAddCreditCardProduct), ApplicationAddReadyCreditProduct readyCreditProduct = default(ApplicationAddReadyCreditProduct), ApplicationAddUnsecuredLoanProduct unsecuredLoanProduct = default(ApplicationAddUnsecuredLoanProduct))
        {
        ...
        public ApplicationAddCreditCardProduct CreditCardProduct { get; set; }

        /// <summary>
        /// Gets or Sets ReadyCreditProduct
        /// </summary>
        [DataMember(Name="readyCreditProduct", EmitDefaultValue=false)]
        public ApplicationAddReadyCreditProduct ReadyCreditProduct { get; set; }

        /// <summary>
        /// Gets or Sets UnsecuredLoanProduct
        /// </summary>
        [DataMember(Name="unsecuredLoanProduct", EmitDefaultValue=false)]
        public ApplicationAddUnsecuredLoanProduct UnsecuredLoanProduct { get; set; }
        ...
        {
            return this.Equals(input as ApplicationAddProduct);
        }

        /// <summary>
        /// Returns true if ApplicationAddProduct instances are equal
        /// </summary>
        /// <param name="input">Instance of ApplicationAddProduct to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApplicationAddProduct input)
        {
            if (input == null)
                return false;
