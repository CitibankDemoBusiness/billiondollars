...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ApplicationAddContactConsent :  IEquatable<ApplicationAddContactConsent>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ApplicationAddContactConsent" /> class.
        /// </summary>
        ...
        public ApplicationAddContactConsent(bool? okToCall = default(bool?), bool? okToMail = default(bool?), bool? okToSms = default(bool?))
        {
        ...
        {
            return this.Equals(input as ApplicationAddContactConsent);
        }

        /// <summary>
        /// Returns true if ApplicationAddContactConsent instances are equal
        /// </summary>
        /// <param name="input">Instance of ApplicationAddContactConsent to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApplicationAddContactConsent input)
        {
            if (input == null)
                return false;
