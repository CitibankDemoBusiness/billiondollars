...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class KbaSubmissionResponse :  IEquatable<KbaSubmissionResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="KbaSubmissionResponse" /> class.
        /// </summary>
        ...
        public KbaSubmissionResponse(string applicationStage = default(string))
        {
        ...
        {
            return this.Equals(input as KbaSubmissionResponse);
        }

        /// <summary>
        /// Returns true if KbaSubmissionResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of KbaSubmissionResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(KbaSubmissionResponse input)
        {
            if (input == null)
                return false;
