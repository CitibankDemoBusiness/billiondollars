...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ReadyCreditProduct :  IEquatable<ReadyCreditProduct>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ReadyCreditProduct" /> class.
        /// </summary>
        ...
        public ReadyCreditProduct(string productCode = default(string), string sourceCode = default(string), string organization = default(string), string logo = default(string), bool? requestCreditShield = default(bool?), string embossName = default(string), string billingAddress = default(string), string cardDeliveryAddress = default(string), string pinDeliveryAddress = default(string), string giftCode = default(string), bool? creditLimitIncreaseIndicator = default(bool?), bool? atmRequiredFlag = default(bool?), bool? chequeBookRequiredFlag = default(bool?), List<BalanceTransferDetails> balanceTransferDetails = default(List<BalanceTransferDetails>), string loanPurpose = default(string), double? requestedCreditLimit = default(double?), List<EqualPaymentPlan> equalPaymentPlan = default(List<EqualPaymentPlan>), bool? atmPinRegistrationFlag = default(bool?), bool? creditLimitAcceptedFlag = default(bool?))
        {
            ...
            if (sourceCode == null)
            {
                throw new InvalidDataException("sourceCode is a required property for ReadyCreditProduct and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("organization is a required property for ReadyCreditProduct and cannot be null");
            }
            else
            {
            ...
            if (logo == null)
            {
                throw new InvalidDataException("logo is a required property for ReadyCreditProduct and cannot be null");
            }
            else
            {
                this.Logo = logo;
        ...
        {
            return this.Equals(input as ReadyCreditProduct);
        }

        /// <summary>
        /// Returns true if ReadyCreditProduct instances are equal
        /// </summary>
        /// <param name="input">Instance of ReadyCreditProduct to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ReadyCreditProduct input)
        {
            if (input == null)
                return false;
