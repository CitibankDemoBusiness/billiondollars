...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ApplicationAddContactPreference :  IEquatable<ApplicationAddContactPreference>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ApplicationAddContactPreference" /> class.
        /// </summary>
        ...
        public ApplicationAddContactPreference(bool? sendSmsAdviceFlag = default(bool?), bool? sendEmailAdviceFlag = default(bool?), string preferredMailingAddress = default(string), bool? eStatementEnrollmentFlag = default(bool?))
        {
        ...
        {
            return this.Equals(input as ApplicationAddContactPreference);
        }

        /// <summary>
        /// Returns true if ApplicationAddContactPreference instances are equal
        /// </summary>
        /// <param name="input">Instance of ApplicationAddContactPreference to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApplicationAddContactPreference input)
        {
            if (input == null)
                return false;
