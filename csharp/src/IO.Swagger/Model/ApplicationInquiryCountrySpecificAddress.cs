...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ApplicationInquiryCountrySpecificAddress :  IEquatable<ApplicationInquiryCountrySpecificAddress>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ApplicationInquiryCountrySpecificAddress" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as ApplicationInquiryCountrySpecificAddress);
        }

        /// <summary>
        /// Returns true if ApplicationInquiryCountrySpecificAddress instances are equal
        /// </summary>
        /// <param name="input">Instance of ApplicationInquiryCountrySpecificAddress to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApplicationInquiryCountrySpecificAddress input)
        {
            if (input == null)
                return false;
