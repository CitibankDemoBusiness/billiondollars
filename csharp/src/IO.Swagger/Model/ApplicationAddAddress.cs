...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ApplicationAddAddress :  IEquatable<ApplicationAddAddress>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ApplicationAddAddress" /> class.
        /// </summary>
        ...
        public ApplicationAddAddress(string addressType = default(string), string addressLine1 = default(string), string addressLine2 = default(string), string addressLine3 = default(string), string addressLine4 = default(string), string cityName = default(string), string state = default(string), string postalCode = default(string), string provinceCode = default(string), string countryCode = default(string), bool? okToMail = default(bool?), int? residenceDurationInYears = default(int?), int? residenceDurationInMonths = default(int?), ApplicationAddCountrySpecificAddress countrySpecificAddress = default(ApplicationAddCountrySpecificAddress))
        {
        ...
        public ApplicationAddCountrySpecificAddress CountrySpecificAddress { get; set; }
        ...
        {
            return this.Equals(input as ApplicationAddAddress);
        }

        /// <summary>
        /// Returns true if ApplicationAddAddress instances are equal
        /// </summary>
        /// <param name="input">Instance of ApplicationAddAddress to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApplicationAddAddress input)
        {
            if (input == null)
                return false;
