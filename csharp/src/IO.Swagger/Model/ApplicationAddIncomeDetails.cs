...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ApplicationAddIncomeDetails :  IEquatable<ApplicationAddIncomeDetails>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ApplicationAddIncomeDetails" /> class.
        /// </summary>
        ...
        public ApplicationAddIncomeDetails(string incomeType = default(string), double? fixedAmount = default(double?), double? variableAmount = default(double?), string frequency = default(string), string otherIncomeDescription = default(string))
        {
        ...
        {
            return this.Equals(input as ApplicationAddIncomeDetails);
        }

        /// <summary>
        /// Returns true if ApplicationAddIncomeDetails instances are equal
        /// </summary>
        /// <param name="input">Instance of ApplicationAddIncomeDetails to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApplicationAddIncomeDetails input)
        {
            if (input == null)
                return false;
