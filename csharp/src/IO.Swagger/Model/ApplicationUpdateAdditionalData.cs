...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ApplicationUpdateAdditionalData :  IEquatable<ApplicationUpdateAdditionalData>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ApplicationUpdateAdditionalData" /> class.
        /// </summary>
        ...
        /// <param name="creditCardUsagePurpose">Indicates applicants usage of credit card whether it is for personal or business.Please use /v1/apac/utilities/referenceData/{creditCardUsagePurpose} resource to get valid value of this field with description..</param>
        public ApplicationUpdateAdditionalData(decimal? numberOfDependents = default(decimal?), bool? staffIndicator = default(bool?), string businessNature = default(string), string emergencyContactName = default(string), string emergencyContactPhoneNumber = default(string), bool? overLimitConsentFlag = default(bool?), ApplicationUpdateCountrySpecificGroup countrySpecificGroup = default(ApplicationUpdateCountrySpecificGroup), ApplicationUpdatePrimaryBankDetails primaryBankDetails = default(ApplicationUpdatePrimaryBankDetails), string referralGivenName = default(string), string referralSurname = default(string), bool? relatedToCitiEmployeeFlag = default(bool?), string relatedCitiEmployeeName = default(string), string relatedCitiEmployeeDepartment = default(string), string creditCardUsagePurpose = default(string))
        {
        ...
        /// </summary>
        /// <value>Business nature of the applicant. This is a reference data data field. Please use /v1/apac/utilities/referenceData/{businessNature} resource to get valid value of this field with description. You can use businessNature field name as the referenceCode parameter to retrieve the values.</value>
        ...
        public ApplicationUpdateCountrySpecificGroup CountrySpecificGroup { get; set; }

        /// <summary>
        /// Gets or Sets PrimaryBankDetails
        /// </summary>
        [DataMember(Name="primaryBankDetails", EmitDefaultValue=false)]
        public ApplicationUpdatePrimaryBankDetails PrimaryBankDetails { get; set; }
        ...
        /// </summary>
        /// <value>Indicates applicants usage of credit card whether it is for personal or business.Please use /v1/apac/utilities/referenceData/{creditCardUsagePurpose} resource to get valid value of this field with description.</value>
        ...
        {
            return this.Equals(input as ApplicationUpdateAdditionalData);
        }

        /// <summary>
        /// Returns true if ApplicationUpdateAdditionalData instances are equal
        /// </summary>
        /// <param name="input">Instance of ApplicationUpdateAdditionalData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApplicationUpdateAdditionalData input)
        {
            if (input == null)
                return false;
