...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ApplicantUpdateConsentDetails :  IEquatable<ApplicantUpdateConsentDetails>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ApplicantUpdateConsentDetails" /> class.
        /// </summary>
        ...
        public ApplicantUpdateConsentDetails(string consentType = default(string), bool? isConsentGiven = default(bool?))
        {
        ...
        {
            return this.Equals(input as ApplicantUpdateConsentDetails);
        }

        /// <summary>
        /// Returns true if ApplicantUpdateConsentDetails instances are equal
        /// </summary>
        /// <param name="input">Instance of ApplicantUpdateConsentDetails to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApplicantUpdateConsentDetails input)
        {
            if (input == null)
                return false;
