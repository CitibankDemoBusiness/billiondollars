...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class KbaSubmissionRequest :  IEquatable<KbaSubmissionRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="KbaSubmissionRequest" /> class.
        /// </summary>
        /// <param name="questionnaire">questionnaire.</param>
        /// <param name="controlFlowId">Control Flow Id.</param>
        public KbaSubmissionRequest(List<Questionnaire> questionnaire = default(List<Questionnaire>), string controlFlowId = default(string))
        {
        ...
        {
            return this.Equals(input as KbaSubmissionRequest);
        }

        /// <summary>
        /// Returns true if KbaSubmissionRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of KbaSubmissionRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(KbaSubmissionRequest input)
        {
            if (input == null)
                return false;
