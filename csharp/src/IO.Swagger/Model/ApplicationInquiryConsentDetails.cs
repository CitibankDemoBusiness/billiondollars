...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ApplicationInquiryConsentDetails :  IEquatable<ApplicationInquiryConsentDetails>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ApplicationInquiryConsentDetails" /> class.
        /// </summary>
        ...
        public ApplicationInquiryConsentDetails(string consentType = default(string), bool? isConsentGiven = default(bool?))
        {
        ...
        {
            return this.Equals(input as ApplicationInquiryConsentDetails);
        }

        /// <summary>
        /// Returns true if ApplicationInquiryConsentDetails instances are equal
        /// </summary>
        /// <param name="input">Instance of ApplicationInquiryConsentDetails to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApplicationInquiryConsentDetails input)
        {
            if (input == null)
                return false;
