...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class RequiredDocuments :  IEquatable<RequiredDocuments>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RequiredDocuments" /> class.
        /// </summary>
        ...
        /// <param name="documentStatus">Status of document ID proof. This is a reference data data field. Please use /v1/apac/utilities/referenceData/{documentStatus} resource to get valid values of this field with descriptions.</param>
        ...
        /// <param name="linkedDocumentId">Linked document id is used to link different documents for the required documents/proof type..</param>
        /// <param name="applicantType">Applicant relationship with the Bank. Currently supported value is primary.This is a reference data data field. Please use /v1/apac/utilities/referenceData/{applicantType} resource to get valid values of this field with descriptions.</param>
        public RequiredDocuments(string documentIdType = default(string), string documentStatus = default(string), string productCode = default(string), string proofType = default(string), string linkedDocumentId = default(string), string applicantType = default(string))
        {
        ...
        /// </summary>
        /// <value>Status of document ID proof. This is a reference data data field. Please use /v1/apac/utilities/referenceData/{documentStatus} resource to get valid values of this field with descriptions</value>
        ...
        /// </summary>
        /// <value>Linked document id is used to link different documents for the required documents/proof type.</value>
        ...
        /// </summary>
        /// <value>Applicant relationship with the Bank. Currently supported value is primary.This is a reference data data field. Please use /v1/apac/utilities/referenceData/{applicantType} resource to get valid values of this field with descriptions</value>
        ...
        {
            return this.Equals(input as RequiredDocuments);
        }

        /// <summary>
        /// Returns true if RequiredDocuments instances are equal
        /// </summary>
        /// <param name="input">Instance of RequiredDocuments to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RequiredDocuments input)
        {
            if (input == null)
                return false;
