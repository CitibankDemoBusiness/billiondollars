...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ApplicationInquiryUnsecuredLoanProduct :  IEquatable<ApplicationInquiryUnsecuredLoanProduct>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ApplicationInquiryUnsecuredLoanProduct" /> class.
        /// </summary>
        ...
        public ApplicationInquiryUnsecuredLoanProduct(string productCode = default(string), string sourceCode = default(string), string organization = default(string), string logo = default(string), bool? requestCreditShield = default(bool?), string billingAddress = default(string), string giftCode = default(string), double? requestedLoanAmount = default(double?), string tenor = default(string))
        {
            // to ensure "productCode" is required (not null)
            if (productCode == null)
            {
                throw new InvalidDataException("productCode is a required property for ApplicationInquiryUnsecuredLoanProduct and cannot be null");
            }
            else
            {
            ...
            if (sourceCode == null)
            {
                throw new InvalidDataException("sourceCode is a required property for ApplicationInquiryUnsecuredLoanProduct and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("organization is a required property for ApplicationInquiryUnsecuredLoanProduct and cannot be null");
            }
            else
            {
            ...
            if (logo == null)
            {
                throw new InvalidDataException("logo is a required property for ApplicationInquiryUnsecuredLoanProduct and cannot be null");
            }
            else
            {
                this.Logo = logo;
        ...
        {
            return this.Equals(input as ApplicationInquiryUnsecuredLoanProduct);
        }

        /// <summary>
        /// Returns true if ApplicationInquiryUnsecuredLoanProduct instances are equal
        /// </summary>
        /// <param name="input">Instance of ApplicationInquiryUnsecuredLoanProduct to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApplicationInquiryUnsecuredLoanProduct input)
        {
            if (input == null)
                return false;
