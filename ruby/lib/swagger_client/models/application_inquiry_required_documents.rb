...
module SwaggerClient
  class ApplicationInquiryRequiredDocuments
    ...
    attr_accessor :linked_document_id
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `SwaggerClient::ApplicationInquiryRequiredDocuments` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SwaggerClient::ApplicationInquiryRequiredDocuments`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'linked_document_id')
        self.linked_document_id = attributes[:'linked_document_id']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          linked_document_id == o.linked_document_id &&
    ...
    def hash
      [document_id_type, document_status, product_code, proof_type, linked_document_id, applicant_type].hash
    end
