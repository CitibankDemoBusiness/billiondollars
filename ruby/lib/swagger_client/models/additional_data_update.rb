...
module SwaggerClient
  class AdditionalDataUpdate
    ...
    attr_accessor :otp_authentication_success_flag

    # Flag to capture applicant's consent for Bureau Data Prepopulation
    attr_accessor :bureau_data_pre_populate_consent_flag
    ...
    def self.openapi_types
      {
        ...
        :'otp_authentication_success_flag' => :'Object',
        :'bureau_data_pre_populate_consent_flag' => :'Object',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `SwaggerClient::AdditionalDataUpdate` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SwaggerClient::AdditionalDataUpdate`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'otp_authentication_success_flag')
        self.otp_authentication_success_flag = attributes[:'otp_authentication_success_flag']
      end

      if attributes.key?(:'bureau_data_pre_populate_consent_flag')
        self.bureau_data_pre_populate_consent_flag = attributes[:'bureau_data_pre_populate_consent_flag']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          otp_authentication_success_flag == o.otp_authentication_success_flag &&
          bureau_data_pre_populate_consent_flag == o.bureau_data_pre_populate_consent_flag &&
    ...
    def hash
      [account_fund_source, number_of_dependents, staff_indicator, otp_authentication_success_flag, bureau_data_pre_populate_consent_flag, business_nature, emergency_contact_name, emergency_contact_surname, emergency_contact_relationship, emergency_contact_phone_number, over_limit_consent_flag, country_specific_group, primary_bank_details, referral_given_name, referral_surname, introducer_id, related_to_citi_employee_flag, related_citi_employee_name, related_citi_employee_department, credit_card_usage_purpose, cash_pin_flag, media_id, referral_code, referral_tracking, utility_bill_details, fee_code, billing_cycle_day, application_reference_id, customer_segment, printing_serial_number, additional_information, trade_reference_details, bureau_session_id_].hash
    end
