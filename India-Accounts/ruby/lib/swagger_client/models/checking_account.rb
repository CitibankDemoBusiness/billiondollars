...
module SwaggerClient
  class CheckingAccount
    ...
    attr_accessor :available_overdraft_limit
    ...
    def self.openapi_types
      {
        ...
        :'available_overdraft_limit' => :'Object',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `SwaggerClient::CheckingAccount` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SwaggerClient::CheckingAccount`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'available_overdraft_limit')
        self.available_overdraft_limit = attributes[:'available_overdraft_limit']
      end
      ...
      if attributes.key?(:'float_amount')
        self.float_amount = attributes[:'float_amount']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          available_overdraft_limit == o.available_overdraft_limit &&
          currency_code == o.currency_code &&
          last_statement_date == o.last_statement_date &&
          hold_amount == o.hold_amount &&
          float_amount == o.float_amount &&
    ...
    def hash
      [product_name, product_code, display_account_number, current_balance, available_balance, overdraft_limit, available_overdraft_limit, currency_code, last_statement_date, hold_amount, float_amount, total_interest_amount, opening_date].hash
    end
