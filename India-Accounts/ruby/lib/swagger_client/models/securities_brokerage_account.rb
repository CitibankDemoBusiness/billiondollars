...
module SwaggerClient
  class SecuritiesBrokerageAccount
    ...
    attr_accessor :total_securities_value_amount
    ...
    def self.openapi_types
      {
        ...
        :'total_securities_value_amount' => :'Object',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `SwaggerClient::SecuritiesBrokerageAccount` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SwaggerClient::SecuritiesBrokerageAccount`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'total_securities_value_amount')
        self.total_securities_value_amount = attributes[:'total_securities_value_amount']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          total_securities_value_amount == o.total_securities_value_amount &&
    ...
    def hash
      [product_name, product_code, display_account_number, currency_code, total_securities_value_amount, total_transaction_amount, total_unrealized_gains, relationship, security].hash
    end
