...
module SwaggerClient
  class CallDepositAccount
    ...
    attr_accessor :last_interest_payment_date
    ...
    def self.openapi_types
      {
        ...
        :'last_interest_payment_date' => :'Object'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `SwaggerClient::CallDepositAccount` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SwaggerClient::CallDepositAccount`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'last_interest_payment_date')
        self.last_interest_payment_date = attributes[:'last_interest_payment_date']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          last_interest_payment_date == o.last_interest_payment_date
    end
    ...
    def hash
      [product_name, product_code, display_account_number, currency_code, available_balance, current_balance, interest_rate, opening_date, base_currency_maturity_amount, last_interest_payment_amount, last_interest_payment_date].hash
    end
