...
module SwaggerClient
  class ExternalBankDetails
    ...
    attr_accessor :display_destination_account_number
    ...
    def self.openapi_types
      {
        ...
        :'display_destination_account_number' => :'Object'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `SwaggerClient::ExternalBankDetails` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SwaggerClient::ExternalBankDetails`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'display_destination_account_number')
        self.display_destination_account_number = attributes[:'display_destination_account_number']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          display_destination_account_number == o.display_destination_account_number
    end
    ...
    def hash
      [bank_code, destination_account_id, display_destination_account_number].hash
    end
