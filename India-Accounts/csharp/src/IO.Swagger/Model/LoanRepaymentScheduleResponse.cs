...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class LoanRepaymentScheduleResponse :  IEquatable<LoanRepaymentScheduleResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LoanRepaymentScheduleResponse" /> class.
        /// </summary>
        ...
        public LoanRepaymentScheduleResponse(List<AmortizationSched> amortizationSchedule = default(List<AmortizationSched>), string nextStartIndex = default(string))
        {
        ...
        public List<AmortizationSched> AmortizationSchedule { get; set; }
        ...
        {
            return this.Equals(input as LoanRepaymentScheduleResponse);
        }

        /// <summary>
        /// Returns true if LoanRepaymentScheduleResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of LoanRepaymentScheduleResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LoanRepaymentScheduleResponse input)
        {
            if (input == null)
                return false;
