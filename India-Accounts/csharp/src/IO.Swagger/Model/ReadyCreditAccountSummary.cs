...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ReadyCreditAccountSummary :  IEquatable<ReadyCreditAccountSummary>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ReadyCreditAccountSummary" /> class.
        /// </summary>
        ...
        /// <param name="availableCredit">Available Credit for the ready credit account. It is the amount that is available to be charged to a ready credit account.</param>
        ...
        public ReadyCreditAccountSummary(string productName = default(string), string productCode = default(string), string accountNickname = default(string), string displayAccountNumber = default(string), string accountId = default(string), string currencyCode = default(string), string accountStatus = default(string), string accountClassification = default(string), double? outstandingBalance = default(double?), double? availableCredit = default(double?), double? nextPaymentAmount = default(double?), DateTime? nextPaymentDate = default(DateTime?))
        {
        ...
        /// </summary>
        /// <value>Available Credit for the ready credit account. It is the amount that is available to be charged to a ready credit account</value>
        ...
        {
            return this.Equals(input as ReadyCreditAccountSummary);
        }

        /// <summary>
        /// Returns true if ReadyCreditAccountSummary instances are equal
        /// </summary>
        /// <param name="input">Instance of ReadyCreditAccountSummary to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ReadyCreditAccountSummary input)
        {
            if (input == null)
                return false;
