...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ReadyCreditAccountBalanceSummary :  IEquatable<ReadyCreditAccountBalanceSummary>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ReadyCreditAccountBalanceSummary" /> class.
        /// </summary>
        ...
        public ReadyCreditAccountBalanceSummary(double? totalDisputedTransactionAmount = default(double?), double? currentOutstandingAmount = default(double?), double? currentAccruedInterest = default(double?), double? paymentDueAmount = default(double?), double? availablePointBalance = default(double?), List<PartialResponseInformation> partialResponseInformation = default(List<PartialResponseInformation>))
        {
            ...
            {
                throw new InvalidDataException("currentAccruedInterest is a required property for ReadyCreditAccountBalanceSummary and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("paymentDueAmount is a required property for ReadyCreditAccountBalanceSummary and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as ReadyCreditAccountBalanceSummary);
        }

        /// <summary>
        /// Returns true if ReadyCreditAccountBalanceSummary instances are equal
        /// </summary>
        /// <param name="input">Instance of ReadyCreditAccountBalanceSummary to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ReadyCreditAccountBalanceSummary input)
        {
            if (input == null)
                return false;
