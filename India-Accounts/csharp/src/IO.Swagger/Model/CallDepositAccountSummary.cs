...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class CallDepositAccountSummary :  IEquatable<CallDepositAccountSummary>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CallDepositAccountSummary" /> class.
        /// </summary>
        ...
        /// <param name="currentBalance">The current balance on the Deposit account. The available balance including any pending or in progress deposits and withdrawals.</param>
        public CallDepositAccountSummary(string productName = default(string), string productCode = default(string), string accountNickname = default(string), string displayAccountNumber = default(string), string accountId = default(string), string currencyCode = default(string), string accountStatus = default(string), string accountClassification = default(string), double? currentBalance = default(double?))
        {
        ...
        /// </summary>
        /// <value>The current balance on the Deposit account. The available balance including any pending or in progress deposits and withdrawals</value>
        ...
        {
            return this.Equals(input as CallDepositAccountSummary);
        }

        /// <summary>
        /// Returns true if CallDepositAccountSummary instances are equal
        /// </summary>
        /// <param name="input">Instance of CallDepositAccountSummary to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CallDepositAccountSummary input)
        {
            if (input == null)
                return false;
