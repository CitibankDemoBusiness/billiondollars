...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class TimeDepositAccountSummary :  IEquatable<TimeDepositAccountSummary>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TimeDepositAccountSummary" /> class.
        /// </summary>
        ...
        /// <param name="currentBalance">The account balance on the time deposit account.</param>
        /// <param name="originalPrincipalAmount">The amount invested.</param>
        /// <param name="maturityDate">The date when the time deposit will mature in ISO8601 date format YYYY-MM-DD.</param>
        public TimeDepositAccountSummary(string productName = default(string), string productCode = default(string), string accountNickname = default(string), string displayAccountNumber = default(string), string accountId = default(string), string currencyCode = default(string), string accountStatus = default(string), string accountClassification = default(string), double? currentBalance = default(double?), double? originalPrincipalAmount = default(double?), DateTime? maturityDate = default(DateTime?))
        {
        ...
        /// </summary>
        /// <value>The account balance on the time deposit account</value>
        ...
        /// The amount invested
        /// </summary>
        /// <value>The amount invested</value>
        ...
        /// </summary>
        /// <value>The date when the time deposit will mature in ISO8601 date format YYYY-MM-DD</value>
        ...
        {
            return this.Equals(input as TimeDepositAccountSummary);
        }

        /// <summary>
        /// Returns true if TimeDepositAccountSummary instances are equal
        /// </summary>
        /// <param name="input">Instance of TimeDepositAccountSummary to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TimeDepositAccountSummary input)
        {
            if (input == null)
                return false;
