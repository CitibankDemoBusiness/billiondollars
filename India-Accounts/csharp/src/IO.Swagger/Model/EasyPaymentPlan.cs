...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class EasyPaymentPlan :  IEquatable<EasyPaymentPlan>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EasyPaymentPlan" /> class.
        /// </summary>
        ...
        public EasyPaymentPlan(string tenor = default(string), double? effectiveInterestRate = default(double?), double? annualPercentageRate = default(double?), double? installmentAmount = default(double?), string oneTimeProcessingFeeIndicator = default(string), double? oneTimeProcessingFeeAmount = default(double?), double? oneTimeProcessingFeePercentage = default(double?), string offerIndicator = default(string))
        {
            ...
            {
                throw new InvalidDataException("offerIndicator is a required property for EasyPaymentPlan and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as EasyPaymentPlan);
        }

        /// <summary>
        /// Returns true if EasyPaymentPlan instances are equal
        /// </summary>
        /// <param name="input">Instance of EasyPaymentPlan to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EasyPaymentPlan input)
        {
            if (input == null)
                return false;
