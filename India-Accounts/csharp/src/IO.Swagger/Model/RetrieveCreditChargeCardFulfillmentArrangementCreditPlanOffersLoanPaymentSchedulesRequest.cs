...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class RetrieveCreditChargeCardFulfillmentArrangementCreditPlanOffersLoanPaymentSchedulesRequest :  IEquatable<RetrieveCreditChargeCardFulfillmentArrangementCreditPlanOffersLoanPaymentSchedulesRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RetrieveCreditChargeCardFulfillmentArrangementCreditPlanOffersLoanPaymentSchedulesRequest" /> class.
        /// </summary>
        ...
        /// <param name="requestSize">Number of records required.</param>
        public RetrieveCreditChargeCardFulfillmentArrangementCreditPlanOffersLoanPaymentSchedulesRequest(string controlFlowId = default(string), string orgCode = default(string), double? loanAmount = default(double?), string promotionId = default(string), string loanTenure = default(string), string startIndex = default(string), int? requestSize = default(int?))
        {
            // to ensure "controlFlowId" is required (not null)
            if (controlFlowId == null)
            {
                throw new InvalidDataException("controlFlowId is a required property for RetrieveCreditChargeCardFulfillmentArrangementCreditPlanOffersLoanPaymentSchedulesRequest and cannot be null");
            }
            else
            {
            ...
            if (orgCode == null)
            {
                throw new InvalidDataException("orgCode is a required property for RetrieveCreditChargeCardFulfillmentArrangementCreditPlanOffersLoanPaymentSchedulesRequest and cannot be null");
            }
            else
            {
            ...
            if (loanAmount == null)
            {
                throw new InvalidDataException("loanAmount is a required property for RetrieveCreditChargeCardFulfillmentArrangementCreditPlanOffersLoanPaymentSchedulesRequest and cannot be null");
            }
            else
            {
            ...
            if (promotionId == null)
            {
                throw new InvalidDataException("promotionId is a required property for RetrieveCreditChargeCardFulfillmentArrangementCreditPlanOffersLoanPaymentSchedulesRequest and cannot be null");
            }
            else
            {
            ...
            if (loanTenure == null)
            {
                throw new InvalidDataException("loanTenure is a required property for RetrieveCreditChargeCardFulfillmentArrangementCreditPlanOffersLoanPaymentSchedulesRequest and cannot be null");
            }
            else
            {
        ...
        /// </summary>
        /// <value>Number of records required</value>
        ...
        {
            return this.Equals(input as RetrieveCreditChargeCardFulfillmentArrangementCreditPlanOffersLoanPaymentSchedulesRequest);
        }

        /// <summary>
        /// Returns true if RetrieveCreditChargeCardFulfillmentArrangementCreditPlanOffersLoanPaymentSchedulesRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of RetrieveCreditChargeCardFulfillmentArrangementCreditPlanOffersLoanPaymentSchedulesRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RetrieveCreditChargeCardFulfillmentArrangementCreditPlanOffersLoanPaymentSchedulesRequest input)
        {
            if (input == null)
                return false;
