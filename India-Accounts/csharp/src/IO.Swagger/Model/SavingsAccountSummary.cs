...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class SavingsAccountSummary :  IEquatable<SavingsAccountSummary>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SavingsAccountSummary" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as SavingsAccountSummary);
        }

        /// <summary>
        /// Returns true if SavingsAccountSummary instances are equal
        /// </summary>
        /// <param name="input">Instance of SavingsAccountSummary to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SavingsAccountSummary input)
        {
            if (input == null)
                return false;
