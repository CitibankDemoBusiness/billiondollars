...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class OriginalDebitAccountDetails :  IEquatable<OriginalDebitAccountDetails>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OriginalDebitAccountDetails" /> class.
        /// </summary>
        ...
        public OriginalDebitAccountDetails(string displayAccountNumber = default(string), string bankName = default(string), string bankCode = default(string))
        {
        ...
        {
            return this.Equals(input as OriginalDebitAccountDetails);
        }

        /// <summary>
        /// Returns true if OriginalDebitAccountDetails instances are equal
        /// </summary>
        /// <param name="input">Instance of OriginalDebitAccountDetails to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OriginalDebitAccountDetails input)
        {
            if (input == null)
                return false;
