...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class LoanBookingPreLoginResponse :  IEquatable<LoanBookingPreLoginResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LoanBookingPreLoginResponse" /> class.
        /// </summary>
        ...
        public LoanBookingPreLoginResponse(string loanReferenceId = default(string), string paymentMethod = default(string))
        {
            // to ensure "loanReferenceId" is required (not null)
            if (loanReferenceId == null)
            {
                throw new InvalidDataException("loanReferenceId is a required property for LoanBookingPreLoginResponse and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as LoanBookingPreLoginResponse);
        }

        /// <summary>
        /// Returns true if LoanBookingPreLoginResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of LoanBookingPreLoginResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LoanBookingPreLoginResponse input)
        {
            if (input == null)
                return false;
