...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class LoanAmortizationSchedule :  IEquatable<LoanAmortizationSchedule>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LoanAmortizationSchedule" /> class.
        /// </summary>
        ...
        /// <param name="outstandingPrincipalAmount">The portion of the Principal Amount not Paid for the loan..</param>
        /// <param name="installmentDate">Installment date in MM/YYYY format.</param>
        public LoanAmortizationSchedule(int? installmentNumber = default(int?), double? installmentAmount = default(double?), double? principalAmount = default(double?), double? installmentInterestAmount = default(double?), double? outstandingPrincipalAmount = default(double?), string installmentDate = default(string))
        {
            // to ensure "installmentNumber" is required (not null)
            if (installmentNumber == null)
            {
                throw new InvalidDataException("installmentNumber is a required property for LoanAmortizationSchedule and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("installmentAmount is a required property for LoanAmortizationSchedule and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("principalAmount is a required property for LoanAmortizationSchedule and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("installmentInterestAmount is a required property for LoanAmortizationSchedule and cannot be null");
            }
            else
            {
        ...
        /// </summary>
        /// <value>The portion of the Principal Amount not Paid for the loan.</value>
        ...
        {
            return this.Equals(input as LoanAmortizationSchedule);
        }

        /// <summary>
        /// Returns true if LoanAmortizationSchedule instances are equal
        /// </summary>
        /// <param name="input">Instance of LoanAmortizationSchedule to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LoanAmortizationSchedule input)
        {
            if (input == null)
                return false;
