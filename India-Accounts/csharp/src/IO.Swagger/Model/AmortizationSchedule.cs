...
namespace IO.Swagger.Model
{
        ...
        public partial class AmortizationSchedule :  IEquatable<AmortizationSchedule>, IValidatableObject
    {
        ...
        public AmortizationSchedule(string installmentNumber = default(string), double? installmentAmount = default(double?), double? principalAmount = default(double?), double? installmentInterestAmount = default(double?), double? outstandingPrincipalAmount = default(double?), string installmentDate = default(string))
        {
