...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class RetrieveCreditChargeCardFulfillmentArrangementCreditPlanConsolidatePreprocessRequest :  IEquatable<RetrieveCreditChargeCardFulfillmentArrangementCreditPlanConsolidatePreprocessRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RetrieveCreditChargeCardFulfillmentArrangementCreditPlanConsolidatePreprocessRequest" /> class.
        /// </summary>
        ...
        /// <param name="disbursementAccountId">Customers Account Number with the Bank.   An account number is the primary identifier for ownership of an account, whether a checking account or savings account or credit card account or investment account, or a loan account..</param>
        ...
        public RetrieveCreditChargeCardFulfillmentArrangementCreditPlanConsolidatePreprocessRequest(List<Loan> loan = default(List<Loan>), double? totalLoanAmount = default(double?), int? loanTenureInmonths = default(int?), double? topUpAmount = default(double?), string loanDescription = default(string), string disbursementOption = default(string), string disbursementAccountId = default(string), string payeeId = default(string), BeneficiaryBankDetail beneficiaryBankDetail = default(BeneficiaryBankDetail), string loanPurpose = default(string))
        {
            // to ensure "totalLoanAmount" is required (not null)
            if (totalLoanAmount == null)
            {
                throw new InvalidDataException("totalLoanAmount is a required property for RetrieveCreditChargeCardFulfillmentArrangementCreditPlanConsolidatePreprocessRequest and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("loanTenureInmonths is a required property for RetrieveCreditChargeCardFulfillmentArrangementCreditPlanConsolidatePreprocessRequest and cannot be null");
            }
            else
            {
            ...
            if (topUpAmount == null)
            {
                throw new InvalidDataException("topUpAmount is a required property for RetrieveCreditChargeCardFulfillmentArrangementCreditPlanConsolidatePreprocessRequest and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("loanDescription is a required property for RetrieveCreditChargeCardFulfillmentArrangementCreditPlanConsolidatePreprocessRequest and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("disbursementOption is a required property for RetrieveCreditChargeCardFulfillmentArrangementCreditPlanConsolidatePreprocessRequest and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as RetrieveCreditChargeCardFulfillmentArrangementCreditPlanConsolidatePreprocessRequest);
        }

        /// <summary>
        /// Returns true if RetrieveCreditChargeCardFulfillmentArrangementCreditPlanConsolidatePreprocessRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of RetrieveCreditChargeCardFulfillmentArrangementCreditPlanConsolidatePreprocessRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RetrieveCreditChargeCardFulfillmentArrangementCreditPlanConsolidatePreprocessRequest input)
        {
            if (input == null)
                return false;
