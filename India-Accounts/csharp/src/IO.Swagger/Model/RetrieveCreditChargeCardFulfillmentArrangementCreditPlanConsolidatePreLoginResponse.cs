...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class RetrieveCreditChargeCardFulfillmentArrangementCreditPlanConsolidatePreLoginResponse :  IEquatable<RetrieveCreditChargeCardFulfillmentArrangementCreditPlanConsolidatePreLoginResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RetrieveCreditChargeCardFulfillmentArrangementCreditPlanConsolidatePreLoginResponse" /> class.
        /// </summary>
        ...
        public RetrieveCreditChargeCardFulfillmentArrangementCreditPlanConsolidatePreLoginResponse(string newLoanReferenceId = default(string), double? nextInstallmentAmount = default(double?), double? nextInstallmentPrincipalAmount = default(double?), double? interestRate = default(double?), double? totalInterestAmount = default(double?), double? initialFeeAmount = default(double?), double? closureInterestAmount = default(double?), double? loanBookingFee = default(double?))
        {
            // to ensure "newLoanReferenceId" is required (not null)
            if (newLoanReferenceId == null)
            {
                throw new InvalidDataException("newLoanReferenceId is a required property for RetrieveCreditChargeCardFulfillmentArrangementCreditPlanConsolidatePreLoginResponse and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as RetrieveCreditChargeCardFulfillmentArrangementCreditPlanConsolidatePreLoginResponse);
        }

        /// <summary>
        /// Returns true if RetrieveCreditChargeCardFulfillmentArrangementCreditPlanConsolidatePreLoginResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of RetrieveCreditChargeCardFulfillmentArrangementCreditPlanConsolidatePreLoginResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RetrieveCreditChargeCardFulfillmentArrangementCreditPlanConsolidatePreLoginResponse input)
        {
            if (input == null)
                return false;
