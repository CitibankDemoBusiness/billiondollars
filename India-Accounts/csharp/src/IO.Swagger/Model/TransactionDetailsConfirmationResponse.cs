...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class TransactionDetailsConfirmationResponse :  IEquatable<TransactionDetailsConfirmationResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TransactionDetailsConfirmationResponse" /> class.
        /// </summary>
        ...
        public TransactionDetailsConfirmationResponse(List<Transaction> transactions = default(List<Transaction>), List<InvestmentTransaction> investmentTransaction = default(List<InvestmentTransaction>), string nextStartIndex = default(string))
        {
        ...
        {
            return this.Equals(input as TransactionDetailsConfirmationResponse);
        }

        /// <summary>
        /// Returns true if TransactionDetailsConfirmationResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of TransactionDetailsConfirmationResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TransactionDetailsConfirmationResponse input)
        {
            if (input == null)
                return false;
