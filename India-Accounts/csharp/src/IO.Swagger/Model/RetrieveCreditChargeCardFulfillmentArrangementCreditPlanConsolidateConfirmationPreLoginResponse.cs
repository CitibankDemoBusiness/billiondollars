...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class RetrieveCreditChargeCardFulfillmentArrangementCreditPlanConsolidateConfirmationPreLoginResponse :  IEquatable<RetrieveCreditChargeCardFulfillmentArrangementCreditPlanConsolidateConfirmationPreLoginResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RetrieveCreditChargeCardFulfillmentArrangementCreditPlanConsolidateConfirmationPreLoginResponse" /> class.
        /// </summary>
        ...
        public RetrieveCreditChargeCardFulfillmentArrangementCreditPlanConsolidateConfirmationPreLoginResponse(string newLoanReferenceId = default(string), double? nextInstallmentAmount = default(double?), double? nextInstallmentPrincipalAmount = default(double?), double? interestRate = default(double?), double? totalInterestAmount = default(double?), double? initialFeeAmount = default(double?), double? closureInterestAmount = default(double?), double? loanBookingFee = default(double?))
        {
            // to ensure "newLoanReferenceId" is required (not null)
            if (newLoanReferenceId == null)
            {
                throw new InvalidDataException("newLoanReferenceId is a required property for RetrieveCreditChargeCardFulfillmentArrangementCreditPlanConsolidateConfirmationPreLoginResponse and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as RetrieveCreditChargeCardFulfillmentArrangementCreditPlanConsolidateConfirmationPreLoginResponse);
        }

        /// <summary>
        /// Returns true if RetrieveCreditChargeCardFulfillmentArrangementCreditPlanConsolidateConfirmationPreLoginResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of RetrieveCreditChargeCardFulfillmentArrangementCreditPlanConsolidateConfirmationPreLoginResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RetrieveCreditChargeCardFulfillmentArrangementCreditPlanConsolidateConfirmationPreLoginResponse input)
        {
            if (input == null)
                return false;
