...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class CheckingAccountSummary :  IEquatable<CheckingAccountSummary>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CheckingAccountSummary" /> class.
        /// </summary>
        ...
        /// <param name="availableBalance">The available balance of the saving account. It is the amount available  to withdraw or transfer immediately.</param>
        public CheckingAccountSummary(string productName = default(string), string productCode = default(string), string accountNickname = default(string), string displayAccountNumber = default(string), string accountId = default(string), string currencyCode = default(string), string accountStatus = default(string), string accountClassification = default(string), double? currentBalance = default(double?), double? availableBalance = default(double?))
        {
        ...
        /// </summary>
        /// <value>The available balance of the saving account. It is the amount available  to withdraw or transfer immediately</value>
        ...
        {
            return this.Equals(input as CheckingAccountSummary);
        }

        /// <summary>
        /// Returns true if CheckingAccountSummary instances are equal
        /// </summary>
        /// <param name="input">Instance of CheckingAccountSummary to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CheckingAccountSummary input)
        {
            if (input == null)
                return false;
