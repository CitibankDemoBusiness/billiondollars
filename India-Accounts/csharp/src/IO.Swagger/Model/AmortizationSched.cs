...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class AmortizationSched :  IEquatable<AmortizationSched>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AmortizationSched" /> class.
        /// </summary>
        /// <param name="installmentNumber">Installment number (required).</param>
        /// <param name="installmentAmount">Installment amount to be paid by customer in order to repay the loan in local currency. (required).</param>
        ...
        public AmortizationSched(string installmentNumber = default(string), double? installmentAmount = default(double?), double? principalAmount = default(double?), double? installmentInterestAmount = default(double?))
        {
            // to ensure "installmentNumber" is required (not null)
            if (installmentNumber == null)
            {
                throw new InvalidDataException("installmentNumber is a required property for AmortizationSched and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("installmentAmount is a required property for AmortizationSched and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("principalAmount is a required property for AmortizationSched and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("installmentInterestAmount is a required property for AmortizationSched and cannot be null");
            }
            else
            {
        ...
        /// </summary>
        /// <value>Installment amount to be paid by customer in order to repay the loan in local currency.</value>
        ...
        {
            return this.Equals(input as AmortizationSched);
        }

        /// <summary>
        /// Returns true if AmortizationSched instances are equal
        /// </summary>
        /// <param name="input">Instance of AmortizationSched to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AmortizationSched input)
        {
            if (input == null)
                return false;
