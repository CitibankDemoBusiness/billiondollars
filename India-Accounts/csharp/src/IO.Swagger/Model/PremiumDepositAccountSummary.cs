...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class PremiumDepositAccountSummary :  IEquatable<PremiumDepositAccountSummary>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PremiumDepositAccountSummary" /> class.
        /// </summary>
        ...
        /// <param name="currentBalance">The current market worth of investment.</param>
        ...
        public PremiumDepositAccountSummary(string productName = default(string), string productCode = default(string), string accountNickname = default(string), string displayAccountNumber = default(string), string accountId = default(string), string currencyCode = default(string), string accountClassification = default(string), string accountStatus = default(string), double? currentBalance = default(double?), double? originalPrincipalAmount = default(double?), DateTime? maturityDate = default(DateTime?))
        {
        ...
        {
            return this.Equals(input as PremiumDepositAccountSummary);
        }

        /// <summary>
        /// Returns true if PremiumDepositAccountSummary instances are equal
        /// </summary>
        /// <param name="input">Instance of PremiumDepositAccountSummary to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PremiumDepositAccountSummary input)
        {
            if (input == null)
                return false;
