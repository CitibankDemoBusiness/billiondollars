...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class SecuritiesBrokerageAccountSummary :  IEquatable<SecuritiesBrokerageAccountSummary>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SecuritiesBrokerageAccountSummary" /> class.
        /// </summary>
        ...
        /// <param name="currentBalance">Total fund value for the Investment brokerage account. It is the current market worth of investment.</param>
        public SecuritiesBrokerageAccountSummary(string productName = default(string), string productCode = default(string), string accountNickname = default(string), string displayAccountNumber = default(string), string accountId = default(string), string currencyCode = default(string), string accountStatus = default(string), string accountClassification = default(string), double? currentBalance = default(double?))
        {
        ...
        /// </summary>
        /// <value>Total fund value for the Investment brokerage account. It is the current market worth of investment</value>
        ...
        {
            return this.Equals(input as SecuritiesBrokerageAccountSummary);
        }

        /// <summary>
        /// Returns true if SecuritiesBrokerageAccountSummary instances are equal
        /// </summary>
        /// <param name="input">Instance of SecuritiesBrokerageAccountSummary to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SecuritiesBrokerageAccountSummary input)
        {
            if (input == null)
                return false;
