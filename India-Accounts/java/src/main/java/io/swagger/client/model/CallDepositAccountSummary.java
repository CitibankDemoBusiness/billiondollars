...
public class CallDepositAccountSummary {
   ...
   * @return productName
  **/
  @Schema(example = "Citi bank Platinum Visa", description = "The name of the product")
  ...
  **/
  @Schema(example = "166171.53", description = "The current balance on the Deposit account. The available balance including any pending or in progress deposits and withdrawals")
