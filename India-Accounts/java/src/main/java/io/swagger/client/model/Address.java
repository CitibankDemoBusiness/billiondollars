...
public class Address {
   ...
   * @return addressType
  **/
  @Schema(example = "MAILING_ADDRESS  ", required = true, description = "Type of the address. This is a reference data field. Please use /utilities/referenceData/{addressType} resource to get valid values of this field with descriptions.")
   ...
   * @return addressLine1
  **/
  @Schema(example = "12", required = true, description = "Address line 1")
  ...
  **/
   ...
   * @return countryCode
  **/
  @Schema(example = "PL", description = "ISO country code. This is a reference data field. Please use /v1/utilities/referenceData/{country} resource to get valid value of this field with description.")
  ...
  @Override
  public int hashCode() {
    return Objects.hash(addressType, addressLine1, addressLine2, addressLine3, addressLine4, cityName, state, postalCode, countryCode);
  }
