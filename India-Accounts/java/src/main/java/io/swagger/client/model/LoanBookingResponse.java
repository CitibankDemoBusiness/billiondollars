...
public class LoanBookingResponse {
  ...
  public LoanBookingResponse loanReferenceId(String loanReferenceId) {
  ...
  **/
  @Schema(example = "BIMI51807310002051", required = true, description = "Reference Id to uniquely identify the loan.")
  ...
  public LoanBookingResponse availableCredit(Double availableCredit) {
  ...
  **/
  @Schema(example = "5750.25", description = "This field is to indicate the available credit limit on the credit card.")
  ...
  public LoanBookingResponse paymentMethod(String paymentMethod) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    LoanBookingResponse loanBookingResponse = (LoanBookingResponse) o;
    return Objects.equals(this.loanReferenceId, loanBookingResponse.loanReferenceId) &&
        Objects.equals(this.availableCredit, loanBookingResponse.availableCredit) &&
        Objects.equals(this.paymentMethod, loanBookingResponse.paymentMethod);
  }

  @Override
  public int hashCode() {
    return Objects.hash(loanReferenceId, availableCredit, paymentMethod);
  }
