...
**current_balance** | **double** | The current balance on the Deposit account. The available balance including any pending or in progress deposits and withdrawals | [optional] 
