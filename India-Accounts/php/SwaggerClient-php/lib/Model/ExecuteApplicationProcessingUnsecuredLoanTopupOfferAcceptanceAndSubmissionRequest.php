...
/**
 * ExecuteApplicationProcessingUnsecuredLoanTopupOfferAcceptanceAndSubmissionRequest Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ExecuteApplicationProcessingUnsecuredLoanTopupOfferAcceptanceAndSubmissionRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ExecuteApplicationProcessingUnsecuredLoanTopupOfferAcceptanceAndSubmissionRequest';
...
'display_account_number' => 'displayAccountNumber'    ];
    ...
    protected static $setters = [
        'loan_topup_amount' => 'setLoanTopupAmount',
'tenor' => 'setTenor',
'display_account_number' => 'setDisplayAccountNumber'    ];
    ...
    protected static $getters = [
        'loan_topup_amount' => 'getLoanTopupAmount',
'tenor' => 'getTenor',
'display_account_number' => 'getDisplayAccountNumber'    ];
    ...
    {
        $this->container['loan_topup_amount'] = isset($data['loan_topup_amount']) ? $data['loan_topup_amount'] : null;
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['loan_topup_amount'] === null) {
            $invalidProperties[] = "'loan_topup_amount' can't be null";
        }
    ...
    /**
     * Gets loan_topup_amount
     *
     * @return double
     */
    public function getLoanTopupAmount()
    {
        return $this->container['loan_topup_amount'];
    }

    /**
     * Sets loan_topup_amount
     *
     * @param double $loan_topup_amount Loan top-up Amount accepted by customer
     *
     * @return $this
     */
    public function setLoanTopupAmount($loan_topup_amount)
    {
        $this->container['loan_topup_amount'] = $loan_topup_amount;
