...
/**
 * InsurancePolicySummary Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class InsurancePolicySummary implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'InsurancePolicySummary';
...
'insurance_sum_assured_amount' => 'double',
'total_premium_paid_amount' => 'double'    ];
...
'display_policy_number' => 'setDisplayPolicyNumber',
'insurance_application_id' => 'setInsuranceApplicationId',
'insurance_sum_assured_amount' => 'setInsuranceSumAssuredAmount',
'total_premium_paid_amount' => 'setTotalPremiumPaidAmount'    ];
...
'display_policy_number' => 'getDisplayPolicyNumber',
'insurance_application_id' => 'getInsuranceApplicationId',
'insurance_sum_assured_amount' => 'getInsuranceSumAssuredAmount',
'total_premium_paid_amount' => 'getTotalPremiumPaidAmount'    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['display_policy_number'] = isset($data['display_policy_number']) ? $data['display_policy_number'] : null;
        $this->container['insurance_application_id'] = isset($data['insurance_application_id']) ? $data['insurance_application_id'] : null;
        $this->container['insurance_sum_assured_amount'] = isset($data['insurance_sum_assured_amount']) ? $data['insurance_sum_assured_amount'] : null;
        $this->container['total_premium_paid_amount'] = isset($data['total_premium_paid_amount']) ? $data['total_premium_paid_amount'] : null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['display_policy_number'] === null) {
            $invalidProperties[] = "'display_policy_number' can't be null";
        }
        if ($this->container['insurance_application_id'] === null) {
            $invalidProperties[] = "'insurance_application_id' can't be null";
        }
    ...
    /**
     * Gets display_policy_number
     *
     * @return string
     */
    public function getDisplayPolicyNumber()
    {
        return $this->container['display_policy_number'];
    }

    /**
     * Sets display_policy_number
     *
     * @param string $display_policy_number A masked policy number that can be displayed to the customer.
     *
     * @return $this
     */
    public function setDisplayPolicyNumber($display_policy_number)
    {
        $this->container['display_policy_number'] = $display_policy_number;
     ...
     *
     * @param string $insurance_application_id Insurance Application Number. This field is used to retrieve insurance policy details
     *
     * @return $this
     */
    ...
    /**
     * Gets insurance_sum_assured_amount
     *
     * @return double
     */
    public function getInsuranceSumAssuredAmount()
    {
        return $this->container['insurance_sum_assured_amount'];
    }

    /**
     * Sets insurance_sum_assured_amount
     *
     * @param double $insurance_sum_assured_amount Sum assured amount of the insurance
     *
     * @return $this
     */
    public function setInsuranceSumAssuredAmount($insurance_sum_assured_amount)
    {
        $this->container['insurance_sum_assured_amount'] = $insurance_sum_assured_amount;

        return $this;
    }

    /**
     * Gets total_premium_paid_amount
     *
     * @return double
     */
    public function getTotalPremiumPaidAmount()
    {
        return $this->container['total_premium_paid_amount'];
    }

    /**
     * Sets total_premium_paid_amount
     *
     * @param double $total_premium_paid_amount Total premium paid for the insurance policy
     *
     * @return $this
     */
    public function setTotalPremiumPaidAmount($total_premium_paid_amount)
    {
        $this->container['total_premium_paid_amount'] = $total_premium_paid_amount;
