...
/**
 * CheckingAccountSummary Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CheckingAccountSummary implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CheckingAccountSummary';
...
'available_balance' => 'getAvailableBalance'    ];
     ...
     *
     * @param double $available_balance The available balance of the saving account. It is the amount available  to withdraw or transfer immediately
     *
     * @return $this
     */
