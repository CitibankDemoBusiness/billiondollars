...
/**
 * CallDepositAccountSummary Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CallDepositAccountSummary implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CallDepositAccountSummary';
...
'current_balance' => 'getCurrentBalance'    ];
     ...
     *
     * @param double $current_balance The current balance on the Deposit account. The available balance including any pending or in progress deposits and withdrawals
     *
     * @return $this
     */
