...
/**
 * AmortizationSched Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class AmortizationSched implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'AmortizationSched';
...
'installment_interest_amount' => 'getInstallmentInterestAmount'    ];
     ...
     *
     * @param double $installment_amount Installment amount to be paid by customer in order to repay the loan in local currency.
     *
     * @return $this
     */
