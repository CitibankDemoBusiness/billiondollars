...
/**
 * RetrieveCreditChargeCardFulfillmentArrangementCreditPlanConsolidatePreprocessRequest Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class RetrieveCreditChargeCardFulfillmentArrangementCreditPlanConsolidatePreprocessRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'RetrieveCreditChargeCardFulfillmentArrangementCreditPlanConsolidatePreprocessRequest';
    ...
    protected static $swaggerTypes = [
        'loan' => '\Swagger\Client\Model\Loan[]',
...
'loan_purpose' => 'getLoanPurpose'    ];
     ...
     * Sets loan
     *
     * @param \Swagger\Client\Model\Loan[] $loan loan
     *
     * @return $this
     */
     ...
     *
     * @param string $disbursement_account_id Customers Account Number with the Bank.   An account number is the primary identifier for ownership of an account, whether a checking account or savings account or credit card account or investment account, or a loan account.
     *
     * @return $this
     */
