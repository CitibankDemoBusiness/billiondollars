...
'relationship_type' => 'getRelationshipType'    ];
     ...
     *
     * @param string $relationship_name The relationship name for a customer
     *
     * @return $this
     */
     ...
     *
     * @param string $relationship_type This is a reference data field. Please use /v1/apac/utilities/referenceData/{relationshipType} resource to get valid value of this field with description. You can use the field name as the referenceCode parameter to retrieve the values.
     *
     * @return $this
     */
