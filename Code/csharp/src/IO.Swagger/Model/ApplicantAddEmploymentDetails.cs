...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ApplicantAddEmploymentDetails :  IEquatable<ApplicantAddEmploymentDetails>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ApplicantAddEmploymentDetails" /> class.
        /// </summary>
        ...
        public ApplicantAddEmploymentDetails(int? employmentDurationInYears = default(int?), int? employmentDurationiInMonths = default(int?), string employerName = default(string), string jobTitle = default(string), string occupationCode = default(string), string employmentStatus = default(string))
        {
        ...
        {
            return this.Equals(input as ApplicantAddEmploymentDetails);
        }

        /// <summary>
        /// Returns true if ApplicantAddEmploymentDetails instances are equal
        /// </summary>
        /// <param name="input">Instance of ApplicantAddEmploymentDetails to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApplicantAddEmploymentDetails input)
        {
            if (input == null)
                return false;
