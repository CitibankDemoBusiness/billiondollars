...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ApplicationUpdateBalanceTransferDetails :  IEquatable<ApplicationUpdateBalanceTransferDetails>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ApplicationUpdateBalanceTransferDetails" /> class.
        /// </summary>
        ...
        public ApplicationUpdateBalanceTransferDetails(double? amountToTransfer = default(double?), string issuingOrganizationName = default(string), string accountName = default(string), string accountReferenceNumber = default(string), string billerCode = default(string), string campaignId = default(string))
        {
            // to ensure "amountToTransfer" is required (not null)
            if (amountToTransfer == null)
            {
                throw new InvalidDataException("amountToTransfer is a required property for ApplicationUpdateBalanceTransferDetails and cannot be null");
            }
            else
            {
            ...
            if (billerCode == null)
            {
                throw new InvalidDataException("billerCode is a required property for ApplicationUpdateBalanceTransferDetails and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as ApplicationUpdateBalanceTransferDetails);
        }

        /// <summary>
        /// Returns true if ApplicationUpdateBalanceTransferDetails instances are equal
        /// </summary>
        /// <param name="input">Instance of ApplicationUpdateBalanceTransferDetails to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApplicationUpdateBalanceTransferDetails input)
        {
            if (input == null)
                return false;
