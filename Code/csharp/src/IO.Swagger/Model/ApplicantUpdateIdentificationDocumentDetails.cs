...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ApplicantUpdateIdentificationDocumentDetails :  IEquatable<ApplicantUpdateIdentificationDocumentDetails>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ApplicantUpdateIdentificationDocumentDetails" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as ApplicantUpdateIdentificationDocumentDetails);
        }

        /// <summary>
        /// Returns true if ApplicantUpdateIdentificationDocumentDetails instances are equal
        /// </summary>
        /// <param name="input">Instance of ApplicantUpdateIdentificationDocumentDetails to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApplicantUpdateIdentificationDocumentDetails input)
        {
            if (input == null)
                return false;
