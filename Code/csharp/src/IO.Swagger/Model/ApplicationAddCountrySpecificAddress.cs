...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ApplicationAddCountrySpecificAddress :  IEquatable<ApplicationAddCountrySpecificAddress>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ApplicationAddCountrySpecificAddress" /> class.
        /// </summary>
        ...
        public ApplicationAddCountrySpecificAddress(string unitNumber = default(string), string floorNumber = default(string), string blockNumber = default(string), string buildingName = default(string), string estateName = default(string), string streetNumber = default(string), string streetName = default(string), string streetType = default(string), string town = default(string))
        {
        ...
        {
            return this.Equals(input as ApplicationAddCountrySpecificAddress);
        }

        /// <summary>
        /// Returns true if ApplicationAddCountrySpecificAddress instances are equal
        /// </summary>
        /// <param name="input">Instance of ApplicationAddCountrySpecificAddress to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApplicationAddCountrySpecificAddress input)
        {
            if (input == null)
                return false;
