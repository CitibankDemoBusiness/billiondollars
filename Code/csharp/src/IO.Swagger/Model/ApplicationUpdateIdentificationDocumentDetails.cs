...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ApplicationUpdateIdentificationDocumentDetails :  IEquatable<ApplicationUpdateIdentificationDocumentDetails>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ApplicationUpdateIdentificationDocumentDetails" /> class.
        /// </summary>
        /// <param name="idType">Type of Identification document. This is a reference data data field. Please use /v1/apac/utilities/referenceData/{idType} resource to get valid values of this field with descriptions.</param>
        ...
        /// <param name="idIssueCountry">Country of issuance. This is a reference data data field. Please use /v1/apac/utilities/referenceData/{country} resource to get valid value of this field with description. You can use idIssueCountry field name as the referenceCode parameter to retrieve the values..</param>
        /// <param name="isPrimaryId">Flag to mark primary identification document. Valid values: true and false.</param>
        public ApplicationUpdateIdentificationDocumentDetails(string idType = default(string), string idNumber = default(string), DateTime? idExpiryDate = default(DateTime?), DateTime? idIssueDate = default(DateTime?), string idIssuePlace = default(string), string idIssueState = default(string), string idIssueCountry = default(string), bool? isPrimaryId = default(bool?))
        {
            this.IdType = idType;
        ...
        /// <summary>
        /// Type of Identification document. This is a reference data data field. Please use /v1/apac/utilities/referenceData/{idType} resource to get valid values of this field with descriptions
        /// </summary>
        /// <value>Type of Identification document. This is a reference data data field. Please use /v1/apac/utilities/referenceData/{idType} resource to get valid values of this field with descriptions</value>
        ...
        /// <summary>
        /// Country of issuance. This is a reference data data field. Please use /v1/apac/utilities/referenceData/{country} resource to get valid value of this field with description. You can use idIssueCountry field name as the referenceCode parameter to retrieve the values.
        /// </summary>
        /// <value>Country of issuance. This is a reference data data field. Please use /v1/apac/utilities/referenceData/{country} resource to get valid value of this field with description. You can use idIssueCountry field name as the referenceCode parameter to retrieve the values.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ApplicationUpdateIdentificationDocumentDetails {\n");
        ...
        {
            return this.Equals(input as ApplicationUpdateIdentificationDocumentDetails);
        }

        /// <summary>
        /// Returns true if ApplicationUpdateIdentificationDocumentDetails instances are equal
        /// </summary>
        /// <param name="input">Instance of ApplicationUpdateIdentificationDocumentDetails to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApplicationUpdateIdentificationDocumentDetails input)
        {
            if (input == null)
                return false;
