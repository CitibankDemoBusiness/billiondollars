...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ApplicantUpdateEmail :  IEquatable<ApplicantUpdateEmail>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ApplicantUpdateEmail" /> class.
        /// </summary>
        ...
        public ApplicantUpdateEmail(string emailAddress = default(string), bool? okToEmail = default(bool?), bool? isPreferredEmailAddress = default(bool?))
        {
            // to ensure "emailAddress" is required (not null)
            if (emailAddress == null)
            {
                throw new InvalidDataException("emailAddress is a required property for ApplicantUpdateEmail and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ApplicantUpdateEmail {\n");
        ...
        {
            return this.Equals(input as ApplicantUpdateEmail);
        }

        /// <summary>
        /// Returns true if ApplicantUpdateEmail instances are equal
        /// </summary>
        /// <param name="input">Instance of ApplicantUpdateEmail to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApplicantUpdateEmail input)
        {
            if (input == null)
                return false;
