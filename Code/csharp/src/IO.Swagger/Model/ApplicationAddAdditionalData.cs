...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ApplicationAddAdditionalData :  IEquatable<ApplicationAddAdditionalData>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ApplicationAddAdditionalData" /> class.
        /// </summary>
        ...
        public ApplicationAddAdditionalData(decimal? numberOfDependents = default(decimal?), bool? staffIndicator = default(bool?), string businessNature = default(string), string emergencyContactName = default(string), string emergencyContactPhoneNumber = default(string), bool? overLimitConsentFlag = default(bool?), ApplicationAddCountrySpecificGroup countrySpecificGroup = default(ApplicationAddCountrySpecificGroup), ApplicationAddPrimaryBankDetails primaryBankDetails = default(ApplicationAddPrimaryBankDetails), string referralGivenName = default(string), string referralSurname = default(string), bool? relatedToCitiEmployeeFlag = default(bool?), string relatedCitiEmployeeName = default(string), string relatedCitiEmployeeDepartment = default(string), string creditCardUsagePurpose = default(string))
        {
        ...
        public ApplicationAddCountrySpecificGroup CountrySpecificGroup { get; set; }

        /// <summary>
        /// Gets or Sets PrimaryBankDetails
        /// </summary>
        [DataMember(Name="primaryBankDetails", EmitDefaultValue=false)]
        public ApplicationAddPrimaryBankDetails PrimaryBankDetails { get; set; }
        ...
        {
            return this.Equals(input as ApplicationAddAdditionalData);
        }

        /// <summary>
        /// Returns true if ApplicationAddAdditionalData instances are equal
        /// </summary>
        /// <param name="input">Instance of ApplicationAddAdditionalData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApplicationAddAdditionalData input)
        {
            if (input == null)
                return false;
