...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ApplicationInquiryReadyCreditProduct :  IEquatable<ApplicationInquiryReadyCreditProduct>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ApplicationInquiryReadyCreditProduct" /> class.
        /// </summary>
        ...
        public ApplicationInquiryReadyCreditProduct(string productCode = default(string), string sourceCode = default(string), string organization = default(string), string logo = default(string), bool? requestCreditShield = default(bool?), string embossName = default(string), string billingAddress = default(string), string cardDeliveryAddress = default(string), string pinDeliveryAddress = default(string), string giftCode = default(string), bool? creditLimitIncreaseIndicator = default(bool?), bool? atmRequiredFlag = default(bool?), bool? chequeBookRequiredFlag = default(bool?), List<ApplicationInquiryBalanceTransferDetails> balanceTransferDetails = default(List<ApplicationInquiryBalanceTransferDetails>))
        {
            // to ensure "productCode" is required (not null)
            if (productCode == null)
            {
                throw new InvalidDataException("productCode is a required property for ApplicationInquiryReadyCreditProduct and cannot be null");
            }
            else
            {
            ...
            if (sourceCode == null)
            {
                throw new InvalidDataException("sourceCode is a required property for ApplicationInquiryReadyCreditProduct and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("organization is a required property for ApplicationInquiryReadyCreditProduct and cannot be null");
            }
            else
            {
            ...
            if (logo == null)
            {
                throw new InvalidDataException("logo is a required property for ApplicationInquiryReadyCreditProduct and cannot be null");
            }
            else
            {
                this.Logo = logo;
        ...
        {
            return this.Equals(input as ApplicationInquiryReadyCreditProduct);
        }

        /// <summary>
        /// Returns true if ApplicationInquiryReadyCreditProduct instances are equal
        /// </summary>
        /// <param name="input">Instance of ApplicationInquiryReadyCreditProduct to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApplicationInquiryReadyCreditProduct input)
        {
            if (input == null)
                return false;
