...
namespace IO.Swagger.Model
{
        ...
        public partial class CountrySpecificAddress :  IEquatable<CountrySpecificAddress>, IValidatableObject
    {
        ...
        /// <param name="streetType">Applicant&#x27;s street Type.Please use /v1/utilities/referenceData/{streetType} resource to get valid value of this field with description..</param>
        /// <param name="village">Applicant&#x27;s village.</param>
        /// <param name="town">Applicant&#x27;s town.</param>
        /// <param name="district">This is a reference data field. Please use /v1/utilities/referenceData/{district} resource to get valid value of this field with description..</param>
        public CountrySpecificAddress(string unitNumber = default(string), string floorNumber = default(string), string blockNumber = default(string), string buildingName = default(string), string estateName = default(string), string streetNumber = default(string), string streetName = default(string), string streetType = default(string), string village = default(string), string town = default(string), string district = default(string))
        {
        ...
        /// </summary>
        /// <value>Applicant&#x27;s street Type.Please use /v1/utilities/referenceData/{streetType} resource to get valid value of this field with description.</value>
        ...
        /// Applicant&#x27;s village
        /// </summary>
        /// <value>Applicant&#x27;s village</value>
        ...
        /// </summary>
        /// <value>This is a reference data field. Please use /v1/utilities/referenceData/{district} resource to get valid value of this field with description.</value>
