...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class CounterOffer :  IEquatable<CounterOffer>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CounterOffer" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as CounterOffer);
        }

        /// <summary>
        /// Returns true if CounterOffer instances are equal
        /// </summary>
        /// <param name="input">Instance of CounterOffer to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CounterOffer input)
        {
            if (input == null)
                return false;
