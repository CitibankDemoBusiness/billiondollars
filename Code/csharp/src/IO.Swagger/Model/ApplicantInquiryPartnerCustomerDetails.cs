...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ApplicantInquiryPartnerCustomerDetails :  IEquatable<ApplicantInquiryPartnerCustomerDetails>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ApplicantInquiryPartnerCustomerDetails" /> class.
        /// </summary>
        ...
        public ApplicantInquiryPartnerCustomerDetails(string partnerCustomerInternalId = default(string), string partnerCustomerId = default(string), string partnerCustomerSegment = default(string))
        {
        ...
        {
            return this.Equals(input as ApplicantInquiryPartnerCustomerDetails);
        }

        /// <summary>
        /// Returns true if ApplicantInquiryPartnerCustomerDetails instances are equal
        /// </summary>
        /// <param name="input">Instance of ApplicantInquiryPartnerCustomerDetails to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApplicantInquiryPartnerCustomerDetails input)
        {
            if (input == null)
                return false;
