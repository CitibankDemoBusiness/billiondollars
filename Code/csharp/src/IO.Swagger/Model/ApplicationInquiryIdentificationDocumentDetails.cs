...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ApplicationInquiryIdentificationDocumentDetails :  IEquatable<ApplicationInquiryIdentificationDocumentDetails>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ApplicationInquiryIdentificationDocumentDetails" /> class.
        /// </summary>
        /// <param name="idType">Type of Identification document. This is a reference data field. Please use /v1/apac/utilities/referenceData/{idType} resource to get valid values of this field with descriptions (required).</param>
        /// <param name="idNumber">Unique identifier of identification document. Ex: Passport Number (required).</param>
        ...
        public ApplicationInquiryIdentificationDocumentDetails(string idType = default(string), string idNumber = default(string), DateTime? idExpiryDate = default(DateTime?), DateTime? idIssueDate = default(DateTime?), string idIssuePlace = default(string), string idIssueState = default(string), string idIssueCountry = default(string), bool? isPrimaryId = default(bool?))
        {
            ...
            if (idNumber == null)
            {
                throw new InvalidDataException("idNumber is a required property for ApplicationInquiryIdentificationDocumentDetails and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as ApplicationInquiryIdentificationDocumentDetails);
        }

        /// <summary>
        /// Returns true if ApplicationInquiryIdentificationDocumentDetails instances are equal
        /// </summary>
        /// <param name="input">Instance of ApplicationInquiryIdentificationDocumentDetails to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApplicationInquiryIdentificationDocumentDetails input)
        {
            if (input == null)
                return false;
