...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ApplicationInquiryRequiredDocuments :  IEquatable<ApplicationInquiryRequiredDocuments>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ApplicationInquiryRequiredDocuments" /> class.
        /// </summary>
        ...
        public ApplicationInquiryRequiredDocuments(string documentIdType = default(string), string documentStatus = default(string), string productCode = default(string), string proofType = default(string), string linkedDocumentId = default(string), string applicantType = default(string))
        {
        ...
        {
            return this.Equals(input as ApplicationInquiryRequiredDocuments);
        }

        /// <summary>
        /// Returns true if ApplicationInquiryRequiredDocuments instances are equal
        /// </summary>
        /// <param name="input">Instance of ApplicationInquiryRequiredDocuments to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApplicationInquiryRequiredDocuments input)
        {
            if (input == null)
                return false;
