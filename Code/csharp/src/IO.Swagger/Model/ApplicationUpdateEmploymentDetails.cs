...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ApplicationUpdateEmploymentDetails :  IEquatable<ApplicationUpdateEmploymentDetails>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ApplicationUpdateEmploymentDetails" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as ApplicationUpdateEmploymentDetails);
        }

        /// <summary>
        /// Returns true if ApplicationUpdateEmploymentDetails instances are equal
        /// </summary>
        /// <param name="input">Instance of ApplicationUpdateEmploymentDetails to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApplicationUpdateEmploymentDetails input)
        {
            if (input == null)
                return false;
