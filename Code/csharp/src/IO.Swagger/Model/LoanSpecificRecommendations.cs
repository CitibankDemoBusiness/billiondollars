...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class LoanSpecificRecommendations :  IEquatable<LoanSpecificRecommendations>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LoanSpecificRecommendations" /> class.
        /// </summary>
        /// <param name="loanAmount">Eligible Loan amount..</param>
        /// <param name="tenor">Tenor for the loan repayment. This is a reference data field. Please use /v1/apac/utilities/referenceData/{tenor} resource to get valid value of this field with description..</param>
        /// <param name="interestRate">The rate of interest applicable to product.</param>
        /// <param name="handlingFee">Handling fee to be paid..</param>
        /// <param name="installmentAmount">Installment amount to be paid..</param>
        ...
        /// <param name="totalInterestAmount">Total interest to be paid by customer.</param>
        /// <param name="totalInstallmentAmount">Total installment amount to be paid by customer.</param>
        ...
        public LoanSpecificRecommendations(double? loanAmount = default(double?), string tenor = default(string), double? interestRate = default(double?), double? handlingFee = default(double?), double? installmentAmount = default(double?), double? annualPercentageRate = default(double?), double? totalPrincipalAmount = default(double?), double? totalInterestAmount = default(double?), double? totalInstallmentAmount = default(double?), DateTime? repaymentScheduleIssueDate = default(DateTime?), List<RepaymentSchedule> repaymentSchedule = default(List<RepaymentSchedule>))
        {
        ...
        /// </summary>
        /// <value>Tenor for the loan repayment. This is a reference data field. Please use /v1/apac/utilities/referenceData/{tenor} resource to get valid value of this field with description.</value>
        ...
        /// </summary>
        /// <value>The rate of interest applicable to product</value>
        ...
        /// </summary>
        /// <value>Handling fee to be paid.</value>
        ...
        /// </summary>
        /// <value>Installment amount to be paid.</value>
        ...
        /// </summary>
        /// <value>Total interest to be paid by customer</value>
        ...
        /// </summary>
        /// <value>Total installment amount to be paid by customer</value>
        ...
        {
            return this.Equals(input as LoanSpecificRecommendations);
        }

        /// <summary>
        /// Returns true if LoanSpecificRecommendations instances are equal
        /// </summary>
        /// <param name="input">Instance of LoanSpecificRecommendations to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LoanSpecificRecommendations input)
        {
            if (input == null)
                return false;
