...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ApplicationInquiryName :  IEquatable<ApplicationInquiryName>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ApplicationInquiryName" /> class.
        /// </summary>
        ...
        public ApplicationInquiryName(string salutation = default(string), string givenName = default(string), string middleName = default(string), string surname = default(string), string localEnglishGivenName = default(string), string localEnglishSurname = default(string), string aliasName = default(string), string saluteBy = default(string))
        {
            // to ensure "givenName" is required (not null)
            if (givenName == null)
            {
                throw new InvalidDataException("givenName is a required property for ApplicationInquiryName and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as ApplicationInquiryName);
        }

        /// <summary>
        /// Returns true if ApplicationInquiryName instances are equal
        /// </summary>
        /// <param name="input">Instance of ApplicationInquiryName to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApplicationInquiryName input)
        {
            if (input == null)
                return false;
