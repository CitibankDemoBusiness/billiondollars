...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ApplicantInquiryAddress :  IEquatable<ApplicantInquiryAddress>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ApplicantInquiryAddress" /> class.
        /// </summary>
        /// <param name="addressType">Type of the address. This is a reference data field. Please use /utilities/referenceData/{addressType} resource to get valid values of this field with descriptions. You can use addressType as the referenceCode parameter to retrieve the values..</param>
        ...
        /// <param name="residenceDurationInYears">Applicant&#x27;s residence duration in the current address in years.</param>
        /// <param name="residenceDurationInMonths">Applicant&#x27;s residence duration in the current address in months.</param>
        /// <param name="countrySpecificAddress">countrySpecificAddress.</param>
        public ApplicantInquiryAddress(string addressType = default(string), string addressLine1 = default(string), string addressLine2 = default(string), string addressLine3 = default(string), string addressLine4 = default(string), string cityName = default(string), string state = default(string), string postalCode = default(string), string countryCode = default(string), int? residenceDurationInYears = default(int?), int? residenceDurationInMonths = default(int?), ApplicantInquiryCountrySpecificAddress countrySpecificAddress = default(ApplicantInquiryCountrySpecificAddress))
        {
        ...
        /// </summary>
        /// <value>Type of the address. This is a reference data field. Please use /utilities/referenceData/{addressType} resource to get valid values of this field with descriptions. You can use addressType as the referenceCode parameter to retrieve the values.</value>
        ...
        /// </summary>
        /// <value>Applicant&#x27;s residence duration in the current address in years</value>
        ...
        /// </summary>
        /// <value>Applicant&#x27;s residence duration in the current address in months</value>
        ...
        public ApplicantInquiryCountrySpecificAddress CountrySpecificAddress { get; set; }
        ...
        {
            return this.Equals(input as ApplicantInquiryAddress);
        }

        /// <summary>
        /// Returns true if ApplicantInquiryAddress instances are equal
        /// </summary>
        /// <param name="input">Instance of ApplicantInquiryAddress to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApplicantInquiryAddress input)
        {
            if (input == null)
                return false;
