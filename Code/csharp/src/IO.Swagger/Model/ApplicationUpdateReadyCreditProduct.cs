...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ApplicationUpdateReadyCreditProduct :  IEquatable<ApplicationUpdateReadyCreditProduct>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ApplicationUpdateReadyCreditProduct" /> class.
        /// </summary>
        ...
        public ApplicationUpdateReadyCreditProduct(string productCode = default(string), string sourceCode = default(string), string organization = default(string), string logo = default(string), bool? requestCreditShield = default(bool?), string embossName = default(string), string billingAddress = default(string), string cardDeliveryAddress = default(string), string pinDeliveryAddress = default(string), string giftCode = default(string), bool? creditLimitIncreaseIndicator = default(bool?), bool? atmRequiredFlag = default(bool?), bool? chequeBookRequiredFlag = default(bool?), List<ApplicationUpdateBalanceTransferDetails> balanceTransferDetails = default(List<ApplicationUpdateBalanceTransferDetails>))
        {
        ...
        {
            return this.Equals(input as ApplicationUpdateReadyCreditProduct);
        }

        /// <summary>
        /// Returns true if ApplicationUpdateReadyCreditProduct instances are equal
        /// </summary>
        /// <param name="input">Instance of ApplicationUpdateReadyCreditProduct to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApplicationUpdateReadyCreditProduct input)
        {
            if (input == null)
                return false;
