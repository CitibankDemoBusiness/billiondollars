...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ApplicationAddApplicant :  IEquatable<ApplicationAddApplicant>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ApplicationAddApplicant" /> class.
        /// </summary>
        ...
        public ApplicationAddApplicant(ApplicationAddOcr ocr = default(ApplicationAddOcr), string motherMaidenName = default(string), ApplicationAddName name = default(ApplicationAddName), ApplicationAddDemographics demographics = default(ApplicationAddDemographics), List<ApplicationAddAddress> address = default(List<ApplicationAddAddress>), List<ApplicationAddEmail> email = default(List<ApplicationAddEmail>), List<ApplicationAddPhone> phone = default(List<ApplicationAddPhone>), ApplicationAddContactPreference contactPreference = default(ApplicationAddContactPreference), ApplicationAddContactConsent contactConsent = default(ApplicationAddContactConsent), ApplicationAddFinancialInformation financialInformation = default(ApplicationAddFinancialInformation), ApplicationAddEducation education = default(ApplicationAddEducation), List<ApplicationAddEmploymentDetails> employmentDetails = default(List<ApplicationAddEmploymentDetails>), List<ApplicationAddIdentificationDocumentDetails> identificationDocumentDetails = default(List<ApplicationAddIdentificationDocumentDetails>), ApplicationAddAdditionalData additionalData = default(ApplicationAddAdditionalData), ApplicationAddPartnerCustomerDetails partnerCustomerDetails = default(ApplicationAddPartnerCustomerDetails), List<ApplicationAddConsentDetails> consentDetails = default(List<ApplicationAddConsentDetails>), ApplicationAddMarketingConsent marketingConsent = default(ApplicationAddMarketingConsent), ApplicationAddSelfDeclaration selfDeclaration = default(ApplicationAddSelfDeclaration), ApplicationAddKycInformation kycInformation = default(ApplicationAddKycInformation))
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for ApplicationAddApplicant and cannot be null");
            }
            else
            {
                this.Name = name;
            ...
            if (phone == null)
            {
                throw new InvalidDataException("phone is a required property for ApplicationAddApplicant and cannot be null");
            }
            else
            {
                this.Phone = phone;
        ...
        public ApplicationAddOcr Ocr { get; set; }
        ...
        {
            return this.Equals(input as ApplicationAddApplicant);
        }

        /// <summary>
        /// Returns true if ApplicationAddApplicant instances are equal
        /// </summary>
        /// <param name="input">Instance of ApplicationAddApplicant to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApplicationAddApplicant input)
        {
            if (input == null)
                return false;
