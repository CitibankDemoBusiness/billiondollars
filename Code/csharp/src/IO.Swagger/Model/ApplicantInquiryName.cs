...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ApplicantInquiryName :  IEquatable<ApplicantInquiryName>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ApplicantInquiryName" /> class.
        /// </summary>
        ...
        public ApplicantInquiryName(string salutation = default(string), string givenName = default(string), string middleName = default(string), string surname = default(string), string aliasName = default(string))
        {
            // to ensure "givenName" is required (not null)
            if (givenName == null)
            {
                throw new InvalidDataException("givenName is a required property for ApplicantInquiryName and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as ApplicantInquiryName);
        }

        /// <summary>
        /// Returns true if ApplicantInquiryName instances are equal
        /// </summary>
        /// <param name="input">Instance of ApplicantInquiryName to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApplicantInquiryName input)
        {
            if (input == null)
                return false;
