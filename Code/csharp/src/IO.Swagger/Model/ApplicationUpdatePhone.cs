...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ApplicationUpdatePhone :  IEquatable<ApplicationUpdatePhone>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ApplicationUpdatePhone" /> class.
        /// </summary>
        /// <param name="phoneType">The type of phone. Ex:OFFICE, HOME, MOBILE, PRIMARY_MOBILE, FAX. This is a reference data data field. Please use /v1/apac/utilities/referenceData/{phoneType} resource to get valid value of this field with description. You can use phoneType field name as the referenceCode parameter to retrieve the values. (required).</param>
        /// <param name="phoneCountryCode">Country code of telephone number (required).</param>
        /// <param name="areaCode">The area code of telephone number.</param>
        /// <param name="phoneNumber">The phone number of applicant (required).</param>
        ...
        public ApplicationUpdatePhone(string phoneType = default(string), string phoneCountryCode = default(string), string areaCode = default(string), string phoneNumber = default(string), string extension = default(string), bool? okToSms = default(bool?), bool? okToCall = default(bool?))
        {
            // to ensure "phoneType" is required (not null)
            if (phoneType == null)
            {
                throw new InvalidDataException("phoneType is a required property for ApplicationUpdatePhone and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("phoneCountryCode is a required property for ApplicationUpdatePhone and cannot be null");
            }
            else
            {
            ...
            if (phoneNumber == null)
            {
                throw new InvalidDataException("phoneNumber is a required property for ApplicationUpdatePhone and cannot be null");
            }
            else
            {
        ...
        /// <summary>
        /// The type of phone. Ex:OFFICE, HOME, MOBILE, PRIMARY_MOBILE, FAX. This is a reference data data field. Please use /v1/apac/utilities/referenceData/{phoneType} resource to get valid value of this field with description. You can use phoneType field name as the referenceCode parameter to retrieve the values.
        /// </summary>
        /// <value>The type of phone. Ex:OFFICE, HOME, MOBILE, PRIMARY_MOBILE, FAX. This is a reference data data field. Please use /v1/apac/utilities/referenceData/{phoneType} resource to get valid value of this field with description. You can use phoneType field name as the referenceCode parameter to retrieve the values.</value>
        ...
        /// </summary>
        /// <value>The phone number of applicant</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ApplicationUpdatePhone {\n");
        ...
        {
            return this.Equals(input as ApplicationUpdatePhone);
        }

        /// <summary>
        /// Returns true if ApplicationUpdatePhone instances are equal
        /// </summary>
        /// <param name="input">Instance of ApplicationUpdatePhone to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApplicationUpdatePhone input)
        {
            if (input == null)
                return false;
