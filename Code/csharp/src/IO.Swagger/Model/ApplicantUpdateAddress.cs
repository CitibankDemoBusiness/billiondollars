...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ApplicantUpdateAddress :  IEquatable<ApplicantUpdateAddress>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ApplicantUpdateAddress" /> class.
        /// </summary>
        ...
        public ApplicantUpdateAddress(string addressType = default(string), string addressLine1 = default(string), string addressLine2 = default(string), string addressLine3 = default(string), string addressLine4 = default(string), string cityName = default(string), string state = default(string), string postalCode = default(string), string countryCode = default(string), int? residenceDurationInYears = default(int?), int? residenceDurationInMonths = default(int?), ApplicantUpdateCountrySpecificAddress countrySpecificAddress = default(ApplicantUpdateCountrySpecificAddress))
        {
        ...
        public ApplicantUpdateCountrySpecificAddress CountrySpecificAddress { get; set; }
        ...
        {
            return this.Equals(input as ApplicantUpdateAddress);
        }

        /// <summary>
        /// Returns true if ApplicantUpdateAddress instances are equal
        /// </summary>
        /// <param name="input">Instance of ApplicantUpdateAddress to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApplicantUpdateAddress input)
        {
            if (input == null)
                return false;
