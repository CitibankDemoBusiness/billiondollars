...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ApplicantAddIdentificationDocumentDetails :  IEquatable<ApplicantAddIdentificationDocumentDetails>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ApplicantAddIdentificationDocumentDetails" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as ApplicantAddIdentificationDocumentDetails);
        }

        /// <summary>
        /// Returns true if ApplicantAddIdentificationDocumentDetails instances are equal
        /// </summary>
        /// <param name="input">Instance of ApplicantAddIdentificationDocumentDetails to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApplicantAddIdentificationDocumentDetails input)
        {
            if (input == null)
                return false;
