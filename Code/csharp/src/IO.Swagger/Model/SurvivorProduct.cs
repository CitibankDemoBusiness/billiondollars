...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class SurvivorProduct :  IEquatable<SurvivorProduct>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SurvivorProduct" /> class.
        /// </summary>
        ...
        public SurvivorProduct(string productCode = default(string), string sourceCode = default(string), string organization = default(string), string logo = default(string))
        {
            // to ensure "productCode" is required (not null)
            if (productCode == null)
            {
                throw new InvalidDataException("productCode is a required property for SurvivorProduct and cannot be null");
            }
            else
            {
            ...
            if (sourceCode == null)
            {
                throw new InvalidDataException("sourceCode is a required property for SurvivorProduct and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("organization is a required property for SurvivorProduct and cannot be null");
            }
            else
            {
            ...
            if (logo == null)
            {
                throw new InvalidDataException("logo is a required property for SurvivorProduct and cannot be null");
            }
            else
            {
                this.Logo = logo;
        ...
        {
            return this.Equals(input as SurvivorProduct);
        }

        /// <summary>
        /// Returns true if SurvivorProduct instances are equal
        /// </summary>
        /// <param name="input">Instance of SurvivorProduct to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SurvivorProduct input)
        {
            if (input == null)
                return false;
