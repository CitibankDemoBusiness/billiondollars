...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ApplicationInquiryEmploymentDetails :  IEquatable<ApplicationInquiryEmploymentDetails>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ApplicationInquiryEmploymentDetails" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as ApplicationInquiryEmploymentDetails);
        }

        /// <summary>
        /// Returns true if ApplicationInquiryEmploymentDetails instances are equal
        /// </summary>
        /// <param name="input">Instance of ApplicationInquiryEmploymentDetails to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApplicationInquiryEmploymentDetails input)
        {
            if (input == null)
                return false;
