  ...
  class ApplicantInquiryEmploymentDetails
    ...
    def self.openapi_types
      {
        ...
        :'employment_durationi_in_months' => :'Object',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `SwaggerClient::ApplicantInquiryEmploymentDetails` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SwaggerClient::ApplicantInquiryEmploymentDetails`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'employment_durationi_in_months')
        self.employment_durationi_in_months = attributes[:'employment_durationi_in_months']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          employment_durationi_in_months == o.employment_durationi_in_months &&
    ...
    def hash
      [employment_duration_in_years, employment_durationi_in_months, employer_name, job_title, occupation_code, employment_status].hash
    end
