...
module SwaggerClient
  class LoanPaymentAccountDetailsAdd
    ...
    def self.openapi_types
      {
        ...
        :'loan_disbursement_method' => :'Object',
        :'account_number' => :'Object',
        :'account_reference_key' => :'Object',
        :'account_nick_name' => :'Object',
        :'bank_name' => :'Object',
        :'bank_code' => :'Object',
        :'branch_code' => :'Object'
      }
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `SwaggerClient::LoanPaymentAccountDetailsAdd` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SwaggerClient::LoanPaymentAccountDetailsAdd`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'disbursement_amount')
        self.disbursement_amount = attributes[:'disbursement_amount']
      end

      if attributes.key?(:'loan_disbursement_method')
        self.loan_disbursement_method = attributes[:'loan_disbursement_method']
      end
      ...
      if attributes.key?(:'account_reference_key')
        self.account_reference_key = attributes[:'account_reference_key']
      end

      if attributes.key?(:'account_nick_name')
        self.account_nick_name = attributes[:'account_nick_name']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          disbursement_amount == o.disbursement_amount &&
          loan_disbursement_method == o.loan_disbursement_method &&
          account_number == o.account_number &&
          account_reference_key == o.account_reference_key &&
          account_nick_name == o.account_nick_name &&
    ...
    def hash
      [disbursement_amount, loan_disbursement_method, account_number, account_reference_key, account_nick_name, bank_name, bank_code, branch_code].hash
    end
