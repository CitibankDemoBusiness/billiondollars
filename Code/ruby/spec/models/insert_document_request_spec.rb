...
# Unit tests for SwaggerClient::InsertDocumentRequest
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'InsertDocumentRequest' do
  before do
    # run before each test
    @instance = SwaggerClient::InsertDocumentRequest.new
  end
  ...
  describe 'test an instance of InsertDocumentRequest' do
    it 'should create an instance of InsertDocumentRequest' do
      expect(@instance).to be_instance_of(SwaggerClient::InsertDocumentRequest)
    end
  end
