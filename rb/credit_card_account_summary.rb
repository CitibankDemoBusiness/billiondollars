...
module SwaggerClient
  class CreditCardAccountSummary
    ...
    attr_accessor :account_nickname
    ...
    attr_accessor :alternate_currency_current_balance
    ...
    def self.openapi_types
      {
        ...
        :'alternate_currency' => :'Object',
        :'alternate_currency_current_balance' => :'Object',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `SwaggerClient::CreditCardAccountSummary` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SwaggerClient::CreditCardAccountSummary`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'account_nickname')
        self.account_nickname = attributes[:'account_nickname']
      end
      ...
      if attributes.key?(:'alternate_currency')
        self.alternate_currency = attributes[:'alternate_currency']
      end

      if attributes.key?(:'alternate_currency_current_balance')
        self.alternate_currency_current_balance = attributes[:'alternate_currency_current_balance']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          account_nickname == o.account_nickname &&
          ...
          alternate_currency == o.alternate_currency &&
          alternate_currency_current_balance == o.alternate_currency_current_balance &&
    ...
    def hash
      [product_name, product_code, account_nickname, display_account_number, account_id, currency_code, account_classification, account_status, outstanding_balance, available_credit, credit_limit, minimum_due_amount, payment_due_date, alternate_currency, alternate_currency_current_balance, card_holder_type].hash
    end
