...
module SwaggerClient
  class OriginalTransactionDetails
    ...
    attr_accessor :transaction_remarks
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `SwaggerClient::OriginalTransactionDetails` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SwaggerClient::OriginalTransactionDetails`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'transaction_remarks')
        self.transaction_remarks = attributes[:'transaction_remarks']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          transaction_remarks == o.transaction_remarks &&
    ...
    def hash
      [payment_type, transaction_date, transaction_amount, transaction_currency_code, transaction_status, transaction_reference_number, transaction_remarks, end_to_end_identification].hash
    end
