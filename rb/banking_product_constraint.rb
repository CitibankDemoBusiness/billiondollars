  ...
  class BankingProductConstraint
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `SwaggerClient::BankingProductConstraint` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SwaggerClient::BankingProductConstraint`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'constraint_type')
        self.constraint_type = attributes[:'constraint_type']
      end
    ...
    def valid?
      ...
      constraint_type_validator = EnumAttributeValidator.new('Object', ['MIN_BALANCE', 'MAX_BALANCE', 'OPENING_BALANCE', 'MAX_LIMIT', 'MIN_LIMIT'])
    ...
    def constraint_type=(constraint_type)
      validator = EnumAttributeValidator.new('Object', ['MIN_BALANCE', 'MAX_BALANCE', 'OPENING_BALANCE', 'MAX_LIMIT', 'MIN_LIMIT'])
    ...
    def hash
      [constraint_type, additional_value, additional_info, additional_info_uri].hash
    end
