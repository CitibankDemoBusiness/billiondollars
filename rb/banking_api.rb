  ...
  class BankingApi
    ...
    def get_product_detail_with_http_info(product_id, x_v, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: BankingApi.get_product_detail ...'
      end
      # verify the required parameter 'product_id' is set
      if @api_client.config.client_side_validation && product_id.nil?
        fail ArgumentError, "Missing the required parameter 'product_id' when calling BankingApi.get_product_detail"
      end
      # verify the required parameter 'x_v' is set
      if @api_client.config.client_side_validation && x_v.nil?
        fail ArgumentError, "Missing the required parameter 'x_v' when calling BankingApi.get_product_detail"
      end
      # resource path
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: BankingApi#get_product_detail\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    def list_products_with_http_info(x_v, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: BankingApi.list_products ...'
      end
      # verify the required parameter 'x_v' is set
      if @api_client.config.client_side_validation && x_v.nil?
        fail ArgumentError, "Missing the required parameter 'x_v' when calling BankingApi.list_products"
      end
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: BankingApi#list_products\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
