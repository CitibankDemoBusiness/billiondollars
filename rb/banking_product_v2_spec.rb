...
# Unit tests for SwaggerClient::BankingProductV2
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'BankingProductV2' do
  before do
    # run before each test
    @instance = SwaggerClient::BankingProductV2.new
  end
  ...
  describe 'test an instance of BankingProductV2' do
    it 'should create an instance of BankingProductV2' do
      expect(@instance).to be_instance_of(SwaggerClient::BankingProductV2)
    end
  end
