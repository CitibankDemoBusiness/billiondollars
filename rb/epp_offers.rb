...
module SwaggerClient
  class EppOffers
    ...
    def hash
      [tenor, effective_interest_rate, annual_percentage_rate, installment_amount, one_time_processing_fee_indicator, one_time_processing_fee_amount, one_time_processing_fee_percentage, initial_interest_amount, offer_indicator].hash
    end
