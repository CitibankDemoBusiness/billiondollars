...
module SwaggerClient
  class LoanBookingPreLoginRequest
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `SwaggerClient::LoanBookingPreLoginRequest` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SwaggerClient::LoanBookingPreLoginRequest`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'purpose_of_loan')
        self.purpose_of_loan = attributes[:'purpose_of_loan']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          purpose_of_loan == o.purpose_of_loan &&
    ...
    def hash
      [loan_amount, tenor, disbursement_option, disbursement_account_id, payee_id, birth_year, purpose_of_loan, bank_details].hash
    end
