...
module SwaggerClient
  class MutualFundAccount
    ...
    attr_accessor :total_net_asset_value_amount
    ...
    attr_accessor :total_unrealized_gains

    attr_accessor :relationship

    attr_accessor :mutual_fund
    ...
    def self.openapi_types
      {
        ...
        :'total_net_asset_value_amount' => :'Object',
        :'total_transaction_amount' => :'Object',
        :'total_unrealized_gains' => :'Object',
        :'relationship' => :'Object',
        :'mutual_fund' => :'Object'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `SwaggerClient::MutualFundAccount` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SwaggerClient::MutualFundAccount`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'total_net_asset_value_amount')
        self.total_net_asset_value_amount = attributes[:'total_net_asset_value_amount']
      end
      ...
      if attributes.key?(:'total_unrealized_gains')
        self.total_unrealized_gains = attributes[:'total_unrealized_gains']
      end
      ...
      if attributes.key?(:'mutual_fund')
        if (value = attributes[:'mutual_fund']).is_a?(Array)
          self.mutual_fund = value
        end
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          total_net_asset_value_amount == o.total_net_asset_value_amount &&
          total_transaction_amount == o.total_transaction_amount &&
          total_unrealized_gains == o.total_unrealized_gains &&
          relationship == o.relationship &&
          mutual_fund == o.mutual_fund
    end
    ...
    def hash
      [product_name, product_code, display_account_number, currency_code, total_net_asset_value_amount, total_transaction_amount, total_unrealized_gains, relationship, mutual_fund].hash
    end
