...
module SwaggerClient
  class CreditCardProductUpdate
    ...
    attr_accessor :card_delivery_branch
    ...
    attr_accessor :card_delivery_option
    ...
    def self.openapi_types
      {
        ...
        :'card_delivery_branch' => :'Object',
        :'card_delivery_option' => :'Object',
        :'gift_code' => :'Object',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `SwaggerClient::CreditCardProductUpdate` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SwaggerClient::CreditCardProductUpdate`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'card_delivery_branch')
        self.card_delivery_branch = attributes[:'card_delivery_branch']
      end

      if attributes.key?(:'card_delivery_option')
        self.card_delivery_option = attributes[:'card_delivery_option']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          card_delivery_branch == o.card_delivery_branch &&
          card_delivery_option == o.card_delivery_option &&
    ...
    def hash
      [product_code, source_code, organization, logo, request_credit_shield, requested_credit_limit, emboss_name, billing_address, card_delivery_address, pin_delivery_address, card_delivery_branch, card_delivery_option, gift_code, credit_limit_increase_indicator, balance_transfer_details, credit_limit_accepted_flag].hash
    end
