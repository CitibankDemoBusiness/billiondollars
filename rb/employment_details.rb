...
module SwaggerClient
  class EmploymentDetails
    ...
    def hash
      [employer_name, job_title, industry_code, business_nature, employment_duration_in_years, employment_duration_in_months, employment_status, years_in_industry, months_in_industry].hash
    end
