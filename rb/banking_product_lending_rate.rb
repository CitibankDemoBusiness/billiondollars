...
module SwaggerClient
  class BankingProductLendingRate
    ...
    attr_accessor :lending_rate_type

    # The rate to be applied
    attr_accessor :rate

    # A comparison rate equivalent for this rate
    attr_accessor :comparison_rate
    ...
    attr_accessor :interest_payment_due
    ...
    def self.openapi_types
      {
        :'lending_rate_type' => :'Object',
        :'rate' => :'Object',
        :'comparison_rate' => :'Object',
        :'calculation_frequency' => :'Object',
        :'application_frequency' => :'Object',
        :'interest_payment_due' => :'Object',
        :'tiers' => :'Object',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `SwaggerClient::BankingProductLendingRate` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SwaggerClient::BankingProductLendingRate`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'lending_rate_type')
        self.lending_rate_type = attributes[:'lending_rate_type']
      end
      ...
      if attributes.key?(:'comparison_rate')
        self.comparison_rate = attributes[:'comparison_rate']
      end
      ...
      if attributes.key?(:'interest_payment_due')
        self.interest_payment_due = attributes[:'interest_payment_due']
      end
    ...
    def list_invalid_properties
      ...
      if @lending_rate_type.nil?
        invalid_properties.push('invalid value for "lending_rate_type", lending_rate_type cannot be nil.')
      end
    ...
    def valid?
      return false if @lending_rate_type.nil?
      lending_rate_type_validator = EnumAttributeValidator.new('Object', ['FIXED', 'VARIABLE', 'INTRODUCTORY', 'DISCOUNT', 'PENALTY', 'FLOATING', 'MARKET_LINKED', 'CASH_ADVANCE', 'PURCHASE', 'BUNDLE_DISCOUNT_FIXED', 'BUNDLE_DISCOUNT_VARIABLE'])
      return false unless lending_rate_type_validator.valid?(@lending_rate_type)
      return false if @rate.nil?
      interest_payment_due_validator = EnumAttributeValidator.new('Object', ['IN_ARREARS', 'IN_ADVANCE'])
      return false unless interest_payment_due_validator.valid?(@interest_payment_due)
      true
    end

    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] lending_rate_type Object to be assigned
    def lending_rate_type=(lending_rate_type)
      validator = EnumAttributeValidator.new('Object', ['FIXED', 'VARIABLE', 'INTRODUCTORY', 'DISCOUNT', 'PENALTY', 'FLOATING', 'MARKET_LINKED', 'CASH_ADVANCE', 'PURCHASE', 'BUNDLE_DISCOUNT_FIXED', 'BUNDLE_DISCOUNT_VARIABLE'])
      unless validator.valid?(lending_rate_type)
        fail ArgumentError, "invalid value for \"lending_rate_type\", must be one of #{validator.allowable_values}."
      end
      @lending_rate_type = lending_rate_type
    end

    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] interest_payment_due Object to be assigned
    def interest_payment_due=(interest_payment_due)
      validator = EnumAttributeValidator.new('Object', ['IN_ARREARS', 'IN_ADVANCE'])
      unless validator.valid?(interest_payment_due)
        fail ArgumentError, "invalid value for \"interest_payment_due\", must be one of #{validator.allowable_values}."
      end
      @interest_payment_due = interest_payment_due
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          lending_rate_type == o.lending_rate_type &&
          rate == o.rate &&
          comparison_rate == o.comparison_rate &&
          calculation_frequency == o.calculation_frequency &&
          application_frequency == o.application_frequency &&
          interest_payment_due == o.interest_payment_due &&
          tiers == o.tiers &&
    ...
    def hash
      [lending_rate_type, rate, comparison_rate, calculation_frequency, application_frequency, interest_payment_due, tiers, additional_value, additional_info, additional_info_uri].hash
    end
