...
module SwaggerClient
  class TransactionDetails
    ...
    attr_accessor :investment_transaction

    attr_accessor :transaction_error_details
    ...
    def self.openapi_types
      {
        ...
        :'transaction_error_details' => :'Object',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `SwaggerClient::TransactionDetails` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SwaggerClient::TransactionDetails`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'investment_transaction')
        if (value = attributes[:'investment_transaction']).is_a?(Array)
          self.investment_transaction = value
        end
      end

      if attributes.key?(:'transaction_error_details')
        self.transaction_error_details = attributes[:'transaction_error_details']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          investment_transaction == o.investment_transaction &&
          transaction_error_details == o.transaction_error_details &&
    ...
    def hash
      [account_id, transactions, statements, investment_transaction, transaction_error_details, next_start_index].hash
    end
