...
module SwaggerClient
  class BankingProductFee
    ...
    attr_accessor :transaction_rate
    ...
    attr_accessor :accrual_frequency
    ...
    def self.openapi_types
      {
        ...
        :'amount' => :'Object',
        :'balance_rate' => :'Object',
        :'transaction_rate' => :'Object',
        :'accrued_rate' => :'Object',
        :'accrual_frequency' => :'Object',
        :'currency' => :'Object',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `SwaggerClient::BankingProductFee` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SwaggerClient::BankingProductFee`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'balance_rate')
        self.balance_rate = attributes[:'balance_rate']
      end

      if attributes.key?(:'transaction_rate')
        self.transaction_rate = attributes[:'transaction_rate']
      end

      if attributes.key?(:'accrued_rate')
        self.accrued_rate = attributes[:'accrued_rate']
      end

      if attributes.key?(:'accrual_frequency')
        self.accrual_frequency = attributes[:'accrual_frequency']
      end
    ...
    def valid?
      ...
      fee_type_validator = EnumAttributeValidator.new('Object', ['PERIODIC', 'TRANSACTION', 'WITHDRAWAL', 'DEPOSIT', 'PAYMENT', 'PURCHASE', 'EVENT', 'UPFRONT', 'EXIT'])
    ...
    def fee_type=(fee_type)
      validator = EnumAttributeValidator.new('Object', ['PERIODIC', 'TRANSACTION', 'WITHDRAWAL', 'DEPOSIT', 'PAYMENT', 'PURCHASE', 'EVENT', 'UPFRONT', 'EXIT'])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          fee_type == o.fee_type &&
          amount == o.amount &&
          balance_rate == o.balance_rate &&
          transaction_rate == o.transaction_rate &&
          accrued_rate == o.accrued_rate &&
          accrual_frequency == o.accrual_frequency &&
          currency == o.currency &&
    ...
    def hash
      [name, fee_type, amount, balance_rate, transaction_rate, accrued_rate, accrual_frequency, currency, additional_value, additional_info, additional_info_uri, discounts].hash
    end
